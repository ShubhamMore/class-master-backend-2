...
router.post('/getLectureContents', auth, adminBranchStaffAuth, async (req, res) => {
...
router.post('/changeLectureContentStatus', auth, adminBranchStaffAuth, async (req, res) => {
  await changeLectureContentStatus(req, res);
});

router.post('/deleteLectureContent', auth, adminBranchStaffAuth, async (req, res) => {
