...
router.post('/newOnlineExam', auth, async (req, res) => {
...
router.post('/getOnlineExamForEditing', auth, async (req, res) => {
  await getOnlineExamForEditing(req, res);
});

router.post('/getOnlineExams', auth, async (req, res) => {
...
router.post('/editOnlineExam', auth, async (req, res) => {
  await editOnlineExam(req, res);
});

router.post('/changeOnlineExamStatus', auth, async (req, res) => {
  await changeOnlineExamStatus(req, res);
});

router.post('/deleteOnlineExam', auth, async (req, res) => {
