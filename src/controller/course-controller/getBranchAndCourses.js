...
const generateBranchAndCourses = async (branches, courses) => {
...
const getBranchAndCourses = async (req, res) => {
  try {
    ...
    const data = await generateBranchAndCourses(branches, courses);
...
module.exports = getBranchAndCourses;
