...
const branchSMSRouter = require('./routers/branch-sms.route');
const branchStorageRouter = require('./routers/branch-storage.route');
...
const smsPackageRouter = require('./routers/sms-package.route');
const storagePackageRouter = require('./routers/storage-package.route');
...
app.use(branchSMSRouter);
app.use(branchStorageRouter);
...
app.use(smsPackageRouter);
app.use(storagePackageRouter);
