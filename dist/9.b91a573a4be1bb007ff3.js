...
var AddCourseRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddCourseRoutingModule() {
    }
...
function AddCourseComponent_div_58_button_6_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddCourseComponent_div_58_button_6_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r20); var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2); return ctx_r19.deleteSubject(); });
...
var AddCourseComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddCourseComponent.prototype.ngOnInit = function () {
        ...
        if (this.courseId) {
            this.courseService.getCourseForEditing(this.courseId).subscribe(function (course) {
                ...
                _this.course = course;
                _this.courseBasicDetailsForm.patchValue({
                ...
                _this.courseFeeDetailsForm.patchValue({
                    fees: course.feeDetails.fees,
                    gst: course.feeDetails.gst,
                });
                _this.inclusiveGST = course.feeDetails.inclusiveGST;
                _this.calculateTotal();
                var subjects = _this.getSubjects();
                subjects.controls = [];
                _this.course.subjects.forEach(function (subject) {
                    _this.addSubject(subject);
                });
                _this.loading = false;
            }, function (err) {
                _this.router.navigate(['../page-not-found'], { relativeTo: _this.route });
    ...
    AddCourseComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    AddCourseComponent.prototype.atLeastOneSubjectValidator = function (group) {
    ...
    AddCourseComponent.prototype.getSubjects = function () {
        return this.courseSubjectForm.get('subjects');
    };
    AddCourseComponent.prototype.newSubject = function (subjectData) {
    ...
    AddCourseComponent.prototype.addSubject = function (subject) {
        var subjects = this.getSubjects();
        subjects.push(this.newSubject(subject));
    };
    AddCourseComponent.prototype.generateSubject = function () {
        var subject = {
    ...
    AddCourseComponent.prototype.deleteSubject = function (i) {
        if (i !== 0 && i !== 1) {
            var subjects = this.getSubjects();
            subjects.removeAt(i);
        }
    };
    AddCourseComponent.prototype.inclusiveGSTChanged = function (inclusiveGST) {
        this.inclusiveGST = inclusiveGST;
        this.calculateTotal();
    };
    AddCourseComponent.prototype.calculateTotal = function () {
        ...
        this.courseFeeDetailsForm.patchValue({ totalFees: totalFees });
    };
    AddCourseComponent.prototype.submitBasicDetails = function () {
    ...
    AddCourseComponent.prototype.submitSubjects = function () {
    ...
    AddCourseComponent.prototype.submitFeeDetails = function () {
    ...
    AddCourseComponent.prototype.saveCourse = function () {
        ...
        if (!this.course) {
            this.courseService.addCourse(course).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Course Added Successfully!');
            ...
            this.courseService.editCourse(course).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Course Updated Successfully!');
                _this.router.navigate(['../'], { relativeTo: _this.route });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
    ...
    AddCourseComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AddCourseComponent.prototype.getGstAmount = function () {
        var fee = this.courseFeeDetailsForm.value.fees;
        var gst = this.courseFeeDetailsForm.value.gst;
        var gstValue = (+fee / 100) * +gst;
        return gstValue.toString();
    };
    AddCourseComponent.prototype.getCategory = function (categoryId) {
    ...
    AddCourseComponent.prototype.getSubjectsData = function () {
        var subjects = [];
    ...
    AddCourseComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AddCourseComponent, selectors: [["ngx-add-course"]], viewQuery: function AddCourseComponent_Query(rf, ctx) {
            ...
            if (rf & 2) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](ctx.courseBasicDetailsForm.value.duration);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](ctx.getCategory(ctx.courseBasicDetailsForm.value.category));
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](ctx.courseBasicDetailsForm.value.description);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);
...
var AddCourseModule = /** @class */ /*@__PURE__*/ (function () {
