...
const routes = [
    {
        ...
        children: [
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(93)]).then(__webpack_require__.bind(null, /*! ./add-salary/add-salary.module */ "./src/app/employee/branch/employee/manage-employee-salary/add-salary/add-salary.module.ts")).then((m) => m.AddSalaryModule),
            },
            {
                path: 'view',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(95)]).then(__webpack_require__.bind(null, /*! ./view-salary-receipt/view-salary-receipt.module */ "./src/app/employee/branch/employee/manage-employee-salary/view-salary-receipt/view-salary-receipt.module.ts")).then((m) => m.ViewSalaryReceiptModule),
            },
            {
                path: '',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(94)]).then(__webpack_require__.bind(null, /*! ./manage-salary/manage-salary.module */ "./src/app/employee/branch/employee/manage-employee-salary/manage-salary/manage-salary.module.ts")).then((m) => m.ManageSalaryModule),
            },
            // {
            //   path: '',
