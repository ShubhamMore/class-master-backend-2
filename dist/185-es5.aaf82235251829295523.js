...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[185], {
  ...
  /***/
  function srcAppInstituteBranchScheduleBatchScheduleBatchScheduleRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() */
          [__webpack_require__.e("common"), __webpack_require__.e(186)]).then(__webpack_require__.bind(null,
          /*! ./manage-batch-schedule/manage-batch-schedule.module */
          "./src/app/institute/branch/schedule/batch-schedule/manage-batch-schedule/manage-batch-schedule.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/institute/branch/schedule/batch-schedule/add-schedule/add-schedule.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() */
          187).then(__webpack_require__.bind(null,
          /*! ./view-schedule/view-schedule.module */
          "./src/app/institute/branch/schedule/batch-schedule/view-schedule/view-schedule.module.ts")).then(function (m) {
    ...
    var BatchScheduleRoutingModule =
    /*@__PURE__*/
    function () {
  ...
  /***/
  function srcAppInstituteBranchScheduleBatchScheduleBatchScheduleComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppInstituteBranchScheduleBatchScheduleBatchScheduleModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
