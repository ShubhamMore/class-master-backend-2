    ...
    EQut: function (t, e, r) {
      ...
      let d = (() => {
        class t {
          ...
          getBranchForStudent(t) {
            return this.httpService.httpPost({ api: 'getBranchForStudent', data: { id: t } }).pipe(
              Object(n.a)((t) => t),
              Object(i.a)((t) => Object(s.a)(t))
            );
          }
          checkBranchStatus(t) {
            return this.httpService.httpPost({ api: 'checkBranchStatus', data: { id: t } }).pipe(
              Object(n.a)((t) => t),
              Object(i.a)((t) => Object(s.a)(t))
            );
          }
      ...
      let G = (() => {
        class t {
          ...
          changeSelectBranch(t) {
            if ('' !== t) {
              const e = this.branches.find((e) => e._id === t);
              e &&
                e.status &&
