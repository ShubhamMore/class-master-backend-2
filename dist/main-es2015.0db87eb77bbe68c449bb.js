...
const routes = [
    {
        path: 'admin',
        loadChildren: () => __webpack_require__.e(/*! import() */ 37).then(__webpack_require__.bind(null, /*! ./admin/admin.module */ "./src/app/admin/admin.module.ts")).then((m) => m.AdminModule),
        canActivate: [],
    },
    {
        path: 'institute',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(40)]).then(__webpack_require__.bind(null, /*! ./institute/institute.module */ "./src/app/institute/institute.module.ts")).then((m) => m.InstituteModule),
        canActivate: [_authentication_auth_guards_institute_auth_guard__WEBPACK_IMPORTED_MODULE_3__["InstituteAuthGuard"]],
    },
    {
        path: 'employee',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(45)]).then(__webpack_require__.bind(null, /*! ./employee/employee.module */ "./src/app/employee/employee.module.ts")).then((m) => m.EmployeeModule),
        canActivate: [_authentication_auth_guards_employee_auth_guard__WEBPACK_IMPORTED_MODULE_2__["EmployeeAuthGuard"]],
    },
    {
        path: 'student',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(41)]).then(__webpack_require__.bind(null, /*! ./student/student.module */ "./src/app/student/student.module.ts")).then((m) => m.StudentModule),
