...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(237)]).then(__webpack_require__.bind(null, /*! ./manage-course/manage-course.module */ "./src/app/student/branch/course/manage-course/manage-course.module.ts")).then((m) => m.ManageCourseModule),
            },
            {
                path: 'material',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(225)]).then(__webpack_require__.bind(null, /*! ./course-material/course-material.module */ "./src/app/student/branch/course/course-material/course-material.module.ts")).then((m) => m.CourseMaterialModule),
            },
            {
                path: 'installment',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(224)]).then(__webpack_require__.bind(null, /*! ./course-installment/course-installment.module */ "./src/app/student/branch/course/course-installment/course-installment.module.ts")).then((m) => m.CourseInstallmentModule),
            },
            {
                path: 'attendance',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(222)]).then(__webpack_require__.bind(null, /*! ./course-attendance/course-attendance.module */ "./src/app/student/branch/course/course-attendance/course-attendance.module.ts")).then((m) => m.CourseAttendanceModule),
            },
            {
                path: 'performance',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(228)]).then(__webpack_require__.bind(null, /*! ./course-performance/course-performance.module */ "./src/app/student/branch/course/course-performance/course-performance.module.ts")).then((m) => m.CoursePerformanceModule),
            },
            {
                path: 'lecture',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(230)]).then(__webpack_require__.bind(null, /*! ./lecture/lecture.module */ "./src/app/student/branch/course/lecture/lecture.module.ts")).then((m) => m.LectureModule),
            },
            {
                path: 'assignment',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(219)]).then(__webpack_require__.bind(null, /*! ./assignment/assignment.module */ "./src/app/student/branch/course/assignment/assignment.module.ts")).then((m) => m.AssignmentModule),
            },
            {
                path: 'online-test',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(240)]).then(__webpack_require__.bind(null, /*! ./online-test/online-test.module */ "./src/app/student/branch/course/online-test/online-test.module.ts")).then((m) => m.OnlineTestModule),
            },
            {
                path: '',
