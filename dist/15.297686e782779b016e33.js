...
var AddEmployeeRoutingModule = /** @class */ /*@__PURE__*/ (function () {
...
function AddEmployeeComponent_div_13_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("submit", function AddEmployeeComponent_div_13_Template_form_submit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r14); var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r13.searchEmployee(); });
...
function AddEmployeeComponent_form_14_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("submit", function AddEmployeeComponent_form_14_Template_form_submit_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r26); var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r25.employeeFormSubmit(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("input", function AddEmployeeComponent_form_14_Template_input_input_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r26); var ctx_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r27.checkUser(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
var AddEmployeeComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddEmployeeComponent.prototype.checkUser = function () {
        var _this = this;
    ...
    AddEmployeeComponent.prototype.alreadyRegister = function (alreadyRegisteredUser) {
        this.alreadyRegisteredUser = alreadyRegisteredUser;
    };
    AddEmployeeComponent.prototype.searchEmployee = function () {
        var _this = this;
        ...
        this.employeeService.searchEmployee(this.employeeId).subscribe(function (employee) {
            ...
            _this.employeeId = employee.imsMasterId;
            _this.userExist = false;
    ...
    AddEmployeeComponent.prototype.enableEmployeeDetails = function () {
    ...
    AddEmployeeComponent.prototype.disableEmployeeDetails = function () {
    ...
    AddEmployeeComponent.prototype.previousStep = function () {
    ...
    AddEmployeeComponent.prototype.branchEmployeeFormSubmit = function () {
    ...
    AddEmployeeComponent.prototype.saveEmployee = function () {
        ...
        if (!this.employeeId && !this.branchEmployeeId) {
            ...
            this.employeeService.addEmployee(newEmployee, newBranchEmployee).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Employee Added Successfully');
                _this.back();
                _this.loading = false;
            }, function (error) {
            ...
            this.branchEmployeeService.newBranchEmployee(newBranchEmployee).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Branch Employee added Successfully');
                _this.back();
                _this.loading = false;
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
            ...
            this.branchEmployeeService.editBranchEmployee(branchEmployee).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Employee Updated Successfully');
                _this.back();
                _this.loading = false;
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
    ...
    AddEmployeeComponent.prototype.showToastr = function (position, status, message) {
...
var AddEmployeeModule = /** @class */ /*@__PURE__*/ (function () {
