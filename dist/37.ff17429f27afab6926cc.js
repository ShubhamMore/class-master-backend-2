...
/***/ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-answer/add-answer.component.ts":
/*!******************************************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/question-answers/add-question-answers/add-answer/add-answer.component.ts ***!
  \******************************************************************************************************************/
...
/* harmony import */ var _services_question_answers_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../../services/question-answers.service */ "./src/app/services/question-answers.service.ts");
...
function AddAnswerComponent_form_6_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("submit", function AddAnswerComponent_form_6_Template_form_submit_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4); var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r3.saveLectureQuestionAnswer(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddAnswerComponent_form_6_Template_button_click_11_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4); var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r5.onClose(); });
...
var AddAnswerComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddAnswerComponent.prototype.ngOnInit = function () {
        ...
        this.questionAnswersService
            .getQuestionAnswer()
            .subscribe(function (questionAnswer) {
            _this.lectureQuestionAnswer = questionAnswer;
            if (questionAnswer) {
                _this.answerForm.patchValue({ answer: _this.lectureQuestionAnswer.answer });
            }
        });
    ...
    AddAnswerComponent.prototype.onClose = function () {
        this.ref.close();
    };
    AddAnswerComponent.prototype.saveLectureQuestionAnswer = function () {
        var _this = this;
        ...
        if (!this.lectureQuestionAnswer) {
            this.questionAnswersService.newLectureQuestionAnswer(lectureQuestionAnswer).subscribe(function (newLectureQuestionAnswer) {
                _this.showToastr('top-right', 'success', 'New Answer Added Successfully!');
                _this.ref.close(newLectureQuestionAnswer);
            }, function (error) {
            ...
            this.questionAnswersService.editLectureQuestionAnswer(lectureQuestionAnswer).subscribe(function (res) {
                _this.lectureQuestionAnswer.answer = answer;
                _this.showToastr('top-right', 'success', 'Answer Updated Successfully!');
                _this.ref.close(_this.lectureQuestionAnswer);
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
            });
    ...
    AddAnswerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AddAnswerComponent, selectors: [["ngx-add-answer"]], decls: 7, vars: 2, consts: [[1, "answer-box"], ["icon", "close-outline", 1, "float-right", "pointer", 3, "click"], [3, "formGroup", "submit", 4, "ngIf"], [3, "formGroup", "submit"], [1, "row"], [1, "col-12"], [1, "form-control-group"], ["for", "input-answer", 1, "label"], ["type", "text", "nbInput", "", "id", "input-answer", "name", "answer", "formControlName", "answer", "placeholder", "Answer", "fullWidth", "", 3, "status"], [4, "ngIf"], [1, "col-6"], ["type", "button", "nbButton", "", "size", "small", "status", "danger", 3, "click"], [1, "col-6", "text-right"], ["type", "submit", "nbButton", "", "size", "small", "status", "success"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"]], template: function AddAnswerComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddAnswerComponent_Template_nb_icon_click_2_listener() { return ctx.onClose(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
/***/ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question-answers-routing.module.ts":
/*!**********************************************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question-answers-routing.module.ts ***!
  \**********************************************************************************************************************/
...
var routes = [];
var AddQuestionAnswersRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddQuestionAnswersRoutingModule() {
    }
...
/***/ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question-answers.module.ts":
/*!**************************************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question-answers.module.ts ***!
  \**************************************************************************************************************/
...
/* harmony import */ var _add_answer_add_answer_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add-answer/add-answer.component */ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-answer/add-answer.component.ts");
/* harmony import */ var _add_question_add_question_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-question/add-question.component */ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question/add-question.component.ts");
...
/* harmony import */ var _add_question_answers_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./add-question-answers-routing.module */ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question-answers-routing.module.ts");
...
var AddQuestionAnswersModule = /** @class */ /*@__PURE__*/ (function () {
    function AddQuestionAnswersModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](AddQuestionAnswersModule, { declarations: [_add_question_add_question_component__WEBPACK_IMPORTED_MODULE_3__["AddQuestionComponent"], _add_answer_add_answer_component__WEBPACK_IMPORTED_MODULE_2__["AddAnswerComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"],
            _add_question_answers_routing_module__WEBPACK_IMPORTED_MODULE_6__["AddQuestionAnswersRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbButtonModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbInputModule"],
...
/***/ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question/add-question.component.ts":
/*!**********************************************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question/add-question.component.ts ***!
  \**********************************************************************************************************************/
...
var AddQuestionComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddQuestionComponent.prototype.ngOnInit = function () {
        ...
        this.questionAnswersService.getQuestion().subscribe(function (questionAnswers) {
            _this.lectureQuestion = questionAnswers;
            if (questionAnswers) {
                _this.lectureQuestionForm.patchValue({ question: _this.lectureQuestion.question });
            }
        });
        this.lectureService.getLectureData().subscribe(function (lecture) {
            _this.lecture = lecture;
    ...
    AddQuestionComponent.prototype.saveLectureQuestion = function () {
        var _this = this;
        ...
        if (!this.lectureQuestion) {
            this.questionAnswersService.newLectureQuestion(lectureQuestion).subscribe(function (newLectureQuestion) {
                _this.showToastr('top-right', 'success', 'New Question Added Successfully!');
                _this.ref.close(newLectureQuestion);
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
            });
            ...
            this.questionAnswersService.editLectureQuestion(lectureQuestion).subscribe(function (res) {
                _this.lectureQuestion.question = question;
                _this.showToastr('top-right', 'success', 'Question Updated Successfully!');
                _this.ref.close(_this.lectureQuestion);
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
            });
    ...
    AddQuestionComponent.prototype.onClose = function () {
        this.ref.close();
    };
    AddQuestionComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AddQuestionComponent.prototype.ngOnDestroy = function () {
        this.questionAnswersService.deleteQuestionId();
        this.questionAnswersService.deleteQuestion();
    };
    AddQuestionComponent.ɵfac = function AddQuestionComponent_Factory(t) { return new (t || AddQuestionComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_2__["NbToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_branch_service__WEBPACK_IMPORTED_MODULE_3__["BranchService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_lecture_service__WEBPACK_IMPORTED_MODULE_4__["LectureService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_question_answers_service__WEBPACK_IMPORTED_MODULE_5__["QuestionAnswersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_2__["NbDialogRef"])); };
    AddQuestionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AddQuestionComponent, selectors: [["ngx-add-question"]], decls: 22, vars: 4, consts: [[1, "question-box"], ["icon", "close-outline", 1, "float-right", "pointer", 3, "click"], [3, "formGroup", "submit"], [1, "row"], [1, "col-12"], [1, "form-control-group"], ["for", "input-question", 1, "label"], ["type", "text", "nbInput", "", "id", "input-question", "name", "question", "formControlName", "question", "placeholder", "Question", "fullWidth", "", 3, "status"], [4, "ngIf"], [1, "col-6"], ["type", "button", "nbButton", "", "size", "small", "status", "danger", 3, "click"], [1, "col-6", "text-right"], ["type", "submit", "nbButton", "", "size", "small", "status", "success"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"]], template: function AddQuestionComponent_Template(rf, ctx) {
            if (rf & 1) {
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-card", 0);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "nb-card-header");
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](2, "nb-icon", 1);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddQuestionComponent_Template_nb_icon_click_2_listener() { return ctx.onClose(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](3, "h3");
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](4);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("submit", function AddQuestionComponent_Template_form_submit_6_listener() { return ctx.saveLectureQuestion(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddQuestionComponent_Template_button_click_17_listener() { return ctx.onClose(); });
...
/***/ "./src/app/employee/branch/lecture/question-answers/question-answers-routing.module.ts":
/*!*********************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/question-answers/question-answers-routing.module.ts ***!
  \*********************************************************************************************/
...
/* harmony import */ var _question_answers_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./question-answers.component */ "./src/app/employee/branch/lecture/question-answers/question-answers.component.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm5/core.js");
...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () {
            return __webpack_require__.e(/*! import() */ 118).then(__webpack_require__.bind(null, /*! ./view-question-answers/view-question-answers.module */ "./src/app/employee/branch/lecture/question-answers/view-question-answers/view-question-answers.module.ts")).then(function (m) { return m.ViewQuestionAnswersModule; });
        },
    },
    {
        path: 'page-not-found',
...
var QuestionAnswersRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function QuestionAnswersRoutingModule() {
    }
...
/***/ "./src/app/employee/branch/lecture/question-answers/question-answers.component.ts":
/*!****************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/question-answers/question-answers.component.ts ***!
  \****************************************************************************************/
...
/* harmony import */ var _add_question_answers_add_question_add_question_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-question-answers/add-question/add-question.component */ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question/add-question.component.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm5/core.js");
...
function QuestionAnswersComponent_div_11_ng_container_2_nb_card_1_button_6_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function QuestionAnswersComponent_div_11_ng_container_2_nb_card_1_button_6_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r13); var lectureQuestion_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit; var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3); return ctx_r11.editQuestion(lectureQuestion_r7); });
...
function QuestionAnswersComponent_div_11_ng_container_2_nb_card_1_button_9_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function QuestionAnswersComponent_div_11_ng_container_2_nb_card_1_button_9_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r16); var lectureQuestion_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit; var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3); return ctx_r14.deleteQuestion(lectureQuestion_r7._id); });
...
function QuestionAnswersComponent_div_11_ng_container_2_nb_card_1_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function QuestionAnswersComponent_div_11_ng_container_2_nb_card_1_Template_button_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); var lectureQuestion_r7 = ctx.$implicit; var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3); return ctx_r17.viewQuestionAnswer(lectureQuestion_r7); });
...
var QuestionAnswersComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    QuestionAnswersComponent.prototype.ngOnInit = function () {
        ...
        this.lectureService.getLectureData().subscribe(function (lecture) {
            ...
            _this.getQuestionAnswers();
        });
    };
    QuestionAnswersComponent.prototype.getQuestionAnswers = function () {
        var _this = this;
        this.loading = true;
        this.questionAnswerService
            ...
            .subscribe(function (questionsAnswers) {
            _this.questionsAnswers = questionsAnswers;
            _this.loading = false;
        }, function (err) {
            _this.loading = false;
        });
    };
    QuestionAnswersComponent.prototype.addQuestion = function () {
        this.openQuestionDialog();
    };
    QuestionAnswersComponent.prototype.openQuestionDialog = function () {
        var _this = this;
        this.dialogService
            .open(_add_question_answers_add_question_add_question_component__WEBPACK_IMPORTED_MODULE_0__["AddQuestionComponent"], {
            context: {},
        })
            .onClose.subscribe(function (question) { return question && _this.saveLectureQuestion(question); });
    };
    QuestionAnswersComponent.prototype.editQuestion = function (questionAnswer) {
    ...
    QuestionAnswersComponent.prototype.formatQuestionAnswerDate = function (questionDate) {
        var date = this.dateService.convertToDate(questionDate).toString();
        return date.substr(0, 21);
    };
    QuestionAnswersComponent.prototype.deleteQuestion = function (id, i) {
        var _this = this;
        this.loading = true;
        this.questionAnswerService.deleteLectureQuestion(id).subscribe(function (res) {
            _this.questionsAnswers.splice(i, 1);
            _this.showToastr('top-right', 'success', "Question Deleted Successfully!");
            _this.loading = false;
        }, function (err) {
    ...
    QuestionAnswersComponent.prototype.viewQuestionAnswer = function (questionAnswer) {
    ...
    QuestionAnswersComponent.prototype.saveLectureQuestion = function (question) {
        if (!this.editLectureQuestion) {
            question.name = this.user.name;
            this.questionsAnswers.push(question);
        }
        else {
            var index = this.questionsAnswers.findIndex(function (curQuestion) { return curQuestion._id === question._id; });
            if (index >= 0) {
    ...
    QuestionAnswersComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    QuestionAnswersComponent.ɵfac = function QuestionAnswersComponent_Factory(t) { return new (t || QuestionAnswersComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_authentication_auth_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_branch_service__WEBPACK_IMPORTED_MODULE_3__["BranchService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_lecture_service__WEBPACK_IMPORTED_MODULE_4__["LectureService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_question_answers_service__WEBPACK_IMPORTED_MODULE_5__["QuestionAnswersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbDialogService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_shared_services_date_service__WEBPACK_IMPORTED_MODULE_8__["DateService"])); };
    QuestionAnswersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: QuestionAnswersComponent, selectors: [["ngx-question-answers"]], decls: 14, vars: 2, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], [1, "col-md-3", "col-sm-4"], ["nbButton", "", "size", "small", "status", "primary", "fullWidth", "", 3, "click"], ["icon", "plus-circle-outline"], [1, "body-container"], ["class", "row", 4, "ngIf", "ngIfElse"], ["loadingData", ""], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["noQuestions", ""], [4, "ngFor", "ngForOf"], [1, "col-md-6", "col-12"], [3, "name", "title"], [1, "col-md-6", "col-12", "text-right"], ["class", "mr-3", "nbButton", "", "size", "small", "status", "basic", 3, "click", 4, "ngIf"], ["nbButton", "", "size", "small", "status", "primary", 1, "mr-3", 3, "click"], ["class", "mr-3", "nbButton", "", "size", "small", "status", "danger", 3, "click", 4, "ngIf"], [3, "innerHTML"], ["nbButton", "", "size", "small", "status", "basic", 1, "mr-3", 3, "click"], ["nbButton", "", "size", "small", "status", "danger", 1, "mr-3", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function QuestionAnswersComponent_Template(rf, ctx) {
            if (rf & 1) {
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-card");
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "nb-card-header");
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](2, "div", 0);
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function QuestionAnswersComponent_Template_button_click_7_listener() { return ctx.addQuestion(); });
...
/***/ "./src/app/employee/branch/lecture/question-answers/question-answers.module.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/question-answers/question-answers.module.ts ***!
  \*************************************************************************************/
...
/* harmony import */ var _add_question_answers_add_question_answers_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-question-answers/add-question-answers.module */ "./src/app/employee/branch/lecture/question-answers/add-question-answers/add-question-answers.module.ts");
/* harmony import */ var _question_answers_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./question-answers.component */ "./src/app/employee/branch/lecture/question-answers/question-answers.component.ts");
/* harmony import */ var _nebular_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @nebular/theme */ "./node_modules/@nebular/theme/__ivy_ngcc__/fesm5/index.js");
...
/* harmony import */ var _question_answers_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./question-answers-routing.module */ "./src/app/employee/branch/lecture/question-answers/question-answers-routing.module.ts");
...
var QuestionAnswersModule = /** @class */ /*@__PURE__*/ (function () {
    function QuestionAnswersModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](QuestionAnswersModule, { declarations: [_question_answers_component__WEBPACK_IMPORTED_MODULE_1__["QuestionAnswersComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"],
            _question_answers_routing_module__WEBPACK_IMPORTED_MODULE_5__["QuestionAnswersRoutingModule"],
            _add_question_answers_add_question_answers_module__WEBPACK_IMPORTED_MODULE_0__["AddQuestionAnswersModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_2__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_2__["NbButtonModule"],
