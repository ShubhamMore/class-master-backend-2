...
const routes = [
    {
        ...
        children: [
            {
                path: 'dashboard',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(4), __webpack_require__.e("common"), __webpack_require__.e(91)]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/employee/branch/dashboard/dashboard.module.ts")).then((m) => m.DashboardModule),
            },
            {
                path: 'manage-branch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 126).then(__webpack_require__.bind(null, /*! ./manage-branch/manage-branch.module */ "./src/app/employee/branch/manage-branch/manage-branch.module.ts")).then((m) => m.ManageBranchModule),
            },
            {
                path: 'schedule',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(131)]).then(__webpack_require__.bind(null, /*! ./schedule/schedule.module */ "./src/app/employee/branch/schedule/schedule.module.ts")).then((m) => m.ScheduleModule),
            },
            {
                path: 'lecture',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(59)]).then(__webpack_require__.bind(null, /*! ./lecture/lecture.module */ "./src/app/employee/branch/lecture/lecture.module.ts")).then((m) => m.LectureModule),
            },
            {
                path: 'assignment',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(52)]).then(__webpack_require__.bind(null, /*! ./assignment/assignment.module */ "./src/app/employee/branch/assignment/assignment.module.ts")).then((m) => m.AssignmentModule),
            },
            {
                path: 'lead',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(107)]).then(__webpack_require__.bind(null, /*! ./lead/lead.module */ "./src/app/employee/branch/lead/lead.module.ts")).then((m) => m.LeadModule),
            },
            {
                path: 'exam',
                loadChildren: () => __webpack_require__.e(/*! import() */ 96).then(__webpack_require__.bind(null, /*! ./exam/exam.module */ "./src/app/employee/branch/exam/exam.module.ts")).then((m) => m.ExamModule),
            },
            {
                path: 'budget',
                loadChildren: () => __webpack_require__.e(/*! import() */ 88).then(__webpack_require__.bind(null, /*! ./budget/budget.module */ "./src/app/employee/branch/budget/budget.module.ts")).then((m) => m.BudgetModule),
            },
            {
                path: 'student',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(140)]).then(__webpack_require__.bind(null, /*! ./student/student.module */ "./src/app/employee/branch/student/student.module.ts")).then((m) => m.StudentModule),
            },
            {
                path: 'students-report',
                loadChildren: () => __webpack_require__.e(/*! import() */ 146).then(__webpack_require__.bind(null, /*! ./students-report/students-report.module */ "./src/app/employee/branch/students-report/students-report.module.ts")).then((m) => m.StudentsReportModule),
            },
            {
                path: 'employee',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(92)]).then(__webpack_require__.bind(null, /*! ./employee/employee.module */ "./src/app/employee/branch/employee/employee.module.ts")).then((m) => m.EmployeeModule),
            },
            {
                path: 'leave',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(36), __webpack_require__.e(58)]).then(__webpack_require__.bind(null, /*! ./leave/leave.module */ "./src/app/employee/branch/leave/leave.module.ts")).then((m) => m.LeaveModule),
            },
            {
                path: '',
...
let BranchRoutingModule = /*@__PURE__*/ (() => {
    ...
    BranchRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ factory: function BranchRoutingModule_Factory(t) { return new (t || BranchRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
...
/* harmony import */ var _branch_header_branch_header_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./branch-header/branch-header.component */ "./src/app/employee/branch/branch-header/branch-header.component.ts");
