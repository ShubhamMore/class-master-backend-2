...
const routes = [
    {
        ...
        children: [
            {
                path: 'add',
                loadChildren: () => __webpack_require__.e(/*! import() */ 18).then(__webpack_require__.bind(null, /*! ./add-lead/add-lead.module */ "./src/app/employee/branch/lead/add-lead/add-lead.module.ts")).then((m) => m.AddLeadModule),
            },
            {
                path: 'edit',
                loadChildren: () => __webpack_require__.e(/*! import() */ 18).then(__webpack_require__.bind(null, /*! ./add-lead/add-lead.module */ "./src/app/employee/branch/lead/add-lead/add-lead.module.ts")).then((m) => m.AddLeadModule),
            ...
            {
                path: 'manage',
                loadChildren: () => __webpack_require__.e(/*! import() */ 108).then(__webpack_require__.bind(null, /*! ./manage-lead/manage-lead.module */ "./src/app/employee/branch/lead/manage-lead/manage-lead.module.ts")).then((m) => m.ManageLeadModule),
            },
            {
                path: '',
