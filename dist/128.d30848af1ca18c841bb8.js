...
/***/ "./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer-routing.module.ts":
/*!****************************************************************************************************************************************!*\
  !*** ./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer-routing.module.ts ***!
  \****************************************************************************************************************************************/
...
/* harmony import */ var _manage_discount_and_offer_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manage-discount-and-offer.component */ "./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer.component.ts");
...
var ManageDiscountAndOfferRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageDiscountAndOfferRoutingModule() {
    }
...
/***/ "./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer.component.ts":
/*!***********************************************************************************************************************************!*\
  !*** ./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer.component.ts ***!
  \***********************************************************************************************************************************/
...
function ManageDiscountAndOfferComponent_ng_container_13_div_1_tr_20_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageDiscountAndOfferComponent_ng_container_13_div_1_tr_20_Template_button_click_14_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); var discountAndOffer_r7 = ctx.$implicit; var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r9.editDiscountAndOffer(discountAndOffer_r7._id); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageDiscountAndOfferComponent_ng_container_13_div_1_tr_20_Template_button_click_17_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); var discountAndOffer_r7 = ctx.$implicit; var i_r8 = ctx.index; var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r11.changeDiscountAndOfferStatus(discountAndOffer_r7._id, !discountAndOffer_r7.status, i_r8); });
...
var ManageDiscountAndOfferComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageDiscountAndOfferComponent.prototype.ngOnInit = function () {
        this.loading = true;
    ...
    ManageDiscountAndOfferComponent.prototype.getDiscountAndOffers = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageDiscountAndOfferComponent.prototype.addDiscountAndOffer = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageDiscountAndOfferComponent.prototype.editDiscountAndOffer = function (id) {
    ...
    ManageDiscountAndOfferComponent.prototype.changeDiscountAndOfferStatus = function (id, status, i) {
        var _this = this;
        this.loading = true;
        this.discountAndOfferService.changeDiscountAndOfferStatus(id, status).subscribe(function (res) {
            _this.discountAndOffers[i].status = status;
            _this.showToastr('top-right', 'success', "DiscountAndOffer " + (status ? 'Activated' : 'Deactivated') + " Successfully!");
            _this.loading = false;
        }, function (err) {
    ...
    ManageDiscountAndOfferComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ManageDiscountAndOfferComponent.ɵfac = function ManageDiscountAndOfferComponent_Factory(t) { return new (t || ManageDiscountAndOfferComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_branch_service__WEBPACK_IMPORTED_MODULE_1__["BranchService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_shared_services_date_service__WEBPACK_IMPORTED_MODULE_2__["DateService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_discount_and_offer_service__WEBPACK_IMPORTED_MODULE_3__["DiscountAndOfferService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"])); };
    ManageDiscountAndOfferComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageDiscountAndOfferComponent, selectors: [["ngx-manage-discount-and-offer"]], decls: 16, vars: 2, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], [1, "col-md-3", "col-sm-4"], ["nbButton", "", "size", "small", "status", "primary", "fullWidth", "", 3, "click"], ["icon", "plus-circle-outline"], [1, "body-container"], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noDiscountsAndOffers", ""], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], [1, "keep-hyphen"], ["nbButton", "", "size", "small", "status", "basic", 1, "mr-3", 3, "click"], ["nbButton", "", "size", "small", 1, "", 3, "status", "click"], [1, "text-center", "pt-5", "pb-5"]], template: function ManageDiscountAndOfferComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageDiscountAndOfferComponent_Template_button_click_7_listener() { return ctx.addDiscountAndOffer(); });
...
/***/ "./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer.module.ts":
/*!********************************************************************************************************************************!*\
  !*** ./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer.module.ts ***!
  \********************************************************************************************************************************/
...
/* harmony import */ var _manage_discount_and_offer_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manage-discount-and-offer-routing.module */ "./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer-routing.module.ts");
/* harmony import */ var _manage_discount_and_offer_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./manage-discount-and-offer.component */ "./src/app/employee/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer.component.ts");
...
var ManageDiscountAndOfferModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageDiscountAndOfferModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](ManageDiscountAndOfferModule, { declarations: [_manage_discount_and_offer_component__WEBPACK_IMPORTED_MODULE_1__["ManageDiscountAndOfferComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"],
            _manage_discount_and_offer_routing_module__WEBPACK_IMPORTED_MODULE_0__["ManageDiscountAndOfferRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbButtonModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbIconModule"]] });
