...
var MyLeaveRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function MyLeaveRoutingModule() {
    }
...
function MyLeaveComponent_ng_container_28_div_1_tr_17_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MyLeaveComponent_ng_container_28_div_1_tr_17_Template_button_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r16); var employeeLeave_r13 = ctx.$implicit; var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3); return ctx_r17.deleteLeave(employeeLeave_r13._id); });
...
function MyLeaveComponent_ng_container_30_Template(rf, ctx) {
    ...
    if (rf & 2) {
        var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](3);
...
function MyLeaveComponent_ng_container_32_Template(rf, ctx) {
    ...
    if (rf & 2) {
        var _r25 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](3);
...
var MyLeaveComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    MyLeaveComponent.prototype.ngOnInit = function () {
        this.loading = true;
    ...
    MyLeaveComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getMyLeaves();
    };
    MyLeaveComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    MyLeaveComponent.prototype.getMyLeaves = function () {
        var _this = this;
        this.loading = true;
        this.employeeLeaveService.getMyBranchLeaves(this.branchId, this.month, this.year).subscribe(function (leaves) {
            _this.pendingLeaves = leaves.filter(function (leave) { return leave.status === 'pending'; });
            _this.approvedLeaves = leaves.filter(function (leave) { return leave.status === 'accepted'; });
            _this.rejectedLeaves = leaves.filter(function (leave) { return leave.status === 'rejected'; });
            _this.loading = false;
        }, function (error) {
    ...
    MyLeaveComponent.prototype.getLeaveDuration = function (duration, startDate, endDate, hours) {
        if (duration === 'single') {
    ...
    MyLeaveComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    MyLeaveComponent.prototype.saveLeave = function (type, leave) {
        if (type === 'new') {
            this.pendingLeaves.push(leave);
        }
        else {
            var index = this.pendingLeaves.findIndex(function (curLeave) { return curLeave._id === leave._id; });
            if (index >= 0) {
                this.pendingLeaves[index] = leave;
            }
        }
    };
    MyLeaveComponent.prototype.openLeaveDialog = function () {
        var _this = this;
        this.dialogService
            ...
            return myLeave && _this.saveLeave(myLeave.type, myLeave.leave);
        });
    };
    MyLeaveComponent.prototype.createLeave = function () {
        this.openLeaveDialog();
    };
    MyLeaveComponent.prototype.editLeave = function (leave) {
        this.employeeLeaveService.setEmployeeLeaveId(leave._id);
        this.employeeLeaveService.setEmployeeLeaveData(leave);
        this.openLeaveDialog();
    };
    MyLeaveComponent.prototype.deleteLeave = function (id) {
        var _this = this;
        this.loading = true;
        this.employeeLeaveService.deleteEmployeeLeave(id).subscribe(function (res) {
            var index = _this.pendingLeaves.findIndex(function (curLeave) { return curLeave._id === id; });
            if (index >= 0) {
                _this.pendingLeaves.splice(index, 1);
            }
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
    ...
    MyLeaveComponent.prototype.showToastr = function (position, status, message) {
...
var MyLeaveModule = /** @class */ /*@__PURE__*/ (function () {
    function MyLeaveModule() {
    }
...
function SaveLeaveComponent_nb_stepper_6_ng_container_10_p_1_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Application Date is required! ");
...
function SaveLeaveComponent_nb_stepper_6_ng_container_10_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, SaveLeaveComponent_nb_stepper_6_ng_container_10_p_1_Template, 2, 0, "p", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerEnd"]();
    }
    if (rf & 2) {
        var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r4.leaveForm.get("date").errors == null ? null : ctx_r4.leaveForm.get("date").errors.required);
    }
}
function SaveLeaveComponent_nb_stepper_6_nb_option_18_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "nb-option", 44);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    }
    if (rf & 2) {
        var leaveType_r14 = ctx.$implicit;
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("value", leaveType_r14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](leaveType_r14);
    }
}
function SaveLeaveComponent_nb_stepper_6_ng_container_19_p_1_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "p", 43);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Leave Type is required! ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    }
}
function SaveLeaveComponent_nb_stepper_6_ng_container_19_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, SaveLeaveComponent_nb_stepper_6_ng_container_19_p_1_Template, 2, 0, "p", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerEnd"]();
    }
    if (rf & 2) {
        var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r6.leaveForm.get("leaveType").errors == null ? null : ctx_r6.leaveForm.get("leaveType").errors.required);
    }
}
function SaveLeaveComponent_nb_stepper_6_nb_option_25_Template(rf, ctx) {
    ...
    if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("value", duration_r16);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind1"](2, 2, duration_r16));
    }
}
...
function SaveLeaveComponent_nb_stepper_6_ng_container_26_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, SaveLeaveComponent_nb_stepper_6_ng_container_26_p_1_Template, 2, 0, "p", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerEnd"]();
    }
    if (rf & 2) {
        var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r8.leaveForm.get("duration").errors == null ? null : ctx_r8.leaveForm.get("duration").errors.required);
    }
}
...
function SaveLeaveComponent_nb_stepper_6_ng_container_32_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, SaveLeaveComponent_nb_stepper_6_ng_container_32_p_1_Template, 2, 0, "p", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerEnd"]();
    }
    if (rf & 2) {
        var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r9.leaveForm.get("startDate").errors == null ? null : ctx_r9.leaveForm.get("startDate").errors.required);
    }
}
...
function SaveLeaveComponent_nb_stepper_6_ng_container_38_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, SaveLeaveComponent_nb_stepper_6_ng_container_38_p_1_Template, 2, 0, "p", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerEnd"]();
    }
    if (rf & 2) {
        var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r10.leaveForm.hasError("invalidEndDate"));
    }
}
function SaveLeaveComponent_nb_stepper_6_ng_container_44_p_1_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "p", 43);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Leave Hours are required! ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    }
}
function SaveLeaveComponent_nb_stepper_6_ng_container_44_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, SaveLeaveComponent_nb_stepper_6_ng_container_44_p_1_Template, 2, 0, "p", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerEnd"]();
    }
    if (rf & 2) {
        var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r11.leaveForm.hasError("invalidHours"));
    }
}
function SaveLeaveComponent_nb_stepper_6_ng_container_50_p_1_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "p", 43);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Leave Reason is required! ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    }
}
function SaveLeaveComponent_nb_stepper_6_ng_container_50_Template(rf, ctx) {
    if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, SaveLeaveComponent_nb_stepper_6_ng_container_50_p_1_Template, 2, 0, "p", 42);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerEnd"]();
    }
    if (rf & 2) {
        var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r12.leaveForm.get("reason").errors == null ? null : ctx_r12.leaveForm.get("reason").errors.required);
    }
}
function SaveLeaveComponent_nb_stepper_6_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "nb-stepper", 5, 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](2, "nb-step", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](3, "form", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("submit", function SaveLeaveComponent_nb_stepper_6_Template_form_submit_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r23); var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r22.submitLeave(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](7, "label", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](8, "Application Date:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](9, "input", 13);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](10, SaveLeaveComponent_nb_stepper_6_ng_container_10_Template, 2, 1, "ng-container", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](14, "Leave Type:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](15, "nb-select", 16);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](16, "nb-option", 17);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](17, "Select Leave Type");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](18, SaveLeaveComponent_nb_stepper_6_nb_option_18_Template, 2, 2, "nb-option", 18);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](19, SaveLeaveComponent_nb_stepper_6_ng_container_19_Template, 2, 1, "ng-container", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](24, "nb-select", 20);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectedChange", function SaveLeaveComponent_nb_stepper_6_Template_nb_select_selectedChange_24_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r23); var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r24.onChangeDuration($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](25, SaveLeaveComponent_nb_stepper_6_nb_option_25_Template, 3, 4, "nb-option", 18);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](26, SaveLeaveComponent_nb_stepper_6_ng_container_26_Template, 2, 1, "ng-container", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](30, "Start Date:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](31, "input", 22);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](32, SaveLeaveComponent_nb_stepper_6_ng_container_32_Template, 2, 1, "ng-container", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](36, "End Date:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](37, "input", 24);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](38, SaveLeaveComponent_nb_stepper_6_ng_container_38_Template, 2, 1, "ng-container", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](42, "Hours:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](43, "input", 26);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](44, SaveLeaveComponent_nb_stepper_6_ng_container_44_Template, 2, 1, "ng-container", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](47, "label", 28);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](48, "Reason:");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](49, "textarea", 29);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](50, SaveLeaveComponent_nb_stepper_6_ng_container_50_Template, 2, 1, "ng-container", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](54, "button", 31);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](57, "nb-icon", 32);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](58, "nb-step", 33);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](61, "table", 36);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](65, "Application Date");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](70, "Leave Type");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](75, "Duration");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](80, "Start Date");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](85, "End Date");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](90, "Hours");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](95, "Reason");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](101, "button", 38);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](102, "nb-icon", 39);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](103, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](104, "prev");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](105, "div", 40);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](106, "button", 41);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function SaveLeaveComponent_nb_stepper_6_Template_button_click_106_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r23); var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r25.saveLeave(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](107, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](108, "Submit");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    ...
    if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("stepControl", ctx_r0.leaveForm);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("formGroup", ctx_r0.leaveForm);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](6);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("min", ctx_r0.dateService.getDateString())("status", ctx_r0.leaveForm.get("date").touched ? ctx_r0.leaveForm.get("date").invalid ? "danger" : "success" : "basic");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r0.leaveForm.get("date").touched);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("status", ctx_r0.leaveForm.get("leaveType").touched ? ctx_r0.leaveForm.get("leaveType").invalid ? "danger" : "success" : "basic");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", ctx_r0.leaveTypes);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r0.leaveForm.get("leaveType").touched);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("status", ctx_r0.leaveForm.get("duration").touched ? ctx_r0.leaveForm.get("duration").invalid ? "danger" : "success" : "basic");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", ctx_r0.durations);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r0.leaveForm.get("duration").touched);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("min", ctx_r0.dateService.getDateString())("status", ctx_r0.leaveForm.get("startDate").touched ? ctx_r0.leaveForm.get("startDate").invalid ? "danger" : "success" : "basic");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r0.leaveForm.get("startDate").touched);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("min", ctx_r0.dateService.getDateString())("status", ctx_r0.leaveForm.get("startDate").touched ? ctx_r0.leaveForm.hasError("invalidEndDate") ? "danger" : "success" : "basic");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r0.leaveForm.get("endDate").touched);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("status", ctx_r0.leaveForm.get("hours").touched ? ctx_r0.leaveForm.hasError("invalidHours") ? "danger" : "success" : "basic");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r0.leaveForm.get("hours").touched);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("status", ctx_r0.leaveForm.get("reason").touched ? ctx_r0.leaveForm.get("reason").invalid ? "danger" : "success" : "basic");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r0.leaveForm.get("reason").touched);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](17);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0.dateService.formatDate(ctx_r0.leaveForm.value.date));
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0.leaveForm.value.leaveType);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0.leaveForm.value.duration);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", ctx_r0.dateService.formatDate(ctx_r0.leaveForm.value.startDate), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", ctx_r0.leaveForm.value.endDate ? ctx_r0.dateService.formatDate(ctx_r0.leaveForm.value.endDate) : "--", " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0.leaveForm.value.hours ? ctx_r0.leaveForm.value.hours + " Hour/s" : "--");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0.leaveForm.value.reason);
    }
}
...
var SaveLeaveComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    SaveLeaveComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this.branchId = this.branchService.getBranchId();
        if (!this.branchId) {
        ...
        this.leaveService.getEmployeeLeaveData().subscribe(function (leave) {
            _this.leave = leave;
            _this.leaveForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
                leaveType: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](leave ? leave.leaveType : '', {
                    validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
                }),
                duration: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](leave ? leave.duration : _this.durations[0], {
                    validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
                }),
                date: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](leave ? leave.date : _this.dateService.getDateString(), {
                    validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
                }),
                startDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](leave ? leave.startDate : null, {
                    validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
                }),
                endDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](leave ? leave.endDate : null, {
                    validators: [],
                }),
                hours: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](leave ? leave.hours : null, {
                    validators: [],
                }),
                reason: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](leave ? leave.reason : null, {
                    validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
                }),
            }, {
                validators: _this.durationValidator.bind(_this),
            });
            _this.onChangeDuration(_this.leaveForm.value.duration);
            _this.loading = false;
        });
    };
    SaveLeaveComponent.prototype.durationValidator = function (group) {
    ...
    SaveLeaveComponent.prototype.onChangeDuration = function (duration) {
        if (duration === 'single') {
    ...
    SaveLeaveComponent.prototype.submitLeave = function () {
    ...
    SaveLeaveComponent.prototype.saveLeave = function () {
        var _this = this;
        this.leaveForm.markAllAsTouched();
        if (this.leaveForm.invalid) {
            this.showToastr('top-right', 'danger', 'Leave Details are required');
        ...
        this.loading = true;
        var leave = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ branch: this.branchId }, this.leaveForm.getRawValue());
        if (!this.leave) {
            this.leaveService.createEmployeeLeave(leave).subscribe(function (resLeave) {
                _this.ref.close({ leave: resLeave, type: 'new' });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
            });
            ...
            this.leaveService.updateEmployeeLeave(leave).subscribe(function (res) {
                _this.ref.close({ leave: leave, type: 'edit' });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
            });
    ...
    SaveLeaveComponent.prototype.onClose = function () {
        this.ref.close();
    };
    SaveLeaveComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    SaveLeaveComponent.prototype.ngOnDestroy = function () {
        this.leaveService.deleteEmployeeLeaveData();
    };
    SaveLeaveComponent.ɵfac = function SaveLeaveComponent_Factory(t) { return new (t || SaveLeaveComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_services_branch_service__WEBPACK_IMPORTED_MODULE_3__["BranchService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_services_shared_services_date_service__WEBPACK_IMPORTED_MODULE_4__["DateService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_services_employee_leave_service__WEBPACK_IMPORTED_MODULE_5__["EmployeeLeaveService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbDialogRef"])); };
    SaveLeaveComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: SaveLeaveComponent, selectors: [["ngx-save-leave"]], viewQuery: function SaveLeaveComponent_Query(rf, ctx) {
            if (rf & 1) {
            ...
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function SaveLeaveComponent_Template_nb_icon_click_2_listener() { return ctx.onClose(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
