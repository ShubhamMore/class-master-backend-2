...
var CourseAttendanceRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function CourseAttendanceRoutingModule() {
    }
...
var CourseAttendanceComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    CourseAttendanceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    CourseAttendanceComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getStudentCourseAttendance();
    };
    CourseAttendanceComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    CourseAttendanceComponent.prototype.onSelectSubject = function (subject) {
        this.subject = subject;
        this.getStudentCourseAttendance();
    };
    CourseAttendanceComponent.prototype.getStudentCourseAttendance = function () {
        var _this = this;
        this.loading = true;
    ...
    CourseAttendanceComponent.prototype.calculateAttendance = function (totalLectures) {
        var totalPresent = 0;
        var totalAbsent = 0;
    ...
    CourseAttendanceComponent.prototype.back = function () {
        var type = this.studentBranchService.getType();
        this.router.navigate(['../'], { relativeTo: this.route, queryParams: { type: type } });
    };
    CourseAttendanceComponent.prototype.showToastr = function (position, status, message) {
...
var CourseAttendanceModule = /** @class */ /*@__PURE__*/ (function () {
    function CourseAttendanceModule() {
    }
