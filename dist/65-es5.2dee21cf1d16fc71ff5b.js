(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[65], {
    ...
    function srcAppAdminInstitutesInstitutesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/admin/institutes/branches/branches.module.ts")).then(function (m) {
      ...
      var InstitutesRoutingModule = /*@__PURE__*/function () {
    ...
    function srcAppAdminInstitutesInstitutesComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function InstitutesComponent_div_7_div_2_tr_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InstitutesComponent_div_7_div_2_tr_14_Template_button_click_11_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

            var institute_r7 = ctx.$implicit;

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3);

            return ctx_r9.viewInstitute(institute_r7);
          });
      ...
      var InstitutesComponent = /*@__PURE__*/function () {
        var InstitutesComponent = /*#__PURE__*/function () {
          function InstitutesComponent(instituteService, toastrService, router, route) {
          ...
          _createClass(InstitutesComponent, [{
            ...
            value: function ngOnInit() {
              ...
              this.loading = true;
              this.instituteService.getInstitutes().subscribe(function (institutes) {
                _this.institutes = institutes;
                _this.loading = false;
              }, function (error) {
            ...
            key: "viewInstitute",
            value: function viewInstitute(institute) {
        ...
        InstitutesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
          ...
          decls: 12,
          vars: 2,
          consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], ["class", "row", 4, "ngIf", "ngIfElse"], ["loadingData", ""], ["noInstitutes", ""], [1, "col-12"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], ["type", "button", "nbButton", "", "size", "small", "status", "primary", 3, "click"], [1, "pt-5", "pb-5", "text-center"]],
    ...
    function srcAppAdminInstitutesInstitutesModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var InstitutesModule = /*@__PURE__*/function () {
