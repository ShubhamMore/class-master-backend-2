...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(193)]).then(__webpack_require__.bind(null, /*! ./manage-batch-schedule/manage-batch-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/manage-batch-schedule/manage-batch-schedule.module.ts")).then((m) => m.ManageBatchScheduleModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(13)]).then(__webpack_require__.bind(null, /*! ./add-schedule/add-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/add-schedule/add-schedule.module.ts")).then((m) => m.AddScheduleModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(13)]).then(__webpack_require__.bind(null, /*! ./add-schedule/add-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/add-schedule/add-schedule.module.ts")).then((m) => m.AddScheduleModule),
            ...
            {
                path: 'view',
                loadChildren: () => __webpack_require__.e(/*! import() */ 194).then(__webpack_require__.bind(null, /*! ./view-schedule/view-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/view-schedule/view-schedule.module.ts")).then((m) => m.ViewScheduleModule),
            },
            {
                path: '',
                redirectTo: 'manage',
