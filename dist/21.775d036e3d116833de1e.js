...
var AddDiscountAndOfferRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddDiscountAndOfferRoutingModule() {
    }
...
/* harmony import */ var _services_discount_and_offer_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../../../../services/discount-and-offer.service */ "./src/app/services/discount-and-offer.service.ts");
...
var AddDiscountAndOfferComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddDiscountAndOfferComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        ...
        if (this.discountAndOfferId) {
            this.discountAndOfferService.getDiscountAndOfferForEditing(this.discountAndOfferId).subscribe(function (discountAndOffer) {
                ...
                _this.discountAndOffer = discountAndOffer;
                _this.discountAndOfferForm.patchValue({
    ...
    AddDiscountAndOfferComponent.prototype.discountPercentageValidator = function (group) {
    ...
    AddDiscountAndOfferComponent.prototype.checkOfferCode = function (code) {
        var _this = this;
        ...
        this.discountAndOfferService.CheckDiscountAndOffer(this.branchId, code).subscribe(function (res) {
            _this.validOfferCode = res.status;
        }, function (err) { });
    };
    AddDiscountAndOfferComponent.prototype.submitDiscountAndOffer = function () {
    ...
    AddDiscountAndOfferComponent.prototype.saveDiscountAndOffer = function () {
        var _this = this;
        this.discountAndOfferForm.markAllAsTouched();
        if (this.discountAndOfferForm.invalid) {
            this.showToastr('top-right', 'danger', 'Discount & Offer Details are required');
        ...
        if (!this.discountAndOffer) {
            this.discountAndOfferService.addDiscountAndOffer(discountAndOffer).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Discount And Offer Added Successfully!');
            ...
            this.discountAndOfferService.editDiscountAndOffer(discountAndOffer).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Discount And Offer Updated Successfully!');
                _this.router.navigate(['../'], { relativeTo: _this.route });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
    ...
    AddDiscountAndOfferComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AddDiscountAndOfferComponent, selectors: [["ngx-add-discount-and-offer"]], viewQuery: function AddDiscountAndOfferComponent_Query(rf, ctx) {
            ...
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddDiscountAndOfferComponent_Template_button_click_2_listener() { return ctx.back(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("submit", function AddDiscountAndOfferComponent_Template_form_submit_11_listener() { return ctx.submitDiscountAndOffer(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("input", function AddDiscountAndOfferComponent_Template_input_input_25_listener($event) { return ctx.checkOfferCode($event.target.value); });
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AddDiscountAndOfferComponent_Template_button_click_124_listener() { return ctx.saveDiscountAndOffer(); });
            ...
            if (rf & 2) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", !ctx.discountAndOffer ? "Add New DiscountAndOffer" : "Edit Offer " + _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](6, 27, ctx.discountAndOffer.offerName), " ");
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](90, 29, ctx.discountAndOfferForm.value.discountType));
...
var AddDiscountAndOfferModule = /** @class */ /*@__PURE__*/ (function () {
    function AddDiscountAndOfferModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AddDiscountAndOfferModule, { declarations: [_add_discount_and_offer_component__WEBPACK_IMPORTED_MODULE_0__["AddDiscountAndOfferComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _add_discount_and_offer_routing_module__WEBPACK_IMPORTED_MODULE_3__["AddDiscountAndOfferRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_5__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_5__["NbButtonModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_5__["NbSelectModule"],
