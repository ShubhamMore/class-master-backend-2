...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 140).then(__webpack_require__.bind(null, /*! ./batch-assignment/batch-assignment.module */ "./src/app/institute/branch/assignment/batch-assignment/batch-assignment.module.ts")).then((m) => m.BatchAssignmentModule),
            },
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(141)]).then(__webpack_require__.bind(null, /*! ./manage-assignment/manage-assignment.module */ "./src/app/institute/branch/assignment/manage-assignment/manage-assignment.module.ts")).then((m) => m.ManageAssignmentModule),
            },
            {
                path: 'submission',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(138)]).then(__webpack_require__.bind(null, /*! ./assignment-submission/assignment-submission.module */ "./src/app/institute/branch/assignment/assignment-submission/assignment-submission.module.ts")).then((m) => m.AssignmentSubmissionModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(22)]).then(__webpack_require__.bind(null, /*! ./save-assignment/save-assignment.module */ "./src/app/institute/branch/assignment/save-assignment/save-assignment.module.ts")).then((m) => m.SaveAssignmentModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(22)]).then(__webpack_require__.bind(null, /*! ./save-assignment/save-assignment.module */ "./src/app/institute/branch/assignment/save-assignment/save-assignment.module.ts")).then((m) => m.SaveAssignmentModule),
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵsetClassMetadata"](AssignmentComponent, [{
    ...
    }], function () { return [{ type: _services_branch_service__WEBPACK_IMPORTED_MODULE_6__["BranchService"] }, { type: _services_branch_employee_service__WEBPACK_IMPORTED_MODULE_2__["BranchEmployeeService"] }, { type: _services_lecture_service__WEBPACK_IMPORTED_MODULE_1__["LectureService"] }, { type: _services_course_service__WEBPACK_IMPORTED_MODULE_3__["CourseService"] }, { type: _services_batch_service__WEBPACK_IMPORTED_MODULE_4__["BatchService"] }, { type: _services_subject_service__WEBPACK_IMPORTED_MODULE_0__["SubjectService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"] }]; }, null); })();
