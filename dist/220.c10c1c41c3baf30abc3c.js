        ...
        children: [
            {
                ...
                loadChildren: function () {
                    return __webpack_require__.e(/*! import() */ 85).then(__webpack_require__.bind(null, /*! ./manage-course/manage-course.module */ "./src/app/student/branch/course/manage-course/manage-course.module.ts")).then(function (m) { return m.ManageCourseModule; });
                },
            },
            {
                path: 'installment',
                loadChildren: function () {
                    return __webpack_require__.e(/*! import() */ 84).then(__webpack_require__.bind(null, /*! ./course-installment/course-installment.module */ "./src/app/student/branch/course/course-installment/course-installment.module.ts")).then(function (m) { return m.CourseInstallmentModule; });
                },
            },
            {
                path: 'attendance',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(82)]).then(__webpack_require__.bind(null, /*! ./course-attendance/course-attendance.module */ "./src/app/student/branch/course/course-attendance/course-attendance.module.ts")).then(function (m) { return m.CourseAttendanceModule; });
                },
            },
            {
                path: 'performance',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(83)]).then(__webpack_require__.bind(null, /*! ./course-performance/course-performance.module */ "./src/app/student/branch/course/course-performance/course-performance.module.ts")).then(function (m) { return m.CoursePerformanceModule; });
                },
            },
            {
                path: 'lecture',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(221)]).then(__webpack_require__.bind(null, /*! ./lecture/lecture.module */ "./src/app/student/branch/course/lecture/lecture.module.ts")).then(function (m) { return m.LectureModule; }); },
            },
            {
                path: 'assignment',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e(6), __webpack_require__.e(216)]).then(__webpack_require__.bind(null, /*! ./assignment/assignment.module */ "./src/app/student/branch/course/assignment/assignment.module.ts")).then(function (m) { return m.AssignmentModule; });
                },
            },
            {
                path: 'online-test',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e(6), __webpack_require__.e(231)]).then(__webpack_require__.bind(null, /*! ./online-test/online-test.module */ "./src/app/student/branch/course/online-test/online-test.module.ts")).then(function (m) { return m.OnlineTestModule; });
                },
            },
            {
                path: '',
...
var CourseRoutingModule = /** @class */ /*@__PURE__*/ (function () {
...
var CourseComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    CourseComponent.prototype.showToastr = function (position, status, message) {
...
var CourseModule = /** @class */ /*@__PURE__*/ (function () {
