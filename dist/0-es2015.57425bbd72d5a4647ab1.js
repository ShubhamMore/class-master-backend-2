...
let PageNotFoundComponent = /*@__PURE__*/ (() => {
    ...
    PageNotFoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PageNotFoundComponent, selectors: [["ngx-page-not-found"]], decls: 12, vars: 0, consts: [[1, "main-container"], [1, "row"], [1, "col-lg-6", "col-md-8", "col-sm-12", "mx-auto"], [1, "flex-centered"], [1, "title"], [1, "sub-title"], ["nbButton", "", "size", "small", "fullWidth", "", "type", "button", 1, "home-button", 3, "click"]], template: function PageNotFoundComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PageNotFoundComponent_Template_button_click_10_listener() { return ctx.goToBack(); });
