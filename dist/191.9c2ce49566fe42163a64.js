        ...
        children: [
            {
                ...
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(192)]).then(__webpack_require__.bind(null, /*! ./receipt-info/receipt-info.module */ "./src/app/institute/branch/manage-branch/receipt-info/receipt-info.module.ts")).then(function (m) { return m.ReceiptInfoModule; });
                },
            },
            {
                path: 'course',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 188).then(__webpack_require__.bind(null, /*! ./course/course.module */ "./src/app/institute/branch/manage-branch/course/course.module.ts")).then(function (m) { return m.CourseModule; }); },
            },
            {
                path: 'discount-and-offers',
                loadChildren: function () {
                    return __webpack_require__.e(/*! import() */ 189).then(__webpack_require__.bind(null, /*! ./discount-and-offer/discount-and-offer.module */ "./src/app/institute/branch/manage-branch/discount-and-offer/discount-and-offer.module.ts")).then(function (m) { return m.DiscountAndOfferModule; });
                },
            },
            {
                path: '',
...
var ManageBranchRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBranchRoutingModule() {
    }
...
var ManageBranchComponent = /** @class */ /*@__PURE__*/ (function () {
    function ManageBranchComponent(branchService, router, route) {
        this.branchService = branchService;
        this.router = router;
        this.route = route;
    }
    ManageBranchComponent.prototype.ngOnInit = function () {
        this.loading = true;
...
var ManageBranchModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBranchModule() {
    }
