...
/***/ "./src/app/institute/branch/manage-branch/course/batch/batch-routing.module.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/institute/branch/manage-branch/course/batch/batch-routing.module.ts ***!
  \*************************************************************************************/
...
/* harmony import */ var _batch_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./batch.component */ "./src/app/institute/branch/manage-branch/course/batch/batch.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(174)]).then(__webpack_require__.bind(null, /*! ./manage-batch/manage-batch.module */ "./src/app/institute/branch/manage-branch/course/batch/manage-batch/manage-batch.module.ts")).then((m) => m.ManageBatchModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(30)]).then(__webpack_require__.bind(null, /*! ./add-batch/add-batch.module */ "./src/app/institute/branch/manage-branch/course/batch/add-batch/add-batch.module.ts")).then((m) => m.AddBatchModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(30)]).then(__webpack_require__.bind(null, /*! ./add-batch/add-batch.module */ "./src/app/institute/branch/manage-branch/course/batch/add-batch/add-batch.module.ts")).then((m) => m.AddBatchModule),
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BatchRoutingModule, [{
...
/***/ "./src/app/institute/branch/manage-branch/course/batch/batch.component.ts":
/*!********************************************************************************!*\
  !*** ./src/app/institute/branch/manage-branch/course/batch/batch.component.ts ***!
  \********************************************************************************/
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BatchComponent, [{
    ...
    }], function () { return [{ type: _services_branch_service__WEBPACK_IMPORTED_MODULE_2__["BranchService"] }, { type: _services_course_service__WEBPACK_IMPORTED_MODULE_0__["CourseService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }]; }, null); })();


/***/ }),

/***/ "./src/app/institute/branch/manage-branch/course/batch/batch.module.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/institute/branch/manage-branch/course/batch/batch.module.ts ***!
  \*****************************************************************************/
...
/* harmony import */ var _batch_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./batch-routing.module */ "./src/app/institute/branch/manage-branch/course/batch/batch-routing.module.ts");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BatchModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
