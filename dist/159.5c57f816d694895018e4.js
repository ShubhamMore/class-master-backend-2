...
/* harmony import */ var _manage_budget_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manage-budget.component */ "./src/app/institute/branch/budget/manage-budget/manage-budget.component.ts");
...
var ManageBudgetRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBudgetRoutingModule() {
    }
...
function ManageBudgetComponent_ng_container_62_div_1_tr_13_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBudgetComponent_ng_container_62_div_1_tr_13_Template_nb_icon_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19); var income_r16 = ctx.$implicit; var i_r17 = ctx.index; var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r18.deleteBudget(income_r16._id, i_r17, "income"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
...
function ManageBudgetComponent_ng_container_64_div_1_tr_13_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBudgetComponent_ng_container_64_div_1_tr_13_Template_nb_icon_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r25); var expense_r22 = ctx.$implicit; var i_r23 = ctx.index; var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r24.deleteBudget(expense_r22._id, i_r23, "expense"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
...
function ManageBudgetComponent_ng_template_71_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBudgetComponent_ng_template_71_Template_button_click_7_listener() { var ref_r27 = ctx.dialogRef; return ref_r27.close(); });
...
var ManageBudgetComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageBudgetComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageBudgetComponent.prototype.addIncomeExpense = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageBudgetComponent.prototype.viewStatement = function () {
        this.router.navigate(['../summery'], { relativeTo: this.route });
    };
    ManageBudgetComponent.prototype.onSelectYear = function (year) {
        this.year = year;
    ...
    ManageBudgetComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.budgetService.setMonth(this.month);
        this.searchBudget();
    };
    ManageBudgetComponent.prototype.openChart = function (dialog) {
    ...
    ManageBudgetComponent.prototype.searchBudget = function () {
        var _this = this;
        this.loading = true;
        this.budgetService.getBudgetForBranch(this.branchId, this.month, this.year).subscribe(function (budgetData) {
            _this.incomes = budgetData.incomes;
            _this.expenses = budgetData.expenses;
            _this.loading = false;
        }, function (error) {
    ...
    ManageBudgetComponent.prototype.getTotalIncome = function () {
        var totalIncome = 0;
    ...
    ManageBudgetComponent.prototype.getTotalExpense = function () {
        var totalExpense = 0;
    ...
    ManageBudgetComponent.prototype.getTotalBalance = function () {
        var totalIncomes = this.getTotalIncome();
        var totalExpenses = this.getTotalExpense();
        return totalIncomes - totalExpenses;
    };
    ManageBudgetComponent.prototype.deleteBudget = function (id, i, type) {
        var _this = this;
        this.budgetService.deleteBudget(id).subscribe(function (budget) {
            if (type === 'income') {
                _this.incomes.splice(i, 1);
                _this.showToastr('top-right', 'success', 'Income Deleted Successfully!!');
            }
            else {
                _this.expenses.splice(i, 1);
                _this.showToastr('top-right', 'success', 'Expense Deleted Successfully!!');
            }
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
    ...
    ManageBudgetComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ManageBudgetComponent.prototype.OnDestroy = function () {
    ...
    ManageBudgetComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageBudgetComponent, selectors: [["ngx-manage-budget"]], decls: 73, vars: 12, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], [1, "col-md-3", "col-sm-4"], ["type", "button", "fullWidth", "", "nbTooltip", "Add Income Expense", "nbButton", "", "size", "small", "status", "primary", 3, "click"], ["icon", "plus-circle-outline"], [1, "col-md-4", "col-sm-6", "col-12"], [1, "form-control-group"], ["for", "input-year", 1, "label"], ["name", "year", "id", "input-year", "fullWidth", "", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["for", "input-month", 1, "label"], ["name", "month", "id", "input-month", "fullWidth", "", 3, "selected", "selectedChange"], ["type", "button", "nbTooltip", "Budget Summery", "nbButton", "", "size", "small", "fullWidth", "", "status", "success", 1, "mt-4", 3, "click"], ["icon", "list-outline"], [3, "ngClass"], [1, "col-md-3", "col-sm-5", "col-7", "pt-3", "mx-auto"], ["nbButton", "", "size", "small", "status", "primary", "fullWidth", "", 3, "click"], ["icon", "pie-chart-outline"], ["fullWidth", ""], ["tabTitle", "INCOME"], [4, "ngIf", "ngIfElse"], ["tabTitle", "EXPENSE"], ["loadingBudget", ""], ["noIncome", ""], ["noExpense", ""], ["budgetChart", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], [1, "table-responsive"], [1, "table", "table-sm", "table-hover"], [1, "text-center"], ["routerLinkActive", "active", 4, "ngFor", "ngForOf"], ["routerLinkActive", "active"], [1, "pointer"], ["icon", "close-circle-outline", "nbTooltip", "Delete Income", 1, "pointer", "delete-budget", 3, "click"], [1, "expense"], ["icon", "close-circle-outline", "nbTooltip", "Delete Expense", 1, "pointer", "delete-budget", 3, "click"], [1, "text-center", "pt-2"], ["type", "pie", 3, "data", "options"], ["nbButton", "", "size", "small", 1, "float-right", 3, "click"]], template: function ManageBudgetComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBudgetComponent_Template_button_click_7_listener() { return ctx.addIncomeExpense(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageBudgetComponent_Template_nb_select_selectedChange_16_listener($event) { return ctx.onSelectYear($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageBudgetComponent_Template_nb_select_selectedChange_24_listener($event) { return ctx.onSelectMonth($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBudgetComponent_Template_button_click_29_listener() { return ctx.viewStatement(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](30, " View Summery\u00A0");
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBudgetComponent_Template_button_click_56_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r29); var _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](72); return ctx.openChart(_r10); });
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](57, " View Chart\u00A0");
...
/* harmony import */ var _manage_budget_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manage-budget.component */ "./src/app/institute/branch/budget/manage-budget/manage-budget.component.ts");
...
/* harmony import */ var _manage_budget_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./manage-budget-routing.module */ "./src/app/institute/branch/budget/manage-budget/manage-budget-routing.module.ts");
...
var ManageBudgetModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBudgetModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](ManageBudgetModule, { declarations: [_manage_budget_component__WEBPACK_IMPORTED_MODULE_2__["ManageBudgetComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"],
            _manage_budget_routing_module__WEBPACK_IMPORTED_MODULE_5__["ManageBudgetRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbInputModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbSelectModule"],
