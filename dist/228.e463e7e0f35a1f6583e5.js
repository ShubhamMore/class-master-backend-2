...
var ManageOnlineTestRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageOnlineTestRoutingModule() {
    }
...
/* harmony import */ var _student_branch_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../../student-branch.service */ "./src/app/student/branch/student-branch.service.ts");
...
function ManageOnlineTestComponent_nb_card_body_26_div_1_tr_16_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageOnlineTestComponent_nb_card_body_26_div_1_tr_16_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15); var onlineExam_r13 = ctx.$implicit; var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r14.startExam(onlineExam_r13); });
...
var ManageOnlineTestComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageOnlineTestComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageOnlineTestComponent.prototype.onSelectSubject = function (subject) {
        this.subject = subject;
        this.getOnlineExam();
    };
    ManageOnlineTestComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getOnlineExam();
    };
    ManageOnlineTestComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    ManageOnlineTestComponent.prototype.getOnlineExam = function () {
        ...
        this.onlineExamService
            ...
            .subscribe(function (onlineExams) {
            _this.onlineExams = onlineExams;
            _this.loading = false;
        }, function (error) {
    ...
    ManageOnlineTestComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ManageOnlineTestComponent.prototype.getSubject = function (subjectId) {
    ...
    ManageOnlineTestComponent.prototype.back = function () {
    ...
    ManageOnlineTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageOnlineTestComponent, selectors: [["ngx-manage-online-test"]], decls: 29, vars: 10, consts: [[1, "row"], [1, "col-md-3", "col-sm-4"], ["id", "select-subject", "name", "subject", "fullWidth", "", "placeholder", "All Subjects", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-year", "name", "year", "fullWidth", "", "placeholder", "All Years", 3, "selected", "selectedChange"], ["id", "select-month", "name", "month", "fullWidth", "", "placeholder", "All Months", 3, "selected", "selectedChange"], [4, "ngIf", "ngIfElse"], ["loadingTemplate", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noOnlineExams", ""], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], ["status", "success", "nbButton", "", "size", "small", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function ManageOnlineTestComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageOnlineTestComponent_Template_nb_select_selectedChange_12_listener($event) { return ctx.onSelectSubject($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageOnlineTestComponent_Template_nb_select_selectedChange_17_listener($event) { return ctx.onSelectYear($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageOnlineTestComponent_Template_nb_select_selectedChange_22_listener($event) { return ctx.onSelectMonth($event); });
...
var ManageOnlineTestModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageOnlineTestModule() {
    }
