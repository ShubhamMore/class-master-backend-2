(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[35], {
    ...
    function srcAppAdminServicesAdminZoomServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AdminZoomService = /*@__PURE__*/function () {
        var AdminZoomService = /*#__PURE__*/function () {
      ...
      var InstituteService = /*@__PURE__*/function () {
        var InstituteService = /*#__PURE__*/function () {
          ...
          _createClass(InstituteService, [{
            ...
            key: "setInstitute",
            value: function setInstitute(institute) {
              this.institute.next(institute);
            }
          }, {
            key: "deleteInstitute",
            value: function deleteInstitute() {
              this.institute.next(null);
            }
          }, {
            key: "getInstituteId",
            value: function getInstituteId() {
              return this.instituteId;
            }
          }, {
            key: "setInstituteId",
            value: function setInstituteId(id) {
              this.instituteId = id;
            }
          }, {
            key: "deleteInstituteId",
            value: function deleteInstituteId() {
            ...
            value: function activateInstituteBranch(branch, planType, amount) {
              var data = {
