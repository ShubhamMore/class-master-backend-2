...
const routes = [
    {
        ...
        children: [
            {
                path: 'test',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(162)]).then(__webpack_require__.bind(null, /*! ./test/test.module */ "./src/app/institute/branch/exam/test/test.module.ts")).then((m) => m.TestModule),
            },
            {
                path: 'online-test',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(157)]).then(__webpack_require__.bind(null, /*! ./online-test/online-test.module */ "./src/app/institute/branch/exam/online-test/online-test.module.ts")).then((m) => m.OnlineTestModule),
            },
            {
                path: '',
                redirectTo: 'test',
...
ExamComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ExamComponent, selectors: [["ngx-exam"]], decls: 1, vars: 0, template: function ExamComponent_Template(rf, ctx) { if (rf & 1) {
