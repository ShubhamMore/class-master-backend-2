...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'manage',
                loadChildren: () => __webpack_require__.e(/*! import() */ 78).then(__webpack_require__.bind(null, /*! ./manage-employee/manage-employee.module */ "./src/app/employee/branch/employee/manage-employee/manage-employee.module.ts")).then((m) => m.ManageEmployeeModule),
            },
            {
                path: 'salary',
                loadChildren: () => __webpack_require__.e(/*! import() */ 75).then(__webpack_require__.bind(null, /*! ./manage-employee-salary/manage-employee-salary.module */ "./src/app/employee/branch/employee/manage-employee-salary/manage-employee-salary.module.ts")).then((m) => m.ManageEmployeeSalaryModule),
            },
            {
                path: '',
