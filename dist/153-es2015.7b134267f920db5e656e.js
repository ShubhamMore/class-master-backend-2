...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(4), __webpack_require__.e(154)]).then(__webpack_require__.bind(null, /*! ./manage-budget/manage-budget.module */ "./src/app/institute/branch/budget/manage-budget/manage-budget.module.ts")).then((m) => m.ManageBudgetModule),
            },
            {
                path: 'add',
                loadChildren: () => __webpack_require__.e(/*! import() */ 64).then(__webpack_require__.bind(null, /*! ./add-budget/add-budget.module */ "./src/app/institute/branch/budget/add-budget/add-budget.module.ts")).then((m) => m.AddBudgetModule),
            },
            {
                path: 'view',
                loadChildren: () => __webpack_require__.e(/*! import() */ 155).then(__webpack_require__.bind(null, /*! ./view-budget/view-budget.module */ "./src/app/institute/branch/budget/view-budget/view-budget.module.ts")).then((m) => m.ViewBudgetModule),
            },
            {
                path: 'summery',
                loadChildren: () => __webpack_require__.e(/*! import() */ 65).then(__webpack_require__.bind(null, /*! ./view-budget-summery/view-budget-summery.module */ "./src/app/institute/branch/budget/view-budget-summery/view-budget-summery.module.ts")).then((m) => m.ViewBudgetSummeryModule),
            },
            {
                path: '',
                redirectTo: 'manage',
