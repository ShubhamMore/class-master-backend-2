...
var ManageBatchTestRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBatchTestRoutingModule() {
    }
...
/* harmony import */ var _services_exam_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../../../../../../services/exam.service */ "./src/app/services/exam.service.ts");
...
function ManageBatchTestComponent_ng_container_32_div_1_tr_17_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBatchTestComponent_ng_container_32_div_1_tr_17_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var exam_r13 = ctx.$implicit; var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r15.editExam(exam_r13); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, " Edit ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](14, "td");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "button", 22);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBatchTestComponent_ng_container_32_div_1_tr_17_Template_button_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var exam_r13 = ctx.$implicit; var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r17.addExamScore(exam_r13); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBatchTestComponent_ng_container_32_div_1_tr_17_Template_button_click_18_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var exam_r13 = ctx.$implicit; var i_r14 = ctx.index; var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r18.changeExamStatus(exam_r13._id, !exam_r13.status, i_r14); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](19);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](20, "td");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](21, "button", 24);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBatchTestComponent_ng_container_32_div_1_tr_17_Template_button_click_21_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var exam_r13 = ctx.$implicit; var i_r14 = ctx.index; var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r19.deleteExam(exam_r13._id, i_r14); });
...
var ManageBatchTestComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageBatchTestComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageBatchTestComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getExams();
    };
    ManageBatchTestComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    ManageBatchTestComponent.prototype.onSelectSubject = function (subject) {
        this.subject = subject;
        this.getExams();
    };
    ManageBatchTestComponent.prototype.getExams = function () {
        var _this = this;
        this.loading = true;
        this.examService
    ...
    ManageBatchTestComponent.prototype.addExam = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageBatchTestComponent.prototype.addExamScore = function (exam) {
        this.examService.setExamData(exam);
        this.router.navigate(['../score'], { relativeTo: this.route });
    };
    ManageBatchTestComponent.prototype.editExam = function (exam) {
        this.examService.setExamId(exam._id);
        this.examService.setExamData(exam);
        this.router.navigate(['../edit'], { relativeTo: this.route, queryParams: { mode: 'edit' } });
    };
    ManageBatchTestComponent.prototype.deleteExam = function (exam, i) {
        var _this = this;
        this.loading = true;
        this.examService.deleteExam(exam).subscribe(function (res) {
            _this.exams.splice(i, 1);
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
    ...
    ManageBatchTestComponent.prototype.changeExamStatus = function (exam, status, i) {
        // this.loading = true
    ...
    ManageBatchTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageBatchTestComponent, selectors: [["ngx-manage-batch-test"]], decls: 35, vars: 8, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], [1, "col-md-3", "col-sm-4"], ["nbButton", "", "size", "small", "fullWidth", "", "status", "primary", 3, "click"], ["icon", "plus-circle-outline"], ["id", "select-subject", "name", "subject", "fullWidth", "", "placeholder", "All Subjects", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-year", "name", "year", "fullWidth", "", "placeholder", "All Years", 3, "selected", "selectedChange"], ["id", "select-month", "name", "month", "fullWidth", "", "placeholder", "All Months", 3, "selected", "selectedChange"], [1, "body-container"], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noBatches", ""], [1, "table-responsive"], [1, "table"], ["colspan", "4"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "primary", 3, "click"], ["nbButton", "", "size", "small", "status", "warning", 3, "click"], ["nbButton", "", "size", "small", 3, "status", "click"], ["nbButton", "", "size", "small", "status", "danger", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function ManageBatchTestComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBatchTestComponent_Template_button_click_7_listener() { return ctx.addExam(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageBatchTestComponent_Template_nb_select_selectedChange_15_listener($event) { return ctx.onSelectSubject($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageBatchTestComponent_Template_nb_select_selectedChange_20_listener($event) { return ctx.onSelectYear($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageBatchTestComponent_Template_nb_select_selectedChange_25_listener($event) { return ctx.onSelectMonth($event); });
        ...
        }, directives: [_nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbCardComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbCardHeaderComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbButtonComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbIconComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbSelectComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbOptionComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgForOf"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbCardBodyComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgIf"]], styles: [""] });
...
var ManageBatchTestModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBatchTestModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](ManageBatchTestModule, { declarations: [_manage_batch_test_component__WEBPACK_IMPORTED_MODULE_4__["ManageBatchTestComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _manage_batch_test_routing_module__WEBPACK_IMPORTED_MODULE_3__["ManageBatchTestRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbSelectModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbButtonModule"],
