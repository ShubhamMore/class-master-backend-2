...
var RegisterRoutingModule = /** @class */ /*@__PURE__*/ (function () {
...
/* harmony import */ var _services_shared_services_encrypt_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/shared-services/encrypt.service */ "./src/app/services/shared-services/encrypt.service.ts");
/* harmony import */ var _services_shared_services_user_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../services/shared-services/user.service */ "./src/app/services/shared-services/user.service.ts");
...
var RegisterComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    RegisterComponent.prototype.passwordValidator = function (group) {
        if (group.value.password !== group.value.confirmPassword) {
            return { invalidConfirmPassword: true };
        }
        return null;
    };
    RegisterComponent.prototype.openTermsAndConditions = function () {
        var _this = this;
        this.dialogService
    ...
    RegisterComponent.prototype.checkUser = function () {
        ...
        if (this.form.get('email').valid) {
            this.userService.checkUser(this.form.value.email).subscribe(function (res) {
                _this.userExist = res.exist;
            }, function (error) { });
        }
    };
    RegisterComponent.prototype.acceptTermsConditions = function (e) {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        authObs.subscribe(function (res) {
            _this.loading = false;
            _this.showToastr('top-right', 'success', 'New User Created Successfully');
    ...
    RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["ngx-register"]], decls: 54, vars: 15, consts: [[1, "main-container"], [1, "row"], [1, "col-md-6", "col-sm-10", "col-12", "mx-auto"], ["id", "title", 1, "title"], [3, "formGroup", "ngSubmit"], [1, "form-control-group"], ["for", "input-name", 1, "label"], ["type", "text", "nbInput", "", "id", "input-name", "name", "fullName", "placeholder", "Full name", "formControlName", "name", "minlength", "5", "maxlength", "30", "autofocus", "", "fullWidth", "", 3, "status"], [4, "ngIf"], ["for", "input-email", 1, "label"], ["type", "email", "nbInput", "", "id", "input-email", "name", "email", "formControlName", "email", "placeholder", "Email address", "fullWidth", "", 3, "status", "input"], ["for", "input-phone", 1, "label"], ["type", "number", "nbInput", "", "id", "input-phone", "name", "phone", "formControlName", "phone", "placeholder", "phone", "minlength", "10", "maxlength", "10", "min", "0", "fullWidth", "", 3, "status"], ["for", "input-password", 1, "label"], ["type", "password", "nbInput", "", "id", "input-password", "name", "password", "formControlName", "password", "placeholder", "Password", "minlength", "7", "maxlength", "20", "fullWidth", "", 3, "status"], ["for", "input-re-password", 1, "label"], ["nbInput", "", "type", "password", "id", "input-re-password", "name", "rePass", "formControlName", "confirmPassword", "placeholder", "Confirm Password", "minlength", "5", "maxlength", "30", "fullWidth", "", 3, "status"], ["for", "input-role", 1, "label"], ["type", "text", "selected", "institute", "id", "input-role", "name", "userRole", "placeholder", "Select User Role", "formControlName", "userRole", "fullWidth", "", 3, "status"], [3, "value", 4, "ngFor", "ngForOf"], [1, "form-control-group", "accept-group"], ["name", "terms", 3, "checked", "checkedChange"], [1, "pointer", 3, "click"], ["nbButton", "", "size", "medium", "fullWidth", "", "status", "primary"], ["aria-label", "Sign in", 1, "another-action", "text-right"], ["routerLink", "/login", 1, "text-link"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"], [3, "value"]], template: function RegisterComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function RegisterComponent_Template_form_ngSubmit_7_listener() { return ctx.register(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("input", function RegisterComponent_Template_input_input_16_listener() { return ctx.checkUser(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("checkedChange", function RegisterComponent_Template_nb_checkbox_checkedChange_41_listener($event) { return ctx.acceptTermsConditions($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function RegisterComponent_Template_a_click_43_listener() { return ctx.openTermsAndConditions(); });
...
var RegisterModule = /** @class */ /*@__PURE__*/ (function () {
...
var TermsAndConditionsComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    TermsAndConditionsComponent.prototype.close = function () {
        this.ref.close(false);
    };
    TermsAndConditionsComponent.prototype.agree = function () {
        this.ref.close(true);
    };
    TermsAndConditionsComponent.ɵfac = function TermsAndConditionsComponent_Factory(t) { return new (t || TermsAndConditionsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbDialogRef"])); };
    TermsAndConditionsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TermsAndConditionsComponent, selectors: [["ngx-terms-and-conditions"]], decls: 10, vars: 0, consts: [[1, "terms-and-conditions-box"], [1, "row"], [1, "col-12"], ["type", "button", "nbButton", "", "size", "small", "status", "success", 1, "float-right", "ml-3", 3, "click"], ["type", "button", "nbButton", "", "size", "small", "status", "basic", 1, "float-right", "ml-3", 3, "click"]], template: function TermsAndConditionsComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TermsAndConditionsComponent_Template_button_click_6_listener() { return ctx.agree(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, " Agree ");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "button", 4);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TermsAndConditionsComponent_Template_button_click_8_listener() { return ctx.close(); });
