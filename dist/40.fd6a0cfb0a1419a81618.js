...
var InstituteOrderService = /** @class */ /*@__PURE__*/ (function () {
    function InstituteOrderService(httpService) {
        this.httpService = httpService;
    }
    InstituteOrderService.prototype.getInstituteOrderDetails = function () {
        return this.instituteOrderDetails;
    };
    InstituteOrderService.prototype.setInstituteOrderDetails = function (instituteOrder) {
        this.instituteOrderDetails = instituteOrder;
    };
    InstituteOrderService.prototype.deleteInstituteOrderDetails = function () {
        this.instituteOrderDetails = null;
    };
    InstituteOrderService.prototype.deleteInstituteOrder = function (id) {
        var data = { api: 'deleteInstituteOrder', data: { id: id } };
    ...
    InstituteOrderService.prototype.generateInstituteOrder = function (instituteOrder) {
        var data = { api: 'generateInstituteOrder', data: instituteOrder };
        return this.httpService.httpPost(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (response) {
            return response;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(err);
...
var PaymentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    PaymentComponent.prototype.getPaymentDescription = function () {
...
var routes = [
    {
        ...
        children: [
            {
                path: 'profile',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(234)]).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/student/profile/profile.module.ts")).then(function (m) { return m.ProfileModule; }); },
                canActivate: [],
            },
            {
                path: 'home',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 233).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/student/home/home.module.ts")).then(function (m) { return m.HomeModule; }); },
                canActivate: [],
            },
            {
                path: 'branch',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 58).then(__webpack_require__.bind(null, /*! ./branch/branch.module */ "./src/app/student/branch/branch.module.ts")).then(function (m) { return m.BranchModule; }); },
