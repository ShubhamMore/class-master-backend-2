...
var SaveAssignmentRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function SaveAssignmentRoutingModule() {
    }
...
function SaveAssignmentComponent_button_52_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SaveAssignmentComponent_button_52_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r17); var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r16.clearFile(); });
...
var SaveAssignmentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    SaveAssignmentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        ...
        if (this.assignmentId) {
            this.assignmentService
                ...
                _this.assignmentDetailsForm.patchValue({
                ...
                _this.fileName = assignment.fileName;
                _this.loading = false;
            });
        }
        else {
    ...
    SaveAssignmentComponent.prototype.onFilePicked = function (event) {
        this.invalidFile = false;
    ...
    SaveAssignmentComponent.prototype.clearFile = function () {
        this.uploadAssignment = null;
        this.fileName = null;
        this.fileInput.nativeElement.value = '';
        this.invalidFile = false;
    };
    SaveAssignmentComponent.prototype.submitAssignmentDetails = function () {
    ...
    SaveAssignmentComponent.prototype.saveAssignment = function () {
        var _this = this;
        this.assignmentDetailsForm.markAllAsTouched();
        if (this.assignmentDetailsForm.invalid) {
            this.showToastr('top-right', 'danger', 'Assignment details are required');
        ...
        if (!this.assignment) {
            this.assignmentService.saveAssignment(assignment).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Assignment Added Successfully!');
                _this.router.navigate(['../manage'], { relativeTo: _this.route });
            }, function (error) {
            ...
            this.assignmentService.updateAssignment(assignment).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Assignment Updated Successfully!');
                _this.router.navigate(['../manage'], { relativeTo: _this.route });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
    ...
    SaveAssignmentComponent.prototype.getSubjectName = function (id) {
        var subject = this.subjects.find(function (curSubject) { return curSubject._id === id; });
        if (subject) {
            return subject.subject;
        }
        return '--';
    };
    SaveAssignmentComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    SaveAssignmentComponent.prototype.back = function () {
        this.router.navigate(['../manage'], { relativeTo: this.route });
    };
    SaveAssignmentComponent.prototype.ngOnDestroy = function () {
    ...
    SaveAssignmentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SaveAssignmentComponent, selectors: [["ngx-save-assignment"]], viewQuery: function SaveAssignmentComponent_Query(rf, ctx) {
            ...
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SaveAssignmentComponent_Template_button_click_49_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r21); var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](47); return _r6.click(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SaveAssignmentComponent_Template_input_click_51_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r21); var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](47); return _r6.click(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
            ...
            if (rf & 2) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", !ctx.assignment ? "Add New Assignment" : "Edit Assignment " + _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](6, 27, ctx.assignment.topic), " ");
...
var SaveAssignmentModule = /** @class */ /*@__PURE__*/ (function () {
    function SaveAssignmentModule() {
    }
