...
var AddBatchRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddBatchRoutingModule() {
    }
...
var AddBatchComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddBatchComponent.prototype.ngOnInit = function () {
        ...
        this.teachers = [];
        this.subjects = this.course.subjects.filter(function (subject) { return subject.status; });
        this.subjects.forEach(function (subject) {
            ...
            _this.addBatchSubject(batchSubject);
        });
        this.branchEmployeeService.getBranchEmployeeNameIdsForBatch(this.branchId, 'teacher').subscribe(function (teachers) {
            ...
            if (_this.batchId) {
                _this.batchService.getBatchForEditing(_this.batchId).subscribe(function (batch) {
                    if (!batch) {
                        _this.router.navigate(['../page-not-found'], { relativeTo: _this.route });
                        return;
                    }
                    _this.batch = batch;
                    _this.batchBasicDetailsForm.patchValue({
                    ...
                    _this.subjects.forEach(function (curSubject, i) {
                        var subject = batchSubjects.find(function (curBatchSubject) {
                            return curBatchSubject.subject === curSubject._id;
                        });
                        var teacher = '';
                        if (subject) {
                            _this.changeSubjectStatus(subject.status, i);
                            _this.getBatchSubjects().controls[i].get('_id').setValue(subject._id);
                            if (teachers.find(function (curTeacher) { return curTeacher.employee === subject.teacher; })) {
                                teacher = subject.teacher;
                            }
                        }
                        _this.getBatchSubjects().controls[i].get('teacher').setValue(teacher);
                    });
                    _this.loading = false;
                }, function (err) {
                    _this.router.navigate(['../page-not-found'], { relativeTo: _this.route });
    ...
    AddBatchComponent.prototype.atLeastOneSubjectValidator = function (group) {
    ...
    AddBatchComponent.prototype.getBatchSubjects = function () {
        return this.batchSubjectForm.get('subjects');
    };
    AddBatchComponent.prototype.newBatchSubject = function (batchSubject) {
    ...
    AddBatchComponent.prototype.addBatchSubject = function (batchSubject) {
        var subjects = this.getBatchSubjects();
        subjects.push(this.newBatchSubject(batchSubject));
    };
    AddBatchComponent.prototype.changeSubjectStatus = function (status, i) {
    ...
    AddBatchComponent.prototype.getSubjectName = function (id) {
    ...
    AddBatchComponent.prototype.getTeacherName = function (id) {
        var teacher = this.teachers.find(function (curTeacher) { return curTeacher.employee === id; });
        if (teacher) {
            return teacher.name;
        }
        return '--';
    };
    AddBatchComponent.prototype.submitBasicDetails = function () {
    ...
    AddBatchComponent.prototype.submitSubjects = function () {
    ...
    AddBatchComponent.prototype.saveBatch = function () {
        var _this = this;
        this.batchBasicDetailsForm.markAllAsTouched();
        this.batchSubjectForm.markAllAsTouched();
        if (this.batchBasicDetailsForm.invalid) {
        ...
        if (!this.batch) {
            this.batchService.addBatch(batch).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Batch Added Successfully!');
                _this.router.navigate(['../'], { relativeTo: _this.route });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
            ...
            this.batchService.editBatch(batch).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Batch Updated Successfully!');
                _this.router.navigate(['../'], { relativeTo: _this.route });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
    ...
    AddBatchComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AddBatchComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    AddBatchComponent.prototype.ngOnDestroy = function () {
...
var AddBatchModule = /** @class */ /*@__PURE__*/ (function () {
    function AddBatchModule() {
    }
