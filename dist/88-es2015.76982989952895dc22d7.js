...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(4), __webpack_require__.e(89)]).then(__webpack_require__.bind(null, /*! ./manage-budget/manage-budget.module */ "./src/app/employee/branch/budget/manage-budget/manage-budget.module.ts")).then((m) => m.ManageBudgetModule),
            },
            {
                path: 'add',
                loadChildren: () => __webpack_require__.e(/*! import() */ 54).then(__webpack_require__.bind(null, /*! ./add-budget/add-budget.module */ "./src/app/employee/branch/budget/add-budget/add-budget.module.ts")).then((m) => m.AddBudgetModule),
            },
            {
                path: 'view',
                loadChildren: () => __webpack_require__.e(/*! import() */ 90).then(__webpack_require__.bind(null, /*! ./view-budget/view-budget.module */ "./src/app/employee/branch/budget/view-budget/view-budget.module.ts")).then((m) => m.ViewBudgetModule),
            },
            {
                path: 'summery',
                loadChildren: () => __webpack_require__.e(/*! import() */ 55).then(__webpack_require__.bind(null, /*! ./view-budget-summery/view-budget-summery.module */ "./src/app/employee/branch/budget/view-budget-summery/view-budget-summery.module.ts")).then((m) => m.ViewBudgetSummeryModule),
            },
            {
                path: '',
                redirectTo: 'manage',
