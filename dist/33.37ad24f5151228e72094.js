...
var AddStudentRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddStudentRoutingModule() {
    }
...
function AddStudentComponent_div_12_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("checkedChange", function AddStudentComponent_div_12_Template_nb_checkbox_checkedChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r9); var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r8.alreadyRegister($event); });
...
function AddStudentComponent_div_13_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("submit", function AddStudentComponent_div_13_Template_form_submit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r14); var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r13.searchStudent(); });
...
function AddStudentComponent_form_14_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("submit", function AddStudentComponent_form_14_Template_form_submit_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r32); var ctx_r31 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r31.studentFormSubmit(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("input", function AddStudentComponent_form_14_Template_input_input_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r32); var ctx_r33 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r33.checkUser(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
var AddStudentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddStudentComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    AddStudentComponent.prototype.checkUser = function () {
        var _this = this;
    ...
    AddStudentComponent.prototype.alreadyRegister = function (alreadyRegisteredUser) {
        this.alreadyRegisteredUser = alreadyRegisteredUser;
    };
    AddStudentComponent.prototype.searchStudent = function () {
        var _this = this;
        ...
        this.studentService.searchStudent(this.studentId).subscribe(function (student) {
            ...
            _this.studentId = student.imsMasterId;
            _this.userExist = false;
            _this.alreadyRegisteredUser = false;
            _this.studentSearchForm.patchValue({
                studentId: _this.student.imsMasterId,
            });
            _this.studentForm.patchValue({
    ...
    AddStudentComponent.prototype.enableStudentDetails = function () {
    ...
    AddStudentComponent.prototype.disableStudentDetails = function () {
    ...
    AddStudentComponent.prototype.previousStep = function () {
        this.stepper.previous();
        if (this.student) {
            this.disableStudentDetails();
        }
    };
    AddStudentComponent.prototype.studentFormSubmit = function () {
    ...
    AddStudentComponent.prototype.branchStudentFormSubmit = function () {
    ...
    AddStudentComponent.prototype.saveStudent = function () {
        var _this = this;
        this.studentForm.markAllAsTouched();
        this.branchStudentForm.markAllAsTouched();
        if (this.studentForm.invalid) {
        ...
        if (!this.studentId && !this.branchStudentId) {
            ...
            this.studentService.addStudent(newStudent, newBranchStudent).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Student Added Successfully');
                _this.back();
                _this.loading = false;
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
            ...
            this.branchStudentService.newBranchStudent(newBranchStudent).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Branch Student added Successfully');
                _this.back();
                _this.loading = false;
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
            ...
            this.branchStudentService.editBranchStudent(branchStudent).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Student Updated Successfully');
                _this.back();
                _this.loading = false;
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
    ...
    AddStudentComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AddStudentComponent.prototype.getCategory = function (categoryId) {
...
var AddStudentModule = /** @class */ /*@__PURE__*/ (function () {
