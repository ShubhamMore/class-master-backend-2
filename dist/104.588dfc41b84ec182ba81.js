...
var ViewSalaryReceiptRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ViewSalaryReceiptRoutingModule() {
    }
...
var ViewSalaryReceiptComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ViewSalaryReceiptComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ViewSalaryReceiptComponent.prototype.totalEarning = function () {
    ...
    ViewSalaryReceiptComponent.prototype.totalDeduction = function () {
    ...
    ViewSalaryReceiptComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    ViewSalaryReceiptComponent.prototype.print = function () {
        window.print();
    };
    ViewSalaryReceiptComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ViewSalaryReceiptComponent.prototype.ngOnDestroy = function () { };
    ...
    ViewSalaryReceiptComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ViewSalaryReceiptComponent, selectors: [["ngx-view-salary-receipt"]], decls: 95, vars: 19, consts: [["class", "row", 4, "ngIf"], [1, "text-center"], [1, "row"], [1, "col-md-10", "col-12", "mx-auto"], [1, "col-12", "text-right"], [1, "col-md-6", "col-12"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], [1, "col-12"], [1, "text-right"], ["type", "button", "nbButton", "", "size", "small", "status", "success", 1, "float-right", 3, "click"], ["icon", "printer-outline"], ["noEarnings", ""], ["noDeductions", ""], [1, "col-12", "text-center"], [1, "table-responsive"], [1, "table", "table-am"], [4, "ngFor", "ngForOf"], ["colspan", "2"], [1, "table", "table-sm"]], template: function ViewSalaryReceiptComponent_Template(rf, ctx) {
            ...
            if (rf & 2) {
                ...
                var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](94);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
var ViewSalaryReceiptModule = /** @class */ /*@__PURE__*/ (function () {
    function ViewSalaryReceiptModule() {
    }
