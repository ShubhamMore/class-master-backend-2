...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'manage',
                loadChildren: () => __webpack_require__.e(/*! import() */ 95).then(__webpack_require__.bind(null, /*! ./manage-lead/manage-lead.module */ "./src/app/employee/branch/lead/manage-lead/manage-lead.module.ts")).then((m) => m.ManageLeadModule),
            },
            {
                path: '',
