...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(238)]).then(__webpack_require__.bind(null, /*! ./manage-online-test/manage-online-test.module */ "./src/app/student/branch/course/online-test/manage-online-test/manage-online-test.module.ts")).then((m) => m.ManageOnlineTestModule),
            },
            {
                path: 'start',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(74)]).then(__webpack_require__.bind(null, /*! ./online-test-question/online-test-question.module */ "./src/app/student/branch/course/online-test/online-test-question/online-test-question.module.ts")).then((m) => m.OnlineTestQuestionModule),
            },
            {
                path: 'result',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(239)]).then(__webpack_require__.bind(null, /*! ./online-test-result/online-test-result.module */ "./src/app/student/branch/course/online-test/online-test-result/online-test-result.module.ts")).then((m) => m.OnlineTestResultModule),
            },
            {
                path: '',
                redirectTo: 'manage',
