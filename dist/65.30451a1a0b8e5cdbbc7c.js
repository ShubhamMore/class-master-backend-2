...
var LeaveCommentComponent = /** @class */ /*@__PURE__*/ (function () {
    function LeaveCommentComponent(ref) {
        this.ref = ref;
    }
    LeaveCommentComponent.prototype.ngOnInit = function () { };
    LeaveCommentComponent.prototype.changeComment = function (comment) {
        this.comment = comment;
    };
    LeaveCommentComponent.prototype.submit = function () {
...
var LeaveRoutingModule = /** @class */ /*@__PURE__*/ (function () {
...
function LeaveComponent_ng_container_31_Template(rf, ctx) {
    ...
    if (rf & 2) {
        var _r21 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](3);
...
var LeaveComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    LeaveComponent.prototype.onSelectEmployee = function (employee) {
        this.employee = employee;
        this.getBranchLeaves();
    };
    LeaveComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getBranchLeaves();
    };
    LeaveComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    LeaveComponent.prototype.getBranchLeaves = function () {
        var _this = this;
        this.loading = true;
        this.employeeLeaveService
            ...
            _this.approvedLeaves = leaves.filter(function (leave) { return leave.status === 'approved'; });
    ...
    LeaveComponent.prototype.getEmployeeName = function (employee) {
        var myEmployee = this.branchEmployees.find(function (curEmployee) { return curEmployee.employee === employee; });
        if (myEmployee) {
            return myEmployee.name;
        }
        return '--';
    };
    LeaveComponent.prototype.getLeaveDuration = function (duration, startDate, endDate, hours) {
        if (duration === 'single') {
    ...
    LeaveComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    LeaveComponent.prototype.changeEmployeeLeaveStatus = function (_id, status, comment) {
        var _this = this;
        this.loading = true;
        var employeeLeave = {
            _id: _id,
        ...
        this.employeeLeaveService.changeEmployeeLeaveStatus(employeeLeave).subscribe(function (res) {
            _this.showToastr('top-right', 'success', "Leave " + status.toUpperCase() + " Successfully!");
            _this.getBranchLeaves();
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
        });
    };
    LeaveComponent.prototype.openCommentDialog = function (id, status) {
        var _this = this;
        this.dialogService
            ...
            .onClose.subscribe(function (comment) { return _this.changeEmployeeLeaveStatus(id, status, comment); });
    };
    LeaveComponent.prototype.showToastr = function (position, status, message) {
    ...
    LeaveComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: LeaveComponent, selectors: [["ngx-leave"]], decls: 36, vars: 12, consts: [[1, "row"], [1, "col-md-12"], [1, "col-md-3", "col-sm-4"], ["id", "select-employee", "name", "employee", "fullWidth", "", "placeholder", "All Employees", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-year", "name", "year", "fullWidth", "", "placeholder", "All Years", 3, "selected", "selectedChange"], ["id", "select-month", "name", "month", "fullWidth", "", "placeholder", "All Months", 3, "selected", "selectedChange"], [1, "body-container"], ["fullWidth", ""], ["tabTitle", "pending"], [4, "ngIf", "ngIfElse"], ["tabTitle", "approved"], ["tabTitle", "Rejected"], ["loadingData", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noPendingLeaves", ""], [1, "table-responsive"], [1, "table"], ["colspan", "2"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "success", 3, "click"], ["nbButton", "", "size", "small", "status", "danger", 3, "click"], [1, "text-center", "pt-5", "pb-5"], ["noApprovedLeaves", ""], ["noRejectedLeaves", ""]], template: function LeaveComponent_Template(rf, ctx) {
            ...
            if (rf & 2) {
                var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](35);
...
var LeaveModule = /** @class */ /*@__PURE__*/ (function () {
