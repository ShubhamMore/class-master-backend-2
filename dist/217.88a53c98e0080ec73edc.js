...
var AssignmentSubmissionRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AssignmentSubmissionRoutingModule() {
    }
...
function AssignmentSubmissionComponent_button_56_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AssignmentSubmissionComponent_button_56_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r7); var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r6.clearFile(); });
...
var AssignmentSubmissionComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AssignmentSubmissionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    AssignmentSubmissionComponent.prototype.onFilePicked = function (event) {
        this.invalidFile = false;
    ...
    AssignmentSubmissionComponent.prototype.clearFile = function () {
        this.uploadAssignmentSubmission = null;
        this.fileName = null;
        this.fileInput.nativeElement.value = '';
        this.invalidFile = false;
    };
    AssignmentSubmissionComponent.prototype.submitAssignmentDetails = function () {
    ...
    AssignmentSubmissionComponent.prototype.saveAssignment = function () {
        var _this = this;
        this.assignmentSubmissionDetailsForm.markAllAsTouched();
        if (this.assignmentSubmissionDetailsForm.invalid) {
            this.showToastr('top-right', 'danger', 'Assignment details are required');
        ...
        if (!this.assignmentSubmission) {
            ...
            this.assignmentSubmissionService.updateAssignmentSubmission(assignmentSubmission).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Assignment Submission Updated Successfully!');
                _this.back();
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
    ...
    AssignmentSubmissionComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AssignmentSubmissionComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    AssignmentSubmissionComponent.prototype.ngOnDestroy = function () { };
    ...
    AssignmentSubmissionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AssignmentSubmissionComponent, selectors: [["ngx-assignment-submission"]], viewQuery: function AssignmentSubmissionComponent_Query(rf, ctx) {
            ...
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AssignmentSubmissionComponent_Template_button_click_53_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r8); var _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](51); return _r2.click(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AssignmentSubmissionComponent_Template_input_click_55_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r8); var _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](51); return _r2.click(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
var AssignmentSubmissionModule = /** @class */ /*@__PURE__*/ (function () {
    function AssignmentSubmissionModule() {
    }
