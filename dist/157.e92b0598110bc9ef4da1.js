...
var ManageAssignmentRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageAssignmentRoutingModule() {
    }
...
function ManageAssignmentComponent_ng_container_31_div_1_tr_21_ng_container_14_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageAssignmentComponent_ng_container_31_div_1_tr_21_ng_container_14_Template_nb_icon_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r20); var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); var assignment_r15 = ctx_r19.$implicit; var i_r16 = ctx_r19.index; var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r18.deleteAssignmentAttachment(assignment_r15._id, assignment_r15.publicId, i_r16); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function ManageAssignmentComponent_ng_container_31_div_1_tr_21_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageAssignmentComponent_ng_container_31_div_1_tr_21_Template_button_click_16_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23); var assignment_r15 = ctx.$implicit; var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r22.assignmentSubmissions(assignment_r15); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageAssignmentComponent_ng_container_31_div_1_tr_21_Template_button_click_19_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23); var assignment_r15 = ctx.$implicit; var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r24.editAssignment(assignment_r15); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageAssignmentComponent_ng_container_31_div_1_tr_21_Template_button_click_22_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23); var assignment_r15 = ctx.$implicit; var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r25.deleteAssignment(assignment_r15._id); });
...
var ManageAssignmentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageAssignmentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageAssignmentComponent.prototype.onSelectSubject = function (subject) {
        this.subject = subject;
        this.getAssignments();
    };
    ManageAssignmentComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getAssignments();
    };
    ManageAssignmentComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    ManageAssignmentComponent.prototype.getAssignments = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageAssignmentComponent.prototype.addAssignment = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageAssignmentComponent.prototype.editAssignment = function (assignment) {
    ...
    ManageAssignmentComponent.prototype.assignmentSubmissions = function (assignment) {
        this.assignmentService.setAssignmentId(assignment._id);
        this.assignmentService.setAssignmentData(assignment);
        this.router.navigate(['../submission'], { relativeTo: this.route });
    };
    ManageAssignmentComponent.prototype.deleteAssignment = function (id) {
        var _this = this;
        this.loading = true;
        this.assignmentService.deleteAssignment(id).subscribe(function (res) {
            var index = _this.assignments.findIndex(function (assignment) { return assignment._id === id; });
            if (index >= 0) {
    ...
    ManageAssignmentComponent.prototype.getSubjectName = function (id) {
    ...
    ManageAssignmentComponent.prototype.deleteAssignmentAttachment = function (id, publicId, i) {
        var _this = this;
        this.assignmentService.deleteAssignmentAttachment(id, publicId).subscribe(function (res) {
            _this.assignments[i].fileName = null;
            _this.assignments[i].fileSize = null;
            _this.assignments[i].fileType = null;
            _this.assignments[i].secureUrl = null;
            _this.assignments[i].publicId = null;
            _this.showToastr('top-right', 'success', 'Attachment Deleted Successfully!');
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
        });
    };
    ManageAssignmentComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ManageAssignmentComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
...
var ManageAssignmentModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageAssignmentModule() {
    }
