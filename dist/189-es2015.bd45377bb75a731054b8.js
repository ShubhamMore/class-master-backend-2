...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(32)]).then(__webpack_require__.bind(null, /*! ./add-discount-and-offer/add-discount-and-offer.module */ "./src/app/institute/branch/manage-branch/discount-and-offer/add-discount-and-offer/add-discount-and-offer.module.ts")).then((m) => m.AddDiscountAndOfferModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(32)]).then(__webpack_require__.bind(null, /*! ./add-discount-and-offer/add-discount-and-offer.module */ "./src/app/institute/branch/manage-branch/discount-and-offer/add-discount-and-offer/add-discount-and-offer.module.ts")).then((m) => m.AddDiscountAndOfferModule),
