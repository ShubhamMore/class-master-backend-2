...
var ManageOnlineTestQuestionsRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageOnlineTestQuestionsRoutingModule() {
    }
...
var ManageOnlineTestQuestionsComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageOnlineTestQuestionsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageOnlineTestQuestionsComponent.prototype.addOnlineExamQuestion = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageOnlineTestQuestionsComponent.prototype.editOnlineExamQuestion = function (onlineExamQuestion) {
    ...
    ManageOnlineTestQuestionsComponent.prototype.changeOnlineExamQuestionStatus = function (id, status, i) {
        var _this = this;
        this.loading = true;
        this.onlineExamQuestionService.changeOnlineExamQuestionStatus(id, status).subscribe(function (res) {
            _this.onlineExamQuestions[i].status = status;
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
    ...
    ManageOnlineTestQuestionsComponent.prototype.deleteOnlineExamQuestion = function (id, i) {
        var _this = this;
        this.loading = true;
        this.onlineExamQuestionService.deleteOnlineExamQuestion(id).subscribe(function (res) {
            _this.onlineExamQuestions.splice(i, 1);
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
    ...
    ManageOnlineTestQuestionsComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ManageOnlineTestQuestionsComponent.prototype.back = function () {
        this.router.navigate(['../../manage'], { relativeTo: this.route });
    };
    ManageOnlineTestQuestionsComponent.prototype.ngOnDestroy = function () { };
...
var ManageOnlineTestQuestionsModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageOnlineTestQuestionsModule() {
    }
