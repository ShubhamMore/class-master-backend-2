...
function CheckoutComponent_tr_27_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function CheckoutComponent_tr_27_Template_input_input_5_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.changeCouponCode($event.target.value); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "button", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CheckoutComponent_tr_27_Template_button_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.applyCoupon(); });
...
var CheckoutComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    CheckoutComponent.prototype.onClose = function () {
        this.ref.close({ status: false });
    };
    CheckoutComponent.prototype.changeCouponCode = function (code) {
        this.couponCode = code;
    };
    CheckoutComponent.prototype.calculateCouponDiscount = function (coupon) {
    ...
    CheckoutComponent.prototype.getAmount = function (amount) {
        amount = parseFloat(amount.toString());
        return amount.toFixed(2).toString();
    };
    CheckoutComponent.prototype.showToastr = function (position, status, message) {
    ...
    CheckoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CheckoutComponent, selectors: [["ngx-checkout"]], decls: 35, vars: 12, consts: [[1, "checkout"], ["nbButton", "", "size", "small", 1, "float-right", 3, "click"], ["icon", "close"], [1, "table-responsive"], [1, "table", "table-bordered"], [4, "ngIf"], ["type", "button", "nbButton", "", "size", "small", "status", "primary", 1, "float-right", 3, "click"], ["type", "text", "nbInput", "", "fullWidth", "", 3, "input"], ["type", "button", "nbSuffix", "", "nbButton", "", "size", "small", "ghost", "", "nbTooltip", "Apply Coupon Now", "status", "success", 3, "click"], ["icon", "paper-plane-outline"]], template: function CheckoutComponent_Template(rf, ctx) {
            if (rf & 1) {
...
var CheckoutService = /** @class */ /*@__PURE__*/ (function () {
    function CheckoutService(httpService) {
        this.httpService = httpService;
    }
    CheckoutService.prototype.setCheckoutDetails = function (checkoutDetails) {
        this.checkoutDetails = checkoutDetails;
    };
    CheckoutService.prototype.getCheckoutDetails = function () {
