...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(234)]).then(__webpack_require__.bind(null, /*! ./manage-course/manage-course.module */ "./src/app/student/branch/course/manage-course/manage-course.module.ts")).then((m) => m.ManageCourseModule),
            },
            {
                path: 'material',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(222)]).then(__webpack_require__.bind(null, /*! ./course-material/course-material.module */ "./src/app/student/branch/course/course-material/course-material.module.ts")).then((m) => m.CourseMaterialModule),
            },
            {
                path: 'installment',
            ...
            {
                path: 'performance',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(225)]).then(__webpack_require__.bind(null, /*! ./course-performance/course-performance.module */ "./src/app/student/branch/course/course-performance/course-performance.module.ts")).then((m) => m.CoursePerformanceModule),
            },
            {
                path: 'lecture',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(227)]).then(__webpack_require__.bind(null, /*! ./lecture/lecture.module */ "./src/app/student/branch/course/lecture/lecture.module.ts")).then((m) => m.LectureModule),
            },
            {
                path: 'assignment',
            ...
            {
                path: 'online-test',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(237)]).then(__webpack_require__.bind(null, /*! ./online-test/online-test.module */ "./src/app/student/branch/course/online-test/online-test.module.ts")).then((m) => m.OnlineTestModule),
            },
            {
                path: '',
