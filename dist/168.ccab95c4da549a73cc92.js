...
var routes = [
    {
        ...
        children: [
            {
                path: 'test',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 53).then(__webpack_require__.bind(null, /*! ./test/test.module */ "./src/app/institute/branch/exam/test/test.module.ts")).then(function (m) { return m.TestModule; }); },
            },
            {
                path: 'online-test',
                loadChildren: function () {
                    return __webpack_require__.e(/*! import() */ 52).then(__webpack_require__.bind(null, /*! ./online-test/online-test.module */ "./src/app/institute/branch/exam/online-test/online-test.module.ts")).then(function (m) { return m.OnlineTestModule; });
                },
            },
            {
                path: '',
