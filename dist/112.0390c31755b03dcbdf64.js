        ...
        children: [
            {
                ...
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(113)]).then(__webpack_require__.bind(null, /*! ./manage-batch-test/manage-batch-test.module */ "./src/app/employee/branch/exam/test/batch-test/manage-batch-test/manage-batch-test.module.ts")).then(function (m) { return m.ManageBatchTestModule; });
                },
            },
            {
                path: 'add',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(18)]).then(__webpack_require__.bind(null, /*! ./add-test/add-test.module */ "./src/app/employee/branch/exam/test/batch-test/add-test/add-test.module.ts")).then(function (m) { return m.AddTestModule; }); },
            },
            {
                path: 'edit',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(18)]).then(__webpack_require__.bind(null, /*! ./add-test/add-test.module */ "./src/app/employee/branch/exam/test/batch-test/add-test/add-test.module.ts")).then(function (m) { return m.AddTestModule; }); },
            },
            {
                path: 'score',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(111)]).then(__webpack_require__.bind(null, /*! ./add-test-score/add-test-score.module */ "./src/app/employee/branch/exam/test/batch-test/add-test-score/add-test-score.module.ts")).then(function (m) { return m.AddTestScoreModule; });
                },
            },
            {
                path: '',
