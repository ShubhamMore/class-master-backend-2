...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[62], {
  ...
  /***/
  function srcAppAdminSettingsSettingsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAdminSettingsSettingsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_admin_zoom_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function SettingsComponent(router, route, toastrService, adminZoomService) {
      ...
      _createClass(SettingsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.zoomKeysForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            accessToken: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, {
              validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
            }),
            secretToken: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, {
              validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
            })
          });
          this.adminZoomService.getAdminZoomKeys().subscribe(function (zoomKeys) {
            if (zoomKeys) {
        ...
        value: function saveZoomKeys() {
          ...
          this.adminZoomService.saveAdminZoomKeys(keys).subscribe(function (res) {
            _this2.adminZoomService.getAdminZoomAuthLink().subscribe(function (responce) {
    ...
    SettingsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      decls: 29,
      vars: 8,
      consts: [["nbButton", "", "size", "small", "status", "warning", 1, "float-right", 3, "click"], [1, "row"], [1, "col-md-8", "col-sm-10", "col-12", "mx-auto"], [3, "formGroup", "submit"], [1, "col-md-6", "col-12"], [1, "form-control-group"], ["for", "input-access-token", 1, "label"], ["type", "text", "nbInput", "", "id", "input-access-token", "name", "accessToken", "formControlName", "accessToken", "placeholder", "Zoom Access Token", "fullWidth", "", 3, "status"], [4, "ngIf"], ["for", "input-secret-token", 1, "label"], ["nbInput", "", "id", "input-secret-token", "name", "secretToken", "formControlName", "secretToken", "placeholder", "Zoom Secret Token", "fullWidth", "", 3, "type", "status"], ["type", "button", "nbSuffixnbButton", "", "size", "small", "ghost", "", 3, "click"], ["pack", "eva", 3, "icon"], [1, "col-12", "mt-3"], ["type", "submit", "nbButton", "", "size", "small", "status", "primary", 1, "float-right"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"]],
      template: function SettingsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function SettingsComponent_Template_button_click_2_listener() {
            return ctx.back();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("submit", function SettingsComponent_Template_form_submit_9_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](SettingsComponent, [{
        ...
        return [{
          ...
          type: _services_admin_zoom_service__WEBPACK_IMPORTED_MODULE_4__["AdminZoomService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppAdminSettingsSettingsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
