...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(182)]).then(__webpack_require__.bind(null, /*! ./manage-discount-and-offer/manage-discount-and-offer.module */ "./src/app/institute/branch/manage-branch/discount-and-offer/manage-discount-and-offer/manage-discount-and-offer.module.ts")).then((m) => m.ManageDiscountAndOfferModule),
            },
            {
                path: 'add',
