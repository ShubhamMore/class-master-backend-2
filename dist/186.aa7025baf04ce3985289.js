...
var ManageCourseMaterialRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageCourseMaterialRoutingModule() {
    }
...
function ManageCourseMaterialComponent_ng_container_22_div_1_tr_15_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageCourseMaterialComponent_ng_container_22_div_1_tr_15_Template_button_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var courseMaterial_r13 = ctx.$implicit; var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r15.viewCourseMaterial(courseMaterial_r13); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageCourseMaterialComponent_ng_container_22_div_1_tr_15_Template_button_click_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var courseMaterial_r13 = ctx.$implicit; var i_r14 = ctx.index; var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r17.changeCourseMaterialStatus(courseMaterial_r13._id, !courseMaterial_r13.status, i_r14); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](14);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "td");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](16, "button", 25);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageCourseMaterialComponent_ng_container_22_div_1_tr_15_Template_button_click_16_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var courseMaterial_r13 = ctx.$implicit; var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r18.deleteCourseMaterial(courseMaterial_r13._id); });
...
var ManageCourseMaterialComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageCourseMaterialComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageCourseMaterialComponent.prototype.getFileSize = function (fileSize) {
        var size = this.storageService.convertByteToUnit(fileSize);
        return size.value.toFixed(1) + ' ' + size.unit;
    };
    ManageCourseMaterialComponent.prototype.getCourseMaterials = function (subject) {
        var _this = this;
        this.loading = true;
        this.subject = subject;
        this.courseMaterialService
            .getCourseMaterials(this.branchId, this.course.basicDetails.category, this.course._id, subject)
            .subscribe(function (courseMaterials) {
            _this.courseMaterials = courseMaterials;
            _this.loading = false;
        }, function (err) {
            _this.loading = false;
        });
    };
    ManageCourseMaterialComponent.prototype.addCourseMaterial = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageCourseMaterialComponent.prototype.deleteCourseMaterial = function (id, i) {
        var _this = this;
        this.loading = true;
        this.courseMaterialService.deleteCourseMaterial(id).subscribe(function (res) {
            _this.courseMaterials.splice(i, 1);
            _this.showToastr('top-right', 'success', "CourseMaterial Deleted Successfully!");
            _this.loading = false;
        }, function (err) {
    ...
    ManageCourseMaterialComponent.prototype.viewCourseMaterial = function (courseMaterial) {
    ...
    ManageCourseMaterialComponent.prototype.getSubject = function (subjectId) {
        var subject = this.course.subjects.find(function (curSubject) { return curSubject._id === subjectId; });
        if (subject) {
            return subject.subject;
        }
        return '--';
    };
    ManageCourseMaterialComponent.prototype.changeCourseMaterialStatus = function (id, status, i) {
        var _this = this;
        this.loading = true;
        this.courseMaterialService.changeCourseMaterialStatus(id, status).subscribe(function (res) {
            _this.courseMaterials[i].status = status;
            _this.showToastr('top-right', 'success', "CourseMaterial " + (status ? 'Activated' : 'Deactivated') + " Successfully!");
            _this.loading = false;
        }, function (err) {
            _this.showToastr('top-right', 'danger', err);
            _this.loading = false;
    ...
    ManageCourseMaterialComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageCourseMaterialComponent, selectors: [["ngx-manage-course-material"]], decls: 25, vars: 4, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], [4, "ngIf"], [1, "col-md-3", "col-sm-4"], ["nbButton", "", "size", "small", "status", "primary", "fullWidth", "", 3, "click"], ["icon", "plus-circle-outline"], [1, "col-md-9"], [1, "col-md-3"], ["id", "select-subject", "name", "subject", "fullWidth", "", "placeholder", "Select Subject", 3, "selected", "selectedChange", 4, "ngIf"], [1, "body-container"], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], ["id", "select-subject", "name", "subject", "fullWidth", "", "placeholder", "Select Subject", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["CourseMaterials", ""], [1, "table-responsive"], [1, "table"], ["colspan", "3"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "info", 3, "click"], ["nbButton", "", "size", "small", 3, "status", "click"], ["nbButton", "", "size", "small", "status", "danger", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function ManageCourseMaterialComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageCourseMaterialComponent_Template_button_click_8_listener() { return ctx.addCourseMaterial(); });
...
var ManageCourseMaterialModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageCourseMaterialModule() {
    }
