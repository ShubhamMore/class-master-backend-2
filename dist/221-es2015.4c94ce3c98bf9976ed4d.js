...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(62)]).then(__webpack_require__.bind(null, /*! ./manage-course-installment/manage-course-installment.module */ "./src/app/student/branch/course/course-installment/manage-course-installment/manage-course-installment.module.ts")).then((m) => m.ManageCourseInstallmentModule),
            },
            {
                path: 'receipt',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(220)]).then(__webpack_require__.bind(null, /*! ./course-installment-receipt/course-installment-receipt.module */ "./src/app/student/branch/course/course-installment/course-installment-receipt/course-installment-receipt.module.ts")).then((m) => m.CourseInstallmentReceiptModule),
            },
            {
                path: '',
                redirectTo: 'manage',
