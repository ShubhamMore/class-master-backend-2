...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(221)]).then(__webpack_require__.bind(null, /*! ./manage-assignment/manage-assignment.module */ "./src/app/student/branch/course/assignment/manage-assignment/manage-assignment.module.ts")).then((m) => m.ManageAssignmentModule),
            },
            {
                path: 'submission',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(220)]).then(__webpack_require__.bind(null, /*! ./assignment-submission/assignment-submission.module */ "./src/app/student/branch/course/assignment/assignment-submission/assignment-submission.module.ts")).then((m) => m.AssignmentSubmissionModule),
            },
            {
                path: '',
                redirectTo: 'manage',
