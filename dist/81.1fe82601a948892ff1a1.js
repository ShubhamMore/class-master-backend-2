...
function ManageCourseComponent_ng_container_24_div_1_tr_15_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageCourseComponent_ng_container_24_div_1_tr_15_Template_button_click_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); var course_r9 = ctx.$implicit; var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r13.courseMaterial(course_r9); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageCourseComponent_ng_container_24_div_1_tr_15_Template_button_click_19_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); var course_r9 = ctx.$implicit; var i_r10 = ctx.index; var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r15.changeCourseStatus(course_r9._id, !course_r9.status, i_r10); });
...
var ManageCourseComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageCourseComponent.prototype.getCourses = function (category) {
        var _this = this;
        this.loading = true;
    ...
    ManageCourseComponent.prototype.getCategory = function (categoryId) {
    ...
    ManageCourseComponent.prototype.addCourse = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageCourseComponent.prototype.courseBatches = function (course) {
    ...
    ManageCourseComponent.prototype.courseMaterial = function (course) {
        this.courseService.setCourseId(course._id);
        this.courseService.setCourseData(course);
        this.router.navigate(['../course-material'], { relativeTo: this.route });
    };
    ManageCourseComponent.prototype.editCourse = function (id) {
        this.courseService.setCourseId(id);
        this.router.navigate(['../edit'], { relativeTo: this.route, queryParams: { mode: 'edit' } });
    };
    ManageCourseComponent.prototype.changeCourseStatus = function (id, status, i) {
        var _this = this;
        this.loading = true;
        this.courseService.changeCourseStatus(id, status).subscribe(function (res) {
            _this.courses[i].status = status;
            _this.showToastr('top-right', 'success', "Course " + (status ? 'Activated' : 'Deactivated') + " Successfully!");
            _this.loading = false;
        }, function (err) {
