...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 84).then(__webpack_require__.bind(null, /*! ./manage-batch-online-test/manage-batch-online-test.module */ "./src/app/employee/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.module.ts")).then((m) => m.ManageBatchOnlineTestModule),
            },
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(85)]).then(__webpack_require__.bind(null, /*! ./manage-online-test/manage-online-test.module */ "./src/app/employee/branch/exam/online-test/manage-online-test/manage-online-test.module.ts")).then((m) => m.ManageOnlineTestModule),
            },
            {
                path: 'add',
            ...
            {
                path: 'question',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(87)]).then(__webpack_require__.bind(null, /*! ./online-test-question/online-test-question.module */ "./src/app/employee/branch/exam/online-test/online-test-question/online-test-question.module.ts")).then((m) => m.OnlineTestQuestionModule),
            },
            {
                path: '',
                redirectTo: 'batch',
