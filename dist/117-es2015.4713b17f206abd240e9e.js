...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(116)]).then(__webpack_require__.bind(null, /*! ./manage-salary/manage-salary.module */ "./src/app/employee/branch/salary/manage-salary/manage-salary.module.ts")).then((m) => m.ManageSalaryModule),
            },
            {
                path: 'view',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(118)]).then(__webpack_require__.bind(null, /*! ./view-salary-receipt/view-salary-receipt.module */ "./src/app/employee/branch/salary/view-salary-receipt/view-salary-receipt.module.ts")).then((m) => m.ViewSalaryReceiptModule),
            },
            {
                path: '',
                redirectTo: 'manage',
...
let SalaryRoutingModule = /*@__PURE__*/ (() => {
    class SalaryRoutingModule {
    }
    SalaryRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: SalaryRoutingModule });
    SalaryRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function SalaryRoutingModule_Factory(t) { return new (t || SalaryRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] });
