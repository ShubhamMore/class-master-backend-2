...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(87)]).then(__webpack_require__.bind(null, /*! ./manage-batch-test/manage-batch-test.module */ "./src/app/employee/branch/exam/test/batch-test/manage-batch-test/manage-batch-test.module.ts")).then((m) => m.ManageBatchTestModule),
            },
            {
                path: 'add',
            ...
            {
                path: 'score',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(85)]).then(__webpack_require__.bind(null, /*! ./add-test-score/add-test-score.module */ "./src/app/employee/branch/exam/test/batch-test/add-test-score/add-test-score.module.ts")).then((m) => m.AddTestScoreModule),
            },
            {
                path: '',
                redirectTo: 'manage',
