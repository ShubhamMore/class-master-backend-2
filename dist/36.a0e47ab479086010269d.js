...
var routes = [
    {
        ...
        children: [
            {
                path: 'home',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 87).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/admin/home/home.module.ts")).then(function (m) { return m.HomeModule; }); },
                canActivate: [],
            },
            {
                path: 'institutes',
                loadChildren: function () {
                    return __webpack_require__.e(/*! import() */ 88).then(__webpack_require__.bind(null, /*! ./institutes/institutes.module */ "./src/app/admin/institutes/institutes.module.ts")).then(function (m) { return m.InstitutesModule; });
                },
                canActivate: [],
            },
            {
                path: 'coupon',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(59)]).then(__webpack_require__.bind(null, /*! ./coupon/coupon.module */ "./src/app/admin/coupon/coupon.module.ts")).then(function (m) { return m.CouponModule; }); },
                canActivate: [],
            },
            {
                path: 'membership-plans',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(42)]).then(__webpack_require__.bind(null, /*! ./membership-plans/membership-plans.module */ "./src/app/admin/membership-plans/membership-plans.module.ts")).then(function (m) { return m.MembershipPlansModule; });
                },
                canActivate: [],
            },
            {
                path: 'settings',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 89).then(__webpack_require__.bind(null, /*! ./settings/settings.module */ "./src/app/admin/settings/settings.module.ts")).then(function (m) { return m.SettingsModule; }); },
                canActivate: [],
            },
            {
                path: 'users',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 90).then(__webpack_require__.bind(null, /*! ./users/users.module */ "./src/app/admin/users/users.module.ts")).then(function (m) { return m.UsersModule; }); },
                canActivate: [],
            },
            {
                path: '',
...
var AdminZoomService = /** @class */ /*@__PURE__*/ (function () {
    function AdminZoomService(httpService) {
        this.httpService = httpService;
    }
    AdminZoomService.prototype.saveAdminZoomKeys = function (keys) {
        var data = {
    ...
    AdminZoomService.prototype.getAdminZoomKeys = function () {
        var data = {
    ...
    AdminZoomService.prototype.getAdminZoomAuthLink = function () {
        var data = {
...
var InstituteService = /** @class */ /*@__PURE__*/ (function () {
    function InstituteService(httpService) {
        this.httpService = httpService;
    }
    InstituteService.prototype.getInstitutes = function () {
        var data = {
            api: 'getInstitutes',
            data: {},
        };
    ...
    InstituteService.prototype.getInstituteBranches = function (institute) {
        var data = {
    ...
    InstituteService.prototype.getInstituteBranch = function (branch) {
        var data = {
    ...
    InstituteService.prototype.getInstituteBranchHistory = function (branch) {
        var data = {
    ...
    InstituteService.prototype.deactivateInstituteBranch = function (branch) {
        var data = {
    ...
    InstituteService.prototype.activateInstituteBranch = function (branch, planType) {
        var data = {
            api: 'activateInstituteBranch',
            data: { branch: branch, planType: planType },
        };
        return this.httpService.httpPost(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (response) {
            return response;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (err) {
...
var UserService = /** @class */ /*@__PURE__*/ (function () {
    ...
    UserService.prototype.changeUserStatus = function (user, status) {
        var data = {
