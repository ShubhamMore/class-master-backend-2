(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[72], {
    ...
    function srcAppInstituteTransactionTransactionRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TransactionRoutingModule = /*@__PURE__*/function () {
    ...
    function srcAppInstituteTransactionTransactionComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function TransactionComponent_div_5_div_1_tr_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TransactionComponent_div_5_div_1_tr_14_Template_button_click_11_listener() {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](5, 4, transaction_r7._id));
      ...
      function TransactionComponent_div_5_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](14, TransactionComponent_div_5_div_1_tr_14_Template, 13, 6, "tr", 6);
      ...
      var TransactionService = /*@__PURE__*/function () {
        var TransactionService = /*#__PURE__*/function () {
          ...
          _createClass(TransactionService, [{
            key: "setInstituteTransactionData",
            value: function setInstituteTransactionData(instituteTransaction) {
              this.instituteTransaction.next(instituteTransaction);
            }
          }, {
            key: "getInstituteTransactionData",
            value: function getInstituteTransactionData() {
              return this.instituteTransaction;
            }
          }, {
            key: "deleteInstituteTransactionData",
            value: function deleteInstituteTransactionData() {
              this.instituteTransaction.next(null);
            }
          }, {
            key: "setStudentTransactionData",
            value: function setStudentTransactionData(studentTransaction) {
              this.studentTransaction.next(studentTransaction);
            }
          }, {
            key: "getStudentTransactionData",
            value: function getStudentTransactionData() {
              return this.studentTransaction;
            }
          }, {
            key: "deleteStudentTransactionData",
            value: function deleteStudentTransactionData() {
            ...
            key: "getInstituteTransaction",
            value: function getInstituteTransaction(id) {
              var data = {
            ...
            key: "getInstituteTransactions",
            value: function getInstituteTransactions() {
              var data = {
            ...
            key: "getStudentTransaction",
            value: function getStudentTransaction(id) {
              var data = {
            ...
            key: "getStudentTransactions",
            value: function getStudentTransactions() {
              var data = {
        ...
        TransactionService.ɵfac = function TransactionService_Factory(t) {
          return new (t || TransactionService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_services_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"]));
        };
