...
var ManageCourseInstallmentRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageCourseInstallmentRoutingModule() {
    }
...
function ManageCourseInstallmentComponent_ng_container_9_div_36_tr_15_button_10_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ManageCourseInstallmentComponent_ng_container_9_div_36_tr_15_button_10_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r12); var installment_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit; var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](3); return installment_r7.receiptId ? ctx_r10.showReceipt(installment_r7.receiptId) : ctx_r10.payInstallment(installment_r7); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    }
    if (rf & 2) {
        var installment_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit;
...
var ManageCourseInstallmentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageCourseInstallmentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageCourseInstallmentComponent.prototype.getStudentCourseInstallment = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageCourseInstallmentComponent.prototype.showReceipt = function (receiptId) {
    ...
    ManageCourseInstallmentComponent.prototype.onClosePayment = function (order) {
        if (order.status) {
            this.generateStudentCourseInstallmentReceipt(order.order, order.receipt);
        }
    };
    ManageCourseInstallmentComponent.prototype.onCheckout = function (checkout) {
        var _this = this;
        if (checkout.status) {
            this.dialogService
    ...
    ManageCourseInstallmentComponent.prototype.payInstallment = function (installment) {
        var _this = this;
    ...
    ManageCourseInstallmentComponent.prototype.generateStudentCourseInstallmentReceipt = function (order, receipt) {
        var _this = this;
        this.loading = true;
        this.studentCourseInstallmentReceiptService
            .generateStudentCourseInstallmentReceipt(order, receipt)
            .subscribe(function (res) {
            _this.showToastr('top-right', 'success', 'Receipt Generated Successfully');
            _this.getStudentCourseInstallment();
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
        });
    };
    ManageCourseInstallmentComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ManageCourseInstallmentComponent.prototype.ngOnDestroy = function () {
...
var ManageCourseInstallmentModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageCourseInstallmentModule() {
    }
...
var CheckoutComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    CheckoutComponent.prototype.ngOnInit = function () {
        ...
        this.studentCourseInstallmentService
            ...
            .subscribe(function (installment) {
            _this.installment = installment;
        });
