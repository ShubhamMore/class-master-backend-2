...
/***/ "./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test-routing.module.ts":
/*!***********************************************************************************************************************!*\
  !*** ./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test-routing.module.ts ***!
  \***********************************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManageBatchOnlineTestRoutingModule", function() { return ManageBatchOnlineTestRoutingModule; });
/* harmony import */ var _manage_batch_online_test_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manage-batch-online-test.component */ "./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.component.ts");
...
var routes = [
    { path: '', component: _manage_batch_online_test_component__WEBPACK_IMPORTED_MODULE_0__["ManageBatchOnlineTestComponent"] },
    {
        path: 'page-not-found',
...
var ManageBatchOnlineTestRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBatchOnlineTestRoutingModule() {
    }
    ManageBatchOnlineTestRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: ManageBatchOnlineTestRoutingModule });
    ManageBatchOnlineTestRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function ManageBatchOnlineTestRoutingModule_Factory(t) { return new (t || ManageBatchOnlineTestRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] });
    return ManageBatchOnlineTestRoutingModule;
}());

(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](ManageBatchOnlineTestRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] }); })();


/***/ }),

/***/ "./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.component.ts":
/*!******************************************************************************************************************!*\
  !*** ./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.component.ts ***!
  \******************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManageBatchOnlineTestComponent", function() { return ManageBatchOnlineTestComponent; });
...
function ManageBatchOnlineTestComponent_ng_container_19_div_1_tr_17_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageBatchOnlineTestComponent_ng_container_19_div_1_tr_17_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14); var batch_r11 = ctx.$implicit; var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r13.manageOnlineExam(batch_r11); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, " Manage Online Exam ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
...
function ManageBatchOnlineTestComponent_ng_container_19_div_1_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](17, ManageBatchOnlineTestComponent_ng_container_19_div_1_tr_17_Template, 14, 5, "tr", 16);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
...
function ManageBatchOnlineTestComponent_ng_container_19_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, ManageBatchOnlineTestComponent_ng_container_19_div_1_Template, 18, 1, "div", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, ManageBatchOnlineTestComponent_ng_container_19_ng_template_2_Template, 2, 0, "ng-template", null, 13, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
...
var ManageBatchOnlineTestComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageBatchOnlineTestComponent.prototype.ngOnInit = function () {
        this.loading = true;
    ...
    ManageBatchOnlineTestComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    ManageBatchOnlineTestComponent.prototype.getCourses = function () {
        var _this = this;
        this.courseService.getCoursesData().subscribe(function (courses) {
            _this.courses = courses;
        });
    };
    ManageBatchOnlineTestComponent.prototype.onSelectCategory = function (category) {
        this.category = category;
        this.course = '';
        this.myCourses = this.courses.filter(function (course) { return course.basicDetails.category === category; });
        this.getBatches(this.category, this.course);
    };
    ManageBatchOnlineTestComponent.prototype.onSelectCourse = function (course) {
        this.course = course;
        this.getBatches(this.category, this.course);
    };
    ManageBatchOnlineTestComponent.prototype.getBatches = function (category, course) {
        var _this = this;
        this.loading = true;
    ...
    ManageBatchOnlineTestComponent.prototype.manageOnlineExam = function (batch) {
    ...
    ManageBatchOnlineTestComponent.prototype.getCategory = function (categoryId) {
    ...
    ManageBatchOnlineTestComponent.prototype.getCourse = function (courseId) {
    ...
    ManageBatchOnlineTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageBatchOnlineTestComponent, selectors: [["ngx-manage-batch-online-test"]], decls: 22, vars: 6, consts: [[1, "row"], [1, "col-md-6", "col-sm-4"], [1, "col-md-3", "col-sm-4"], ["id", "select-category", "name", "category", "fullWidth", "", "placeholder", "Select Category", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-course", "name", "course", "fullWidth", "", "placeholder", "Select Course", 3, "selected", "selectedChange"], [1, "body-container"], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noBatches", ""], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "primary", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function ManageBatchOnlineTestComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageBatchOnlineTestComponent_Template_nb_select_selectedChange_7_listener($event) { return ctx.onSelectCategory($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](10, ManageBatchOnlineTestComponent_nb_option_10_Template, 2, 2, "nb-option", 5);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "div", 2);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "nb-select", 6);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageBatchOnlineTestComponent_Template_nb_select_selectedChange_12_listener($event) { return ctx.onSelectCourse($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](15, ManageBatchOnlineTestComponent_nb_option_15_Template, 2, 2, "nb-option", 5);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](19, ManageBatchOnlineTestComponent_ng_container_19_Template, 4, 2, "ng-container", 9);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](20, ManageBatchOnlineTestComponent_ng_template_20_Template, 2, 0, "ng-template", null, 10, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/***/ "./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.module.ts":
/*!***************************************************************************************************************!*\
  !*** ./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.module.ts ***!
  \***************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManageBatchOnlineTestModule", function() { return ManageBatchOnlineTestModule; });
...
/* harmony import */ var _manage_batch_online_test_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./manage-batch-online-test-routing.module */ "./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test-routing.module.ts");
/* harmony import */ var _manage_batch_online_test_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./manage-batch-online-test.component */ "./src/app/institute/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.component.ts");
...
var ManageBatchOnlineTestModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageBatchOnlineTestModule() {
    }
    ManageBatchOnlineTestModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: ManageBatchOnlineTestModule });
    ManageBatchOnlineTestModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function ManageBatchOnlineTestModule_Factory(t) { return new (t || ManageBatchOnlineTestModule)(); }, imports: [[
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _manage_batch_online_test_routing_module__WEBPACK_IMPORTED_MODULE_3__["ManageBatchOnlineTestRoutingModule"],
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](ManageBatchOnlineTestModule, { declarations: [_manage_batch_online_test_component__WEBPACK_IMPORTED_MODULE_4__["ManageBatchOnlineTestComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _manage_batch_online_test_routing_module__WEBPACK_IMPORTED_MODULE_3__["ManageBatchOnlineTestRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbSelectModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbIconModule"],
