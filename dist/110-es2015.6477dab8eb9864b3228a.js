...
const routes = [
    {
        ...
        children: [
            {
                path: 'receipt',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(111)]).then(__webpack_require__.bind(null, /*! ./receipt-info/receipt-info.module */ "./src/app/employee/branch/manage-branch/receipt-info/receipt-info.module.ts")).then((m) => m.ReceiptInfoModule),
            },
            {
                path: 'course',
                loadChildren: () => __webpack_require__.e(/*! import() */ 106).then(__webpack_require__.bind(null, /*! ./course/course.module */ "./src/app/employee/branch/manage-branch/course/course.module.ts")).then((m) => m.CourseModule),
            },
            {
                path: 'discount-and-offers',
                loadChildren: () => __webpack_require__.e(/*! import() */ 108).then(__webpack_require__.bind(null, /*! ./discount-and-offer/discount-and-offer.module */ "./src/app/employee/branch/manage-branch/discount-and-offer/discount-and-offer.module.ts")).then((m) => m.DiscountAndOfferModule),
            },
            {
                path: '',
                redirectTo: 'course',
