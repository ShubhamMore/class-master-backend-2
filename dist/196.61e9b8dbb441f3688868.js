...
var routes = [{ path: '', component: _manage_schedule_component__WEBPACK_IMPORTED_MODULE_0__["ManageScheduleComponent"] }];
var ManageScheduleRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageScheduleRoutingModule() {
    }
...
var ManageScheduleComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageScheduleComponent.prototype.ngOnInit = function () {
        this.loading = true;
    ...
    ManageScheduleComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    ManageScheduleComponent.prototype.getCourses = function () {
        var _this = this;
        this.courseService.getCoursesData().subscribe(function (courses) {
            _this.courses = courses;
        });
    };
    ManageScheduleComponent.prototype.onSelectCategory = function (category) {
        this.category = category;
        this.course = '';
        this.myCourses = this.courses.filter(function (course) { return course.basicDetails.category === category; });
        this.getBatches(this.category, this.course);
    };
    ManageScheduleComponent.prototype.onSelectCourse = function (course) {
        this.course = course;
        this.getBatches(this.category, this.course);
    };
    ManageScheduleComponent.prototype.getBatches = function (category, course) {
        var _this = this;
        this.loading = true;
    ...
    ManageScheduleComponent.prototype.manageSchedule = function (batch) {
    ...
    ManageScheduleComponent.prototype.getCategory = function (categoryId) {
    ...
    ManageScheduleComponent.prototype.getCourse = function (courseId) {
    ...
    ManageScheduleComponent.prototype.showToastr = function (position, status, message) {
...
var ManageScheduleModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageScheduleModule() {
    }
