...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(142)]).then(__webpack_require__.bind(null, /*! ./manage-student-course/manage-student-course.module */ "./src/app/employee/branch/students-report/student-courses/manage-student-course/manage-student-course.module.ts")).then((m) => m.ManageStudentCourseModule),
            },
            {
                path: 'attendance',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(143)]).then(__webpack_require__.bind(null, /*! ./student-course-attendance/student-course-attendance.module */ "./src/app/employee/branch/students-report/student-courses/student-course-attendance/student-course-attendance.module.ts")).then((m) => m.StudentCourseAttendanceModule),
            },
            {
                path: 'performance',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(144)]).then(__webpack_require__.bind(null, /*! ./student-course-performance/student-course-performance.module */ "./src/app/employee/branch/students-report/student-courses/student-course-performance/student-course-performance.module.ts")).then((m) => m.StudentCoursePerformanceModule),
            },
            {
                path: '',
                redirectTo: 'manage',
