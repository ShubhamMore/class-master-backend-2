...
var ManageSalaryRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageSalaryRoutingModule() {
    }
...
/* harmony import */ var _services_employee_salary_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../../../../services/employee-salary.service */ "./src/app/services/employee-salary.service.ts");
...
function ManageSalaryComponent_ng_container_27_div_1_tr_15_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageSalaryComponent_ng_container_27_div_1_tr_15_Template_button_click_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14); var employeeSalary_r11 = ctx.$implicit; var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r13.viewEmployeeSalary(employeeSalary_r11); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageSalaryComponent_ng_container_27_div_1_tr_15_Template_button_click_16_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14); var employeeSalary_r11 = ctx.$implicit; var i_r12 = ctx.index; var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r15.changeEmployeeSalaryStatus(employeeSalary_r11._id, !employeeSalary_r11.status, i_r12); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](17);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](18, "td");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](19, "button", 23);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageSalaryComponent_ng_container_27_div_1_tr_15_Template_button_click_19_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14); var employeeSalary_r11 = ctx.$implicit; var i_r12 = ctx.index; var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r16.deleteEmployeeSalary(employeeSalary_r11._id, i_r12); });
...
var ManageSalaryComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageSalaryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageSalaryComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getEmployeeSalary();
    };
    ManageSalaryComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    ManageSalaryComponent.prototype.addEmployeeSalary = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
    ManageSalaryComponent.prototype.viewEmployeeSalary = function (employeeSalary) {
    ...
    ManageSalaryComponent.prototype.deleteEmployeeSalary = function (employeeSalary, i) {
        var _this = this;
        this.loading = true;
        this.employeeSalaryService.deleteEmployeeSalary(employeeSalary).subscribe(function (res) {
            _this.employeeSalaries.splice(i, 1);
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
    ...
    ManageSalaryComponent.prototype.changeEmployeeSalaryStatus = function (employeeSalary, status, i) {
        var _this = this;
        this.loading = true;
        this.employeeSalaryService.changeEmployeeSalaryStatus(employeeSalary, status).subscribe(function (res) {
            _this.employeeSalaries[i].status = status;
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
    ...
    ManageSalaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageSalaryComponent, selectors: [["ngx-manage-salary"]], decls: 30, vars: 6, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], [1, "col-md-3", "col-sm-4"], ["nbButton", "", "size", "small", "fullWidth", "", "status", "primary", 3, "click"], ["icon", "plus-circle-outline"], [1, "col-md-6", "col-sm-4"], ["id", "select-year", "name", "year", "fullWidth", "", "placeholder", "All Years", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-month", "name", "month", "fullWidth", "", "placeholder", "All Months", 3, "selected", "selectedChange"], [1, "body-container"], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noBatches", ""], [1, "table-responsive"], [1, "table"], ["colspan", "3"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "primary", 3, "click"], ["nbButton", "", "size", "small", 3, "status", "click"], ["nbButton", "", "size", "small", "status", "danger", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function ManageSalaryComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageSalaryComponent_Template_button_click_7_listener() { return ctx.addEmployeeSalary(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageSalaryComponent_Template_nb_select_selectedChange_15_listener($event) { return ctx.onSelectYear($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageSalaryComponent_Template_nb_select_selectedChange_20_listener($event) { return ctx.onSelectMonth($event); });
...
var ManageSalaryModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageSalaryModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](ManageSalaryModule, { declarations: [_manage_salary_component__WEBPACK_IMPORTED_MODULE_4__["ManageSalaryComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _manage_salary_routing_module__WEBPACK_IMPORTED_MODULE_3__["ManageSalaryRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbButtonModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbSelectModule"],
