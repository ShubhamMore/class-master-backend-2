...
var routes = [
    {
        ...
        children: [
            {
                path: 'dashboard',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(232)]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/student/branch/dashboard/dashboard.module.ts")).then(function (m) { return m.DashboardModule; }); },
            },
            {
                path: 'course',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 220).then(__webpack_require__.bind(null, /*! ./course/course.module */ "./src/app/student/branch/course/course.module.ts")).then(function (m) { return m.CourseModule; }); },
            },
            {
                path: '',
    ...
    BranchComponent.prototype.ngOnInit = function () {
        ...
        this.instituteKeysService.getInstitutePaymentAccessKey(this.branchId).subscribe(function (paymentGateway) {
            if (paymentGateway && paymentGateway.accessKey) {
                _this.instituteKeysService.setLocalInstitutePaymentAccessKey(paymentGateway.accessKey);
            }
        }, function (error) { });
    };
...
var StudentBranchService = /** @class */ /*@__PURE__*/ (function () {
    function StudentBranchService() {
    }
    StudentBranchService.prototype.setType = function (type) {
        this.type = type;
    };
    StudentBranchService.prototype.getType = function () {
        return this.type;
    };
