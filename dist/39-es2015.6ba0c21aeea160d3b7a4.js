...
const routes = [
    {
        ...
        children: [
            {
                path: 'profile',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(240)]).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/student/profile/profile.module.ts")).then((m) => m.ProfileModule),
                canActivate: [],
            },
            {
                path: 'home',
                loadChildren: () => __webpack_require__.e(/*! import() */ 239).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/student/home/home.module.ts")).then((m) => m.HomeModule),
                canActivate: [],
            },
            {
                path: 'branch',
