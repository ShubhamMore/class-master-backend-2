...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 144).then(__webpack_require__.bind(null, /*! ./batch-assignment/batch-assignment.module */ "./src/app/institute/branch/assignment/batch-assignment/batch-assignment.module.ts")).then((m) => m.BatchAssignmentModule),
            },
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(145)]).then(__webpack_require__.bind(null, /*! ./manage-assignment/manage-assignment.module */ "./src/app/institute/branch/assignment/manage-assignment/manage-assignment.module.ts")).then((m) => m.ManageAssignmentModule),
            },
            {
                path: 'submission',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(142)]).then(__webpack_require__.bind(null, /*! ./assignment-submission/assignment-submission.module */ "./src/app/institute/branch/assignment/assignment-submission/assignment-submission.module.ts")).then((m) => m.AssignmentSubmissionModule),
            },
            {
                path: 'add',
