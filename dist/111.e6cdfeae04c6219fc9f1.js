...
var AddTestScoreRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddTestScoreRoutingModule() {
    }
...
function AddTestScoreComponent_ng_container_54_ng_container_15_ng_container_9_p_1_Template(rf, ctx) {
    ...
    if (rf & 2) {
        var studentScore_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2).$implicit;
...
function AddTestScoreComponent_ng_container_54_ng_container_15_ng_container_9_Template(rf, ctx) {
    ...
    if (rf & 2) {
        var studentScore_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
...
function AddTestScoreComponent_ng_container_54_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("submit", function AddTestScoreComponent_ng_container_54_Template_form_submit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r15); var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r14.saveMarks(); });
...
var AddTestScoreComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddTestScoreComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    AddTestScoreComponent.prototype.getStudents = function () {
        var _this = this;
        this.loading = true;
        this.examService.getStudentsForExam(this.exam._id).subscribe(function (students) {
            ...
            var examScore = _this.getStudentsScore();
            examScore.controls = [];
            students.forEach(function (student) {
                _this.addStudentScore(student);
            });
            _this.loading = false;
        }, function (error) {
    ...
    AddTestScoreComponent.prototype.getStudentsScore = function () {
        return this.examMarksForm.get('marks');
    };
    AddTestScoreComponent.prototype.addStudentScore = function (student) {
        var examScore = this.getStudentsScore();
        examScore.push(this.newStudentScore(student));
    };
    AddTestScoreComponent.prototype.newStudentScore = function (student) {
    ...
    AddTestScoreComponent.prototype.isNumber = function (number) {
        return Number.isInteger(number);
    };
    AddTestScoreComponent.prototype.saveMarks = function () {
        var _this = this;
        ...
        this.examService.saveStudentsMarks(this.exam._id, studentScore).subscribe(function (res) {
            _this.showToastr('top-right', 'success', "Exam Marks Updated Successfully");
            _this.back();
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
        });
    };
    AddTestScoreComponent.prototype.getSubject = function (subject) {
    ...
    AddTestScoreComponent.prototype.back = function () {
        this.router.navigate(['../manage'], { relativeTo: this.route });
    };
    AddTestScoreComponent.prototype.showToastr = function (position, status, message) {
    ...
    AddTestScoreComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AddTestScoreComponent, selectors: [["ngx-add-test-score"]], decls: 59, vars: 10, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], [1, "col-md-3", "col-sm-4"], ["nbButton", "", "size", "small", "status", "warning", 1, "float-right", 3, "click"], [1, "col-md-6", "col-12"], [4, "ngIf", "ngIfElse"], ["noStudents", ""], ["noStudentMarks", ""], [1, "", 3, "formGroup", "submit"], [1, "col-12"], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], [1, "col-12", "text-right"], ["type", "submit", "nbButton", "", "size", "small", "status", "primary"], [3, "formGroup"], [1, "form-control-group"], ["type", "number", "nbInput", "", "fullWidth", "", "formControlName", "marks", "min", "0", 1, "input-marks", 3, "id", "name", "placeholder", "max", "status"], [4, "ngIf"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"], [1, "text-center", "pt-5", "pb-5"], [1, "text-center", "mt-5", "mb-5"]], template: function AddTestScoreComponent_Template(rf, ctx) {
            ...
            if (rf & 2) {
                var _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](56);
...
var AddTestScoreModule = /** @class */ /*@__PURE__*/ (function () {
    function AddTestScoreModule() {
    }
