...
var CollectStudentCourseInstallmentRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function CollectStudentCourseInstallmentRoutingModule() {
    }
...
function CollectStudentCourseInstallmentComponent_nb_card_0_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CollectStudentCourseInstallmentComponent_nb_card_0_Template_button_click_2_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r26); var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r25.back(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CollectStudentCourseInstallmentComponent_nb_card_0_Template_button_click_166_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r26); var ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r29.previousStep(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CollectStudentCourseInstallmentComponent_nb_card_0_Template_button_click_171_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r26); var ctx_r30 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r30.saveCourseInstallmentReceipt(); });
...
var CollectStudentCourseInstallmentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    CollectStudentCourseInstallmentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        ...
        if (this.studentCourseInstallmentReceiptId) {
            this.studentCourseInstallmentReceiptService
                ...
                .subscribe(function (studentCourseInstallmentReceipt) {
            ...
            this.studentCourseInstallmentService
                ...
                .subscribe(function (courseInstallment) {
    ...
    CollectStudentCourseInstallmentComponent.prototype.calculateTotalAmount = function () {
        ...
        this.courseInstallmentReceiptForm.patchValue({ totalAmount: totalAmount });
    };
    CollectStudentCourseInstallmentComponent.prototype.previousStep = function () {
        this.stepper.previous();
    };
    CollectStudentCourseInstallmentComponent.prototype.courseInstallmentReceiptFormSubmit = function () {
    ...
    CollectStudentCourseInstallmentComponent.prototype.saveCourseInstallmentReceipt = function () {
        var _this = this;
        if (this.courseInstallmentReceiptForm.invalid) {
            this.showToastr('top-right', 'danger', 'Receipt Details are Required');
            return;
        ...
        if (!this.studentCourseInstallmentReceipt) {
            this.studentCourseInstallmentReceiptService
                ...
                _this.showToastr('top-right', 'success', 'Installment Receipt Generated Successfully!');
            ...
            this.studentCourseInstallmentReceiptService
                ...
                .subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Installment Receipt Updated Successfully!');
                _this.back();
            }, function (err) {
                _this.showToastr('top-right', 'danger', err);
                _this.loading = false;
    ...
    CollectStudentCourseInstallmentComponent.prototype.getCourseName = function (courseId) {
    ...
    CollectStudentCourseInstallmentComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    CollectStudentCourseInstallmentComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    CollectStudentCourseInstallmentComponent.prototype.ngOnDestroy = function () {
...
var CollectStudentCourseInstallmentModule = /** @class */ /*@__PURE__*/ (function () {
    function CollectStudentCourseInstallmentModule() {
    }
