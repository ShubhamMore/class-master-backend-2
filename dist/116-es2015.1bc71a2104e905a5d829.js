...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(117)]).then(__webpack_require__.bind(null, /*! ./manage-batch/manage-batch.module */ "./src/app/employee/branch/manage-branch/course/batch/manage-batch/manage-batch.module.ts")).then((m) => m.ManageBatchModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, /*! ./add-batch/add-batch.module */ "./src/app/employee/branch/manage-branch/course/batch/add-batch/add-batch.module.ts")).then((m) => m.AddBatchModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, /*! ./add-batch/add-batch.module */ "./src/app/employee/branch/manage-branch/course/batch/add-batch/add-batch.module.ts")).then((m) => m.AddBatchModule),
