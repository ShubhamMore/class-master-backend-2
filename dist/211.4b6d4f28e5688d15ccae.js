...
var ManageInstituteRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageInstituteRoutingModule() {
    }
...
function ManageInstituteComponent_div_1_tr_10_button_21_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageInstituteComponent_div_1_tr_10_button_21_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); var branch_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r9.activateBranch(branch_r3._id); });
...
var ManageInstituteComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageInstituteComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this.branches = [];
    ...
    ManageInstituteComponent.prototype.getAddress = function (address) {
    ...
    ManageInstituteComponent.prototype.manageBranch = function (id) {
        this.branchService.setBranchId(id);
        this.router.navigate(['../branch/dashboard'], { relativeTo: this.route });
    };
    ManageInstituteComponent.prototype.activateBranch = function (id) {
        this.branchService.setBranchId(id);
        this.membershipService.setMembershipType('renew');
        this.router.navigate(['../membership-plans'], { relativeTo: this.route });
    };
    ManageInstituteComponent.prototype.viewBranch = function (id) {
        this.branchService.setBranchId(id);
        this.router.navigate(['../view'], { relativeTo: this.route });
    };
    ManageInstituteComponent.prototype.editBranch = function (id) {
        this.branchService.setBranchId(id);
...
var ManageInstituteModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageInstituteModule() {
    }
