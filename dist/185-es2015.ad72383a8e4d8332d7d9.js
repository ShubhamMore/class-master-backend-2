...
/***/ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule-routing.module.ts":
/*!*******************************************************************************************!*\
  !*** ./src/app/institute/branch/schedule/batch-schedule/batch-schedule-routing.module.ts ***!
  \*******************************************************************************************/
...
/* harmony import */ var _batch_schedule_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./batch-schedule.component */ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(186)]).then(__webpack_require__.bind(null, /*! ./manage-batch-schedule/manage-batch-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/manage-batch-schedule/manage-batch-schedule.module.ts")).then((m) => m.ManageBatchScheduleModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, /*! ./add-schedule/add-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/add-schedule/add-schedule.module.ts")).then((m) => m.AddScheduleModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, /*! ./add-schedule/add-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/add-schedule/add-schedule.module.ts")).then((m) => m.AddScheduleModule),
            ...
            {
                path: 'view',
                loadChildren: () => __webpack_require__.e(/*! import() */ 187).then(__webpack_require__.bind(null, /*! ./view-schedule/view-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/view-schedule/view-schedule.module.ts")).then((m) => m.ViewScheduleModule),
            },
            {
                path: '',
                redirectTo: 'manage',
...
BatchScheduleRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function BatchScheduleRoutingModule_Factory(t) { return new (t || BatchScheduleRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BatchScheduleRoutingModule, [{
...
/***/ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule.component.ts":
/*!**************************************************************************************!*\
  !*** ./src/app/institute/branch/schedule/batch-schedule/batch-schedule.component.ts ***!
  \**************************************************************************************/
...
function BatchScheduleComponent_router_outlet_0_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵsetClassMetadata"](BatchScheduleComponent, [{
    ...
    }], function () { return [{ type: _services_branch_service__WEBPACK_IMPORTED_MODULE_4__["BranchService"] }, { type: _services_course_service__WEBPACK_IMPORTED_MODULE_3__["CourseService"] }, { type: _services_batch_service__WEBPACK_IMPORTED_MODULE_2__["BatchService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }, { type: _services_branch_employee_service__WEBPACK_IMPORTED_MODULE_0__["BranchEmployeeService"] }]; }, null); })();


/***/ }),

/***/ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule.module.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/institute/branch/schedule/batch-schedule/batch-schedule.module.ts ***!
  \***********************************************************************************/
...
/* harmony import */ var _batch_schedule_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./batch-schedule-routing.module */ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule-routing.module.ts");
/* harmony import */ var _batch_schedule_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./batch-schedule.component */ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule.component.ts");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BatchScheduleModule, [{
