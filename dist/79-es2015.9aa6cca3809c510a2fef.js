...
/* harmony import */ var _manage_employee_salary_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manage-employee-salary.component */ "./src/app/employee/branch/employee/manage-employee-salary/manage-employee-salary.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(78)]).then(__webpack_require__.bind(null, /*! ./add-salary/add-salary.module */ "./src/app/employee/branch/employee/manage-employee-salary/add-salary/add-salary.module.ts")).then((m) => m.AddSalaryModule),
            },
            {
                path: 'view',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(81)]).then(__webpack_require__.bind(null, /*! ./view-salary-receipt/view-salary-receipt.module */ "./src/app/employee/branch/employee/manage-employee-salary/view-salary-receipt/view-salary-receipt.module.ts")).then((m) => m.ViewSalaryReceiptModule),
            },
            {
                path: '',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(80)]).then(__webpack_require__.bind(null, /*! ./manage-salary/manage-salary.module */ "./src/app/employee/branch/employee/manage-employee-salary/manage-salary/manage-salary.module.ts")).then((m) => m.ManageSalaryModule),
            },
            // {
            //   path: '',
...
let ManageEmployeeSalaryRoutingModule = /*@__PURE__*/ (() => {
    ...
    ManageEmployeeSalaryRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function ManageEmployeeSalaryRoutingModule_Factory(t) { return new (t || ManageEmployeeSalaryRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
...
let ManageEmployeeSalaryComponent = /*@__PURE__*/ (() => {
...
/* harmony import */ var _manage_employee_salary_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manage-employee-salary-routing.module */ "./src/app/employee/branch/employee/manage-employee-salary/manage-employee-salary-routing.module.ts");
/* harmony import */ var _manage_employee_salary_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./manage-employee-salary.component */ "./src/app/employee/branch/employee/manage-employee-salary/manage-employee-salary.component.ts");





let ManageEmployeeSalaryModule = /*@__PURE__*/ (() => {
