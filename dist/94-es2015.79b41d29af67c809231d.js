...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 93).then(__webpack_require__.bind(null, /*! ./batch-lecture/batch-lecture.module */ "./src/app/employee/branch/lecture/batch-lecture/batch-lecture.module.ts")).then((m) => m.BatchLectureModule),
            },
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(5), __webpack_require__.e(52)]).then(__webpack_require__.bind(null, /*! ./manage-lecture/manage-lecture.module */ "./src/app/employee/branch/lecture/manage-lecture/manage-lecture.module.ts")).then((m) => m.ManageLectureModule),
            },
            {
                path: 'view',
                loadChildren: () => __webpack_require__.e(/*! import() */ 99).then(__webpack_require__.bind(null, /*! ./view-lecture/view-lecture.module */ "./src/app/employee/branch/lecture/view-lecture/view-lecture.module.ts")).then((m) => m.ViewLectureModule),
            },
            {
                path: 'material',
                loadChildren: () => __webpack_require__.e(/*! import() */ 97).then(__webpack_require__.bind(null, /*! ./study-material/study-material.module */ "./src/app/employee/branch/lecture/study-material/study-material.module.ts")).then((m) => m.StudyMaterialModule),
            },
            {
                path: 'q&a',
            ...
            {
                path: 'attendance',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(92)]).then(__webpack_require__.bind(null, /*! ./attendance/attendance.module */ "./src/app/employee/branch/lecture/attendance/attendance.module.ts")).then((m) => m.AttendanceModule),
            },
            {
                path: '',
                redirectTo: 'batch',
