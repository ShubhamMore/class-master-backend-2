...
var ReceiptInfoRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ReceiptInfoRoutingModule() {
    }
...
var ReceiptInfoComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ReceiptInfoComponent.prototype.ngOnInit = function () {
        this.loading = true;
    ...
    ReceiptInfoComponent.prototype.getBillingDetails = function () {
        var _this = this;
    ...
    ReceiptInfoComponent.prototype.saveBillingDetails = function () {
        var _this = this;
        ...
        this.billingService.saveBillingDetails(billingDetails).subscribe(function (res) {
            _this.showToastr('top-right', 'success', 'Billing Details Updated Successfully!');
    ...
    ReceiptInfoComponent.prototype.showToastr = function (position, status, message) {
...
var ReceiptInfoModule = /** @class */ /*@__PURE__*/ (function () {
    function ReceiptInfoModule() {
    }
