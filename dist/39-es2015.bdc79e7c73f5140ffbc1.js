...
const routes = [
    ...
    {
        path: 'view',
        loadChildren: () => __webpack_require__.e(/*! import() */ 176).then(__webpack_require__.bind(null, /*! ./view-question-answers/view-question-answers.module */ "./src/app/institute/branch/lecture/question-answers/view-question-answers/view-question-answers.module.ts")).then((m) => m.ViewQuestionAnswersModule),
    },
    {
        path: 'page-not-found',
