...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 97).then(__webpack_require__.bind(null, /*! ./manage-batch-online-test/manage-batch-online-test.module */ "./src/app/employee/branch/exam/online-test/manage-batch-online-test/manage-batch-online-test.module.ts")).then((m) => m.ManageBatchOnlineTestModule),
            },
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(98)]).then(__webpack_require__.bind(null, /*! ./manage-online-test/manage-online-test.module */ "./src/app/employee/branch/exam/online-test/manage-online-test/manage-online-test.module.ts")).then((m) => m.ManageOnlineTestModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(15)]).then(__webpack_require__.bind(null, /*! ./add-online-test/add-online-test.module */ "./src/app/employee/branch/exam/online-test/add-online-test/add-online-test.module.ts")).then((m) => m.AddOnlineTestModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(15)]).then(__webpack_require__.bind(null, /*! ./add-online-test/add-online-test.module */ "./src/app/employee/branch/exam/online-test/add-online-test/add-online-test.module.ts")).then((m) => m.AddOnlineTestModule),
            ...
            {
                path: 'question',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(100)]).then(__webpack_require__.bind(null, /*! ./online-test-question/online-test-question.module */ "./src/app/employee/branch/exam/online-test/online-test-question/online-test-question.module.ts")).then((m) => m.OnlineTestQuestionModule),
            },
            {
                path: '',
                redirectTo: 'batch',
