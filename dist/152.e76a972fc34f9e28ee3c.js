...
var ProfileComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ProfileComponent.prototype.saveProfile = function () {
        ...
        this.userService.saveProfile(profile).subscribe(function (res) {
            _this.showToastr('top-right', 'success', 'Profile updated Successfully!');
            _this.loading = false;
        }, function (error) {
    ...
    ProfileComponent.prototype.changePassword = function () {
        ...
        this.userService.changePassword(password).subscribe(function (res) {
            ...
            _this.showToastr('top-right', 'success', 'Password Changed Successfully!');
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
    ...
    ProfileComponent.prototype.showToastr = function (position, status, message) {
