...
const routes = [
    {
        ...
        children: [
            {
                path: 'home',
                loadChildren: () => __webpack_require__.e(/*! import() */ 48).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/admin/home/home.module.ts")).then((m) => m.HomeModule),
                canActivate: [],
            },
            {
                path: 'institutes',
                loadChildren: () => __webpack_require__.e(/*! import() */ 76).then(__webpack_require__.bind(null, /*! ./institutes/institutes.module */ "./src/app/admin/institutes/institutes.module.ts")).then((m) => m.InstitutesModule),
                canActivate: [],
            },
            {
                path: 'coupon',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(47)]).then(__webpack_require__.bind(null, /*! ./coupon/coupon.module */ "./src/app/admin/coupon/coupon.module.ts")).then((m) => m.CouponModule),
                canActivate: [],
            },
            {
                path: 'membership-plans',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(50)]).then(__webpack_require__.bind(null, /*! ./membership-plans/membership-plans.module */ "./src/app/admin/membership-plans/membership-plans.module.ts")).then((m) => m.MembershipPlansModule),
                canActivate: [],
            },
            {
                path: 'settings',
                loadChildren: () => __webpack_require__.e(/*! import() */ 77).then(__webpack_require__.bind(null, /*! ./settings/settings.module */ "./src/app/admin/settings/settings.module.ts")).then((m) => m.SettingsModule),
                canActivate: [],
            },
            {
                path: 'users',
                loadChildren: () => __webpack_require__.e(/*! import() */ 78).then(__webpack_require__.bind(null, /*! ./users/users.module */ "./src/app/admin/users/users.module.ts")).then((m) => m.UsersModule),
                canActivate: [],
            },
            {
                path: '',
