...
var ManageTestRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageTestRoutingModule() {
    }
...
function ManageTestComponent_ng_container_19_div_1_tr_17_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageTestComponent_ng_container_19_div_1_tr_17_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14); var batch_r11 = ctx.$implicit; var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r13.manageExam(batch_r11); });
...
var ManageTestComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageTestComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    ManageTestComponent.prototype.getCourses = function () {
        var _this = this;
        this.courseService.getCoursesData().subscribe(function (courses) {
            _this.courses = courses;
        });
    };
    ManageTestComponent.prototype.onSelectCategory = function (category) {
        this.category = category;
        this.course = '';
        this.myCourses = this.courses.filter(function (course) { return course.basicDetails.category === category; });
        this.getBatches(this.category, this.course);
    };
    ManageTestComponent.prototype.onSelectCourse = function (course) {
        this.course = course;
        this.getBatches(this.category, this.course);
    };
    ManageTestComponent.prototype.getBatches = function (category, course) {
        var _this = this;
        this.loading = true;
    ...
    ManageTestComponent.prototype.manageExam = function (batch) {
    ...
    ManageTestComponent.prototype.getCategory = function (categoryId) {
    ...
    ManageTestComponent.prototype.getCourse = function (courseId) {
    ...
    ManageTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManageTestComponent, selectors: [["ngx-manage-test"]], decls: 22, vars: 6, consts: [[1, "row"], [1, "col-md-6", "col-sm-4"], [1, "col-md-3", "col-sm-4"], ["id", "select-category", "name", "category", "fullWidth", "", "placeholder", "Select Category", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-course", "name", "course", "fullWidth", "", "placeholder", "Select Course", 3, "selected", "selectedChange"], [1, "body-container"], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noBatches", ""], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "primary", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function ManageTestComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageTestComponent_Template_nb_select_selectedChange_7_listener($event) { return ctx.onSelectCategory($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function ManageTestComponent_Template_nb_select_selectedChange_12_listener($event) { return ctx.onSelectCourse($event); });
...
var ManageTestModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageTestModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](ManageTestModule, { declarations: [_manage_test_component__WEBPACK_IMPORTED_MODULE_1__["ManageTestComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"],
            _manage_test_routing_module__WEBPACK_IMPORTED_MODULE_4__["ManageTestRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbSelectModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbIconModule"],
