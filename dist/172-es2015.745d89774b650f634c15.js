...
const routes = [
    {
        ...
        children: [
            {
                path: 'add',
                loadChildren: () => __webpack_require__.e(/*! import() */ 29).then(__webpack_require__.bind(null, /*! ./add-lead/add-lead.module */ "./src/app/institute/branch/lead/add-lead/add-lead.module.ts")).then((m) => m.AddLeadModule),
            },
            {
                path: 'edit',
                loadChildren: () => __webpack_require__.e(/*! import() */ 29).then(__webpack_require__.bind(null, /*! ./add-lead/add-lead.module */ "./src/app/institute/branch/lead/add-lead/add-lead.module.ts")).then((m) => m.AddLeadModule),
            ...
            {
                path: 'manage',
                loadChildren: () => __webpack_require__.e(/*! import() */ 173).then(__webpack_require__.bind(null, /*! ./manage-lead/manage-lead.module */ "./src/app/institute/branch/lead/manage-lead/manage-lead.module.ts")).then((m) => m.ManageLeadModule),
            },
            {
                path: '',
