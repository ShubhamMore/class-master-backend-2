(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[38], {
    ...
    function srcAppEmployeeBranchLectureQuestionAnswersAddQuestionAnswersAddAnswerAddAnswerComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddAnswerComponent = /*@__PURE__*/function () {
        var AddAnswerComponent = /*#__PURE__*/function () {
        ...
        AddAnswerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
          ...
          decls: 7,
          vars: 2,
          consts: [[1, "answer-box"], ["icon", "close-outline", 1, "float-right", "pointer", 3, "click"], [3, "formGroup", "submit", 4, "ngIf"], [3, "formGroup", "submit"], [1, "row"], [1, "col-12"], [1, "form-control-group"], ["for", "input-answer", 1, "label"], ["type", "text", "nbInput", "", "id", "input-answer", "name", "answer", "formControlName", "answer", "placeholder", "Answer", "fullWidth", "", 3, "status"], [4, "ngIf"], [1, "col-6"], ["type", "button", "nbButton", "", "size", "small", "status", "danger", 3, "disabled", "click"], [1, "col-6", "text-right"], ["type", "submit", "nbButton", "", "size", "small", "status", "success", "nbSpinnerStatus", "primary", "nbSpinnerSize", "small", 3, "disabled", "nbSpinner"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"]],
    ...
    function srcAppEmployeeBranchLectureQuestionAnswersAddQuestionAnswersAddQuestionAnswersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddQuestionAnswersRoutingModule = /*@__PURE__*/function () {
    ...
    function srcAppEmployeeBranchLectureQuestionAnswersAddQuestionAnswersAddQuestionAnswersModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddQuestionAnswersModule = /*@__PURE__*/function () {
    ...
    function srcAppEmployeeBranchLectureQuestionAnswersAddQuestionAnswersAddQuestionAddQuestionComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddQuestionComponent = /*@__PURE__*/function () {
        ...
        AddQuestionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
          ...
          decls: 22,
          vars: 7,
          consts: [[1, "question-box"], ["icon", "close-outline", 1, "float-right", "pointer", 3, "click"], [3, "formGroup", "submit"], [1, "row"], [1, "col-12"], [1, "form-control-group"], ["for", "input-question", 1, "label"], ["type", "text", "nbInput", "", "id", "input-question", "name", "question", "formControlName", "question", "placeholder", "Question", "fullWidth", "", 3, "status"], [4, "ngIf"], [1, "col-6"], ["type", "button", "nbButton", "", "size", "small", "status", "danger", 3, "disabled", "click"], [1, "col-6", "text-right"], ["type", "submit", "nbButton", "", "size", "small", "status", "success", "nbSpinnerStatus", "primary", "nbSpinnerSize", "small", 3, "disabled", "nbSpinner"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"]],
    ...
    function srcAppEmployeeBranchLectureQuestionAnswersQuestionAnswersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() */
          111).then(__webpack_require__.bind(null,
      ...
      var QuestionAnswersRoutingModule = /*@__PURE__*/function () {
    ...
    function srcAppEmployeeBranchLectureQuestionAnswersQuestionAnswersModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var QuestionAnswersModule = /*@__PURE__*/function () {
