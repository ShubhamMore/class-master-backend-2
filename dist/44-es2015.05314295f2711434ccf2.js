...
let MenuService = /*@__PURE__*/ (() => {
    class MenuService {
        ...
        showHideMenu(i, status) {
            const menuItem = _employee_menu__WEBPACK_IMPORTED_MODULE_1__["MENU_ITEMS"][i];
            menuItem.hidden = status;
            if (menuItem.children) {
                _employee_menu__WEBPACK_IMPORTED_MODULE_1__["MENU_ITEMS"][i].children.map((menuItemChildren) => {
                    menuItemChildren.hidden = status;
                });
            }
        }
        hideMenus() {
            this.menuItems = _employee_menu__WEBPACK_IMPORTED_MODULE_1__["MENU_ITEMS"].map((menuItem, i) => {
                if (i !== 0) {
