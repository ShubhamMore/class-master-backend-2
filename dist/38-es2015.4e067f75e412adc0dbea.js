...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'transaction',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(211)]).then(__webpack_require__.bind(null, /*! ./transaction/transaction.module */ "./src/app/institute/transaction/transaction.module.ts")).then((m) => m.TransactionModule),
                canActivate: [],
            },
            {
                path: 'settings',
