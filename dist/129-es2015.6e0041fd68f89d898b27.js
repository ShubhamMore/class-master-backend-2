...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(127)]).then(__webpack_require__.bind(null, /*! ./manage-student-course-installment/manage-student-course-installment.module */ "./src/app/employee/branch/student/student-course/student-course-installment/manage-student-course-installment/manage-student-course-installment.module.ts")).then((m) => m.ManageStudentCourseInstallmentModule),
            },
            {
                path: 'collect',
            ...
            {
                path: 'receipt',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(128)]).then(__webpack_require__.bind(null, /*! ./student-course-installment-receipt/student-course-installment-receipt.module */ "./src/app/employee/branch/student/student-course/student-course-installment/student-course-installment-receipt/student-course-installment-receipt.module.ts")).then((m) => m.StudentCourseInstallmentReceiptModule),
            },
            {
                path: '',
                redirectTo: 'manage',
