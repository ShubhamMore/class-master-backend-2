...
const routes = [
    ...
    {
        path: 'branch',
        loadChildren: () => __webpack_require__.e(/*! import() */ 75).then(__webpack_require__.bind(null, /*! ./branches/branches.module */ "./src/app/admin/institutes/branches/branches.module.ts")).then((m) => m.BranchesModule),
    },
    {
        path: 'page-not-found',
