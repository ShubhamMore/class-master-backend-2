...
const routes = [
    {
        ...
        children: [
            {
                path: 'dashboard',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(235)]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/student/branch/dashboard/dashboard.module.ts")).then((m) => m.DashboardModule),
            },
            {
                path: 'course',
                loadChildren: () => __webpack_require__.e(/*! import() */ 223).then(__webpack_require__.bind(null, /*! ./course/course.module */ "./src/app/student/branch/course/course.module.ts")).then((m) => m.CourseModule),
            },
            {
                path: '',
