        ...
        children: [
            {
                ...
                loadChildren: function () {
                    return __webpack_require__.e(/*! import() */ 156).then(__webpack_require__.bind(null, /*! ./batch-assignment/batch-assignment.module */ "./src/app/institute/branch/assignment/batch-assignment/batch-assignment.module.ts")).then(function (m) { return m.BatchAssignmentModule; });
                },
            },
            {
                path: 'manage',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(157)]).then(__webpack_require__.bind(null, /*! ./manage-assignment/manage-assignment.module */ "./src/app/institute/branch/assignment/manage-assignment/manage-assignment.module.ts")).then(function (m) { return m.ManageAssignmentModule; });
                },
            },
            {
                path: 'submission',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(154)]).then(__webpack_require__.bind(null, /*! ./assignment-submission/assignment-submission.module */ "./src/app/institute/branch/assignment/assignment-submission/assignment-submission.module.ts")).then(function (m) { return m.AssignmentSubmissionModule; });
                },
            },
            {
                path: 'add',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(25)]).then(__webpack_require__.bind(null, /*! ./save-assignment/save-assignment.module */ "./src/app/institute/branch/assignment/save-assignment/save-assignment.module.ts")).then(function (m) { return m.SaveAssignmentModule; });
                },
            },
            {
                path: 'edit',
