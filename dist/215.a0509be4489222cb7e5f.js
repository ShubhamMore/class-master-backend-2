...
var SettingsRoutingModule = /** @class */ /*@__PURE__*/ (function () {
...
var SettingsComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    SettingsComponent.prototype.saveZoomKeys = function () {
        var _this = this;
        ...
        this.instituteKeysService.saveInstituteZoomKeys(keys).subscribe(function (res) {
            _this.instituteKeysService.getZoomAuthLink().subscribe(function (responce) {
                var popup = window.open(responce.authLink, '_blank', 'toolbar,scrollbars,resizable,top=200,left=500,width=400,height=400');
                // setTimeout(() => {
                //   popup.close();
                // }, 3000);
            });
            _this.showToastr('top-right', 'success', 'Institute Zoom Keys Saved Successfully!');
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
        });
    };
    SettingsComponent.prototype.toggleShowZoomSecret = function () {
        this.zoomShowSecret = !this.zoomShowSecret;
    };
    SettingsComponent.prototype.toggleShowPaymentGatewaySecret = function () {
        this.paymentGatewayShowSecret = !this.paymentGatewayShowSecret;
    };
    SettingsComponent.prototype.savePaymentGatewayKeys = function () {
        var _this = this;
        ...
        this.instituteKeysService.saveInstitutePaymentGatewayKeys(keys).subscribe(function (res) {
            _this.showToastr('top-right', 'success', 'Institute Payment Gateway Keys Saved Successfully!');
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.loading = false;
        });
    };
    SettingsComponent.prototype.showToastr = function (position, status, message) {
