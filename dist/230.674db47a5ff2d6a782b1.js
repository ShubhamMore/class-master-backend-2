...
var routes = [];
var OnlineTestResultRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function OnlineTestResultRoutingModule() {
    }
...
var OnlineTestResultComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    OnlineTestResultComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this.onlineExamService.getOnlineExamData().subscribe(function (onlineExam) {
            if (onlineExam) {
                _this.onlineExamService.getOnlineExamResult(onlineExam._id).subscribe(function (onlineExamResult) {
    ...
    OnlineTestResultComponent.prototype.getPassingMarks = function (passingMarks, totalMarks) {
        return Math.ceil((+totalMarks / 100) * passingMarks);
    };
    OnlineTestResultComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    OnlineTestResultComponent.prototype.back = function () {
...
var OnlineTestResultModule = /** @class */ /*@__PURE__*/ (function () {
    function OnlineTestResultModule() {
    }
