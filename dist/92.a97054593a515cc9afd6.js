...
var LoginRoutingModule = /** @class */ /*@__PURE__*/ (function () {
...
/* harmony import */ var _auth_auth_service_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth/auth-service/auth.service */ "./src/app/authentication/auth/auth-service/auth.service.ts");
...
var LoginComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    LoginComponent.prototype.authSubscribe = function () {
        var _this = this;
        this.authObs.subscribe(function (user) {
            ...
            if (user.userRole === 'admin') {
                ...
                _this.router.navigate(['/institute'], { relativeTo: _this.route });
            }
            else if (user.userRole === 'employee') {
                _this.router.navigate(['/employee'], { relativeTo: _this.route });
            }
            else if (user.userRole === 'student') {
                _this.router.navigate(['/student'], { relativeTo: _this.route });
            }
            else {
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](LoginModule, { declarations: [_login_component__WEBPACK_IMPORTED_MODULE_0__["LoginComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _login_routing_module__WEBPACK_IMPORTED_MODULE_3__["LoginRoutingModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"],
            _theme_theme_module__WEBPACK_IMPORTED_MODULE_5__["ThemeModule"],
