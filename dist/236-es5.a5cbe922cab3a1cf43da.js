...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[236], {
  ...
  /***/
  function srcAppStudentTransactionTransactionRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() */
        237).then(__webpack_require__.bind(null,
        /*! ./view-transaction/view-transaction.module */
        "./src/app/student/transaction/view-transaction/view-transaction.module.ts")).then(function (m) {
  ...
  /***/
  function srcAppStudentTransactionTransactionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      function () {
        ...
        _createClass(TransactionComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.loading = true;
            this.transactionService.getStudentTransactions().subscribe(function (transactions) {
  ...
  /***/
  function srcAppStudentTransactionTransactionModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
