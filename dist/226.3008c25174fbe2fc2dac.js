...
var ViewStudyMaterialRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ViewStudyMaterialRoutingModule() {
    }
...
function ViewStudyMaterialComponent_nb_card_0_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewStudyMaterialComponent_nb_card_0_Template_button_click_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.back(); });
...
var ViewStudyMaterialComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ViewStudyMaterialComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        ...
        this.lectureMaterialService
            ...
            .subscribe(function (lectureMaterial) {
            if (!lectureMaterial) {
                _this.back();
                return;
            }
    ...
    ViewStudyMaterialComponent.prototype.back = function () {
        this.loading = true;
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    ViewStudyMaterialComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ViewStudyMaterialComponent.prototype.ngOnDestroy = function () {
...
/* harmony import */ var ng2_pdf_viewer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ng2-pdf-viewer */ "./node_modules/ng2-pdf-viewer/__ivy_ngcc__/fesm5/ng2-pdf-viewer.js");
...
var ViewStudyMaterialModule = /** @class */ /*@__PURE__*/ (function () {
    function ViewStudyMaterialModule() {
    }
