...
/***/ "./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance-routing.module.ts":
/*!****************************************************************************************************************************************!*\
  !*** ./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance-routing.module.ts ***!
  \****************************************************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StudentCourseAttendanceRoutingModule", function() { return StudentCourseAttendanceRoutingModule; });
/* harmony import */ var _student_course_attendance_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./student-course-attendance.component */ "./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance.component.ts");
...
var StudentCourseAttendanceRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function StudentCourseAttendanceRoutingModule() {
    }
    StudentCourseAttendanceRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: StudentCourseAttendanceRoutingModule });
    StudentCourseAttendanceRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function StudentCourseAttendanceRoutingModule_Factory(t) { return new (t || StudentCourseAttendanceRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] });
    return StudentCourseAttendanceRoutingModule;
}());

(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](StudentCourseAttendanceRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] }); })();


/***/ }),

/***/ "./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance.component.ts":
/*!***********************************************************************************************************************************!*\
  !*** ./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance.component.ts ***!
  \***********************************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StudentCourseAttendanceComponent", function() { return StudentCourseAttendanceComponent; });
...
function StudentCourseAttendanceComponent_ng_container_55_div_1_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](15, StudentCourseAttendanceComponent_ng_container_55_div_1_tr_15_Template, 12, 6, "tr", 19);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    }
...
function StudentCourseAttendanceComponent_ng_container_55_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, StudentCourseAttendanceComponent_ng_container_55_div_1_Template, 16, 1, "div", 15);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, StudentCourseAttendanceComponent_ng_container_55_ng_template_2_Template, 2, 0, "ng-template", null, 16, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
...
var StudentCourseAttendanceComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    StudentCourseAttendanceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    StudentCourseAttendanceComponent.prototype.onSelectMonth = function (month) {
        this.month = month;
        this.getStudentCourseAttendance();
    };
    StudentCourseAttendanceComponent.prototype.onSelectYear = function (year) {
        this.year = year;
        if (year === '') {
            this.month = '';
        }
    ...
    StudentCourseAttendanceComponent.prototype.onSelectSubject = function (subject) {
        this.subject = subject;
        this.getStudentCourseAttendance();
    };
    StudentCourseAttendanceComponent.prototype.getStudentCourseAttendance = function () {
        var _this = this;
        this.loading = true;
        this.attendanceService
            .getStudentCourseAttendance(this.subject, this.month, this.year, this.studentId, this.studentCourseId)
            .subscribe(function (attendance) {
            _this.attendance = attendance;
            _this.calculateAttendance(attendance.length);
            _this.loading = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
            _this.back();
    ...
    StudentCourseAttendanceComponent.prototype.calculateAttendance = function (totalLectures) {
        var totalPresent = 0;
        var totalAbsent = 0;
    ...
    StudentCourseAttendanceComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    StudentCourseAttendanceComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    StudentCourseAttendanceComponent.ɵfac = function StudentCourseAttendanceComponent_Factory(t) { return new (t || StudentCourseAttendanceComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_shared_services_date_service__WEBPACK_IMPORTED_MODULE_1__["DateService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_branch_service__WEBPACK_IMPORTED_MODULE_2__["BranchService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_batch_service__WEBPACK_IMPORTED_MODULE_3__["BatchService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_student_service__WEBPACK_IMPORTED_MODULE_5__["StudentService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_student_course_service__WEBPACK_IMPORTED_MODULE_6__["StudentCourseService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_attendance_service__WEBPACK_IMPORTED_MODULE_7__["AttendanceService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"])); };
    StudentCourseAttendanceComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: StudentCourseAttendanceComponent, selectors: [["ngx-student-course-attendance"]], decls: 58, vars: 12, consts: [[1, "row"], [1, "col-md-12"], ["nbButton", "", "size", "small", "status", "warning", 1, "float-right", 3, "click"], [1, "col-md-3", "col-sm-4"], ["id", "select-subject", "name", "subject", "fullWidth", "", "placeholder", "All Subjects", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-year", "name", "year", "fullWidth", "", "placeholder", "All Years", 3, "selected", "selectedChange"], ["id", "select-month", "name", "month", "fullWidth", "", "placeholder", "All Months", 3, "selected", "selectedChange"], [1, "body-container"], [1, "col-md-10", "col-12", "mx-auto"], [1, "col-md-6", "col-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noAttendance", ""], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], [3, "ngClass"], [1, "text-center", "pt-5", "pb-5"]], template: function StudentCourseAttendanceComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentCourseAttendanceComponent_Template_button_click_4_listener() { return ctx.back(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function StudentCourseAttendanceComponent_Template_nb_select_selectedChange_13_listener($event) { return ctx.onSelectSubject($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](16, StudentCourseAttendanceComponent_nb_option_16_Template, 2, 2, "nb-option", 6);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](17, "div", 3);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](18, "nb-select", 7);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function StudentCourseAttendanceComponent_Template_nb_select_selectedChange_18_listener($event) { return ctx.onSelectYear($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](21, StudentCourseAttendanceComponent_nb_option_21_Template, 2, 2, "nb-option", 6);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](22, "div", 3);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](23, "nb-select", 8);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function StudentCourseAttendanceComponent_Template_nb_select_selectedChange_23_listener($event) { return ctx.onSelectMonth($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](26, StudentCourseAttendanceComponent_nb_option_26_Template, 2, 2, "nb-option", 6);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](55, StudentCourseAttendanceComponent_ng_container_55_Template, 4, 2, "ng-container", 12);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](56, StudentCourseAttendanceComponent_ng_template_56_Template, 2, 0, "ng-template", null, 13, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        }, directives: [_nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbCardComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbCardHeaderComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbButtonComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbSelectComponent"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbOptionComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_9__["NgForOf"], _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbCardBodyComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_9__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_9__["NgClass"]], styles: [".present[_ngcontent-%COMP%] {\n  color: #00d68f;\n}\n\n.absent[_ngcontent-%COMP%] {\n  color: #ff3d71;\n}"] });
...
/***/ "./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance.module.ts":
/*!********************************************************************************************************************************!*\
  !*** ./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance.module.ts ***!
  \********************************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StudentCourseAttendanceModule", function() { return StudentCourseAttendanceModule; });
...
/* harmony import */ var _student_course_attendance_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./student-course-attendance-routing.module */ "./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance-routing.module.ts");
/* harmony import */ var _student_course_attendance_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./student-course-attendance.component */ "./src/app/institute/branch/students-report/student-courses/student-course-attendance/student-course-attendance.component.ts");
...
var StudentCourseAttendanceModule = /** @class */ /*@__PURE__*/ (function () {
    function StudentCourseAttendanceModule() {
    }
    StudentCourseAttendanceModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: StudentCourseAttendanceModule });
    StudentCourseAttendanceModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function StudentCourseAttendanceModule_Factory(t) { return new (t || StudentCourseAttendanceModule)(); }, imports: [[
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _student_course_attendance_routing_module__WEBPACK_IMPORTED_MODULE_3__["StudentCourseAttendanceRoutingModule"],
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](StudentCourseAttendanceModule, { declarations: [_student_course_attendance_component__WEBPACK_IMPORTED_MODULE_4__["StudentCourseAttendanceComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _student_course_attendance_routing_module__WEBPACK_IMPORTED_MODULE_3__["StudentCourseAttendanceRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbSelectModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbButtonModule"],
