...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 170).then(__webpack_require__.bind(null, /*! ./manage-test/manage-test.module */ "./src/app/institute/branch/exam/test/manage-test/manage-test.module.ts")).then((m) => m.ManageTestModule),
            },
            {
                path: 'batch-test',
                loadChildren: () => __webpack_require__.e(/*! import() */ 168).then(__webpack_require__.bind(null, /*! ./batch-test/batch-test.module */ "./src/app/institute/branch/exam/test/batch-test/batch-test.module.ts")).then((m) => m.BatchTestModule),
            },
            {
                path: '',
                redirectTo: 'batch',
