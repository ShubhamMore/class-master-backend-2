...
const routes = [
    {
        ...
        children: [
            {
                path: 'test',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(106)]).then(__webpack_require__.bind(null, /*! ./test/test.module */ "./src/app/employee/branch/exam/test/test.module.ts")).then((m) => m.TestModule),
            },
            {
                path: 'online-test',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(101)]).then(__webpack_require__.bind(null, /*! ./online-test/online-test.module */ "./src/app/employee/branch/exam/online-test/online-test.module.ts")).then((m) => m.OnlineTestModule),
            },
            {
                path: '',
                redirectTo: 'test',
