...
var AddOnlineTestQuestionsRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddOnlineTestQuestionsRoutingModule() {
    }
...
var AddOnlineTestQuestionsComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddOnlineTestQuestionsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    AddOnlineTestQuestionsComponent.prototype.atLeastOneCorrectAnswerValidator = function (group) {
    ...
    AddOnlineTestQuestionsComponent.prototype.newAnswer = function (answerData) {
    ...
    AddOnlineTestQuestionsComponent.prototype.addOption = function (answer) {
        var answers = this.onlineExamQuestionForm.get('answers');
        answers.push(this.newAnswer(answer));
    };
    AddOnlineTestQuestionsComponent.prototype.generateOption = function () {
        var answer = {
            answer: '',
            isCorrect: false,
        };
    ...
    AddOnlineTestQuestionsComponent.prototype.deleteOption = function (i) {
        if (i !== 0 && i !== 1) {
            var answers = this.onlineExamQuestionForm.get('answers');
            answers.removeAt(i);
        }
    };
    AddOnlineTestQuestionsComponent.prototype.previousStep = function () {
        this.stepper.previous();
    };
    AddOnlineTestQuestionsComponent.prototype.submitOnlineExamQuestionForm = function () {
    ...
    AddOnlineTestQuestionsComponent.prototype.saveOnlineExamQuestion = function () {
        var _this = this;
        this.onlineExamQuestionForm.markAllAsTouched();
        if (this.onlineExamQuestionForm.invalid) {
    ...
    AddOnlineTestQuestionsComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AddOnlineTestQuestionsComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    AddOnlineTestQuestionsComponent.prototype.ngOnDestroy = function () {
...
var AddOnlineTestQuestionsModule = /** @class */ /*@__PURE__*/ (function () {
    function AddOnlineTestQuestionsModule() {
    }
