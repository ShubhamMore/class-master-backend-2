...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(100)]).then(__webpack_require__.bind(null, /*! ./manage-study-material/manage-study-material.module */ "./src/app/employee/branch/lecture/study-material/manage-study-material/manage-study-material.module.ts")).then((m) => m.ManageStudyMaterialModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(15)]).then(__webpack_require__.bind(null, /*! ./add-study-material/add-study-material.module */ "./src/app/employee/branch/lecture/study-material/add-study-material/add-study-material.module.ts")).then((m) => m.AddStudyMaterialModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(15)]).then(__webpack_require__.bind(null, /*! ./add-study-material/add-study-material.module */ "./src/app/employee/branch/lecture/study-material/add-study-material/add-study-material.module.ts")).then((m) => m.AddStudyMaterialModule),
            ...
            {
                path: 'view',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(3), __webpack_require__.e("common"), __webpack_require__.e(102)]).then(__webpack_require__.bind(null, /*! ./view-study-material/view-study-material.module */ "./src/app/employee/branch/lecture/study-material/view-study-material/view-study-material.module.ts")).then((m) => m.ViewStudyMaterialModule),
            },
            {
                path: '',
                redirectTo: 'manage',
