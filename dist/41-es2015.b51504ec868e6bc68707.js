...
const routes = [
    {
        ...
        children: [
            {
                path: 'home',
                loadChildren: () => __webpack_require__.e(/*! import() */ 42).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/content/home/home.module.ts")).then((m) => m.HomeModule),
                canActivate: [],
            },
            {
                path: 'login',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(69)]).then(__webpack_require__.bind(null, /*! ../authentication/login/login.module */ "./src/app/authentication/login/login.module.ts")).then((m) => m.LoginModule),
                canActivate: [],
            },
            {
                path: 'register',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(5), __webpack_require__.e("common"), __webpack_require__.e(49)]).then(__webpack_require__.bind(null, /*! ../authentication/register/register.module */ "./src/app/authentication/register/register.module.ts")).then((m) => m.RegisterModule),
                canActivate: [],
            },
            {
                path: 'forgot-password',
                loadChildren: () => __webpack_require__.e(/*! import() */ 68).then(__webpack_require__.bind(null, /*! ../authentication/forgot-password/forgot-password.module */ "./src/app/authentication/forgot-password/forgot-password.module.ts")).then((m) => m.ForgotPasswordModule),
                canActivate: [],
            },
            {
                path: 'reset-password',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(70)]).then(__webpack_require__.bind(null, /*! ../authentication/reset-password/reset-password.module */ "./src/app/authentication/reset-password/reset-password.module.ts")).then((m) => m.ResetPasswordModule),
                canActivate: [],
            },
            {
                path: 'privacy-policy',
                loadChildren: () => __webpack_require__.e(/*! import() */ 71).then(__webpack_require__.bind(null, /*! ./privacy-policy/privacy-policy.module */ "./src/app/content/privacy-policy/privacy-policy.module.ts")).then((m) => m.PrivacyPolicyModule),
                canActivate: [],
            },
            {
                path: 'terms-and-conditions',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(5), __webpack_require__.e(72)]).then(__webpack_require__.bind(null, /*! ./terms-and-conditions/terms-and-conditions.module */ "./src/app/content/terms-and-conditions/terms-and-conditions.module.ts")).then((m) => m.TermsAndConditionsModule),
                canActivate: [],
            },
            {
                path: '',
