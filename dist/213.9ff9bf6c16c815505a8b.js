...
function MembershipPlansComponent_button_236_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "button", 22);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MembershipPlansComponent_button_236_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r9); var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r8.activate("membership", "quarterly"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Activate ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    }
}
...
var MembershipPlansComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    MembershipPlansComponent.prototype.getMembershipPlans = function () {
        var _this = this;
    ...
    MembershipPlansComponent.prototype.getPrice = function (name) {
    ...
    MembershipPlansComponent.prototype.onClosePayment = function (order) {
        if (order.status) {
            this.activateBranch(this.branchId, order.order, order.receipt);
        }
    };
    MembershipPlansComponent.prototype.onCheckout = function (checkout) {
        var _this = this;
        if (checkout.status) {
            this.dialogService
                ...
                .onClose.subscribe(function (order) { return order && _this.onClosePayment(order); });
        }
    };
    MembershipPlansComponent.prototype.getMembership = function (name) {
        return this.membershipPlans.find(function (curMembershipPlan) { return curMembershipPlan.name === name; });
    };
    MembershipPlansComponent.prototype.isMembershipPlanAvailable = function (name) {
        var membershipPlan = this.getMembership(name);
        if (membershipPlan) {
            return true;
        }
    ...
    MembershipPlansComponent.prototype.activate = function (planType, packageType) {
        var _this = this;
        ...
        if (membershipPlan) {
            ...
            if (this.branchId && this.membershipType === 'renew') {
                ...
                this.dialogService
                    ...
                    .onClose.subscribe(function (checkout) { return checkout && _this.onCheckout(checkout); });
            }
            else {
    ...
    MembershipPlansComponent.prototype.activateBranch = function (id, orderId, ReceiptId) {
        var _this = this;
        var paymentDetails = {
        ...
        this.branchService.activateBranch(id, paymentDetails).subscribe(function (res) {
            _this.showToastr('top-right', 'success', 'Institute Activated Successfully');
    ...
    MembershipPlansComponent.prototype.ngOnDestroy = function () {
        if (this.branchId && this.membershipType === 'renew') {
