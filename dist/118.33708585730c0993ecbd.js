...
var ViewQuestionAnswersRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ViewQuestionAnswersRoutingModule() {
    }
...
function ViewQuestionAnswersComponent_ng_container_9_button_12_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ViewQuestionAnswersComponent_ng_container_9_button_12_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r11); var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2); return ctx_r10.deleteQuestion(ctx_r10.lectureQuestion._id); });
...
function ViewQuestionAnswersComponent_ng_container_9_div_15_nb_card_3_button_7_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "button", 16);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ViewQuestionAnswersComponent_ng_container_9_div_15_nb_card_3_button_7_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r22); var lectureQuestionAnswer_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit; var ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](3); return ctx_r20.deleteQuestionAnswer(lectureQuestionAnswer_r13._id); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Delete ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    }
}
...
function ViewQuestionAnswersComponent_ng_container_9_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ViewQuestionAnswersComponent_ng_container_9_Template_button_click_9_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r24); var ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); return ctx_r23.addQuestionAnswer(); });
...
var ViewQuestionAnswersComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ViewQuestionAnswersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        ...
        this.questionAnswersService
            .getQuestionAnswers()
            .subscribe(function (questionAnswers) {
            if (!questionAnswers) {
            }
    ...
    ViewQuestionAnswersComponent.prototype.getLectureQuestionAnswers = function (id) {
        var _this = this;
        this.questionAnswersService.getLectureQuestionAnswer(id).subscribe(function (questionAnswer) {
            _this.lectureQuestion = questionAnswer;
            _this.loading = false;
        }, function (error) {
    ...
    ViewQuestionAnswersComponent.prototype.addQuestionAnswer = function () {
        this.openAnswerDialog();
    };
    ViewQuestionAnswersComponent.prototype.openAnswerDialog = function () {
        var _this = this;
        this.dialogService
            .open(_add_question_answers_add_answer_add_answer_component__WEBPACK_IMPORTED_MODULE_1__["AddAnswerComponent"], {
            context: {},
        })
            .onClose.subscribe(function (answer) { return answer && _this.saveLectureQuestionAnswer(answer); });
    };
    ViewQuestionAnswersComponent.prototype.editQuestion = function (lectureQuestion) {
        var _this = this;
        ...
        this.dialogService
            ...
            if (question) {
                _this.lectureQuestion = question;
            }
        });
    };
    ViewQuestionAnswersComponent.prototype.formatQuestionAnswerDate = function (questionDate) {
        var date = this.dateService.convertToDate(questionDate).toString();
        return date.substr(0, 21);
    };
    ViewQuestionAnswersComponent.prototype.deleteQuestion = function (id) {
        var _this = this;
        this.loading = true;
    ...
    ViewQuestionAnswersComponent.prototype.deleteQuestionAnswer = function (id, i) {
        var _this = this;
        this.questionAnswersService.deleteLectureQuestionAnswer(id).subscribe(function (res) {
            _this.lectureQuestion.answers.splice(i, 1);
            _this.showToastr('top-right', 'success', "Answer Deleted Successfully!");
        }, function (err) {
            _this.showToastr('top-right', 'danger', err);
        });
    };
    ViewQuestionAnswersComponent.prototype.editQuestionAnswer = function (lectureQuestionAnswer) {
    ...
    ViewQuestionAnswersComponent.prototype.saveLectureQuestionAnswer = function (newLectureQuestionAnswer) {
        if (!this.editLectureQuestionAnswer) {
            ...
            var index = this.lectureQuestion.answers.findIndex(function (curAnswer) { return curAnswer._id === newLectureQuestionAnswer._id; });
            if (index >= 0) {
    ...
    ViewQuestionAnswersComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
    ViewQuestionAnswersComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ViewQuestionAnswersComponent.prototype.ngOnDestroy = function () {
...
var ViewQuestionAnswersModule = /** @class */ /*@__PURE__*/ (function () {
    function ViewQuestionAnswersModule() {
    }
