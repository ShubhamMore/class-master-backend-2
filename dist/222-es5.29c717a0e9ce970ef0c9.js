...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[222], {
  ...
  /***/
  function srcAppStudentBranchCourseLectureStudyMaterialManageStudyMaterialManageStudyMaterialRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ManageStudyMaterialRoutingModule, [{
  ...
  /***/
  function srcAppStudentBranchCourseLectureStudyMaterialManageStudyMaterialManageStudyMaterialComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_lecture_material_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function ManageStudyMaterialComponent_ng_container_11_div_1_tr_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageStudyMaterialComponent_ng_container_11_div_1_tr_11_Template_button_click_6_listener() {
    ...
    function () {
      ...
      _createClass(ManageStudyMaterialComponent, [{
        ...
        value: function getLectureMaterials(subject) {
          ...
          this.lectureMaterialService.getLectureMaterialsForStudent(this.branchId, this.lecture.category, this.lecture.course, this.lecture.batch, this.lecture._id).subscribe(function (lectureMaterials) {
    ...
    ManageStudyMaterialComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 2,
      consts: [[1, "row"], [1, "col-md-12"], ["type", "button", "nbButton", "", "size", "small", "status", "warning", 1, "float-right", 3, "click"], [1, "body-container"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noLectureMaterials", ""], [1, "table-responsive"], [1, "table"], ["colspan", "3"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "info", 3, "click"], [1, "text-center", "pt-5", "pb-5"]],
      template: function ManageStudyMaterialComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageStudyMaterialComponent_Template_button_click_4_listener() {
            return ctx.back();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ManageStudyMaterialComponent, [{
        ...
        return [{
          ...
          type: _services_lecture_material_service__WEBPACK_IMPORTED_MODULE_2__["LectureMaterialService"]
        }, {
  ...
  /***/
  function srcAppStudentBranchCourseLectureStudyMaterialManageStudyMaterialManageStudyMaterialModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ManageStudyMaterialModule, [{
