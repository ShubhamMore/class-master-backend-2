...
function OnlineTestQuestionComponent_div_7_div_2_div_10_div_8_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("checkedChange", function OnlineTestQuestionComponent_div_7_div_2_div_10_div_8_Template_nb_checkbox_checkedChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r23); var answer_r20 = ctx.$implicit; var i_r21 = ctx.index; var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](4); return ctx_r22.markAnswer(ctx_r22.currentQuestion._id, ctx_r22.currentQuestionIndex, answer_r20._id, i_r21, $event); });
...
var OnlineTestQuestionComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    OnlineTestQuestionComponent.prototype.ngOnInit = function () {
        ...
        this.onlineExamService.getOnlineExamResult(this.onlineExam._id).subscribe(function (onlineExamResult) {
            if (onlineExamResult) {
                ...
                var countDownDate_1 = new Date(startTime).getTime();
                _this.examStartTime = countDownDate_1;
                _this.examStarted = false;
                _this.examSubmitted = false;
                _this.examTimeUp = false;
                // Set Interval
    ...
    OnlineTestQuestionComponent.prototype.getDate = function (date) {
        date = new Date(date).toString();
        return date.substring(0, 3) + ', ' + date.substring(4, 15);
    };
    OnlineTestQuestionComponent.prototype.getTime = function (time) {
    ...
    OnlineTestQuestionComponent.prototype.startExam = function () {
        var _this = this;
        this.onlineExamQuestionService.getOnlineExamQuestionsForStudent(this.onlineExam._id).subscribe(function (onlineExamQuestions) {
            _this.questions = onlineExamQuestions;
            _this.waitingToStart = null;
            _this.examStarted = true;
            _this.studentQuestionAnswers = [];
            ...
            var duration = +_this.onlineExam.duration * 60 * 1000;
            var currentTime = new Date().getTime();
            var endTime = _this.examStartTime + duration + bufferTime;
            var differenceTime = endTime - currentTime;
            if (differenceTime >= duration) {
                _this.examEndTime = currentTime + duration;
            }
            else if (endTime > currentTime) {
                _this.examEndTime = _this.examStartTime + duration + bufferTime;
                _this.examCountDown();
            }
            else {
                _this.examEndTime = null;
                _this.examTimeUp = true;
                _this.submitExam();
            }
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
    ...
    OnlineTestQuestionComponent.prototype.examCountDown = function () {
        var _this = this;
    ...
    OnlineTestQuestionComponent.prototype.previousQuestion = function () {
        this.currentQuestionIndex -= 1;
        this.currentQuestion = this.questions[this.currentQuestionIndex];
    };
    OnlineTestQuestionComponent.prototype.nextQuestion = function () {
        this.currentQuestionIndex += 1;
        this.currentQuestion = this.questions[this.currentQuestionIndex];
    };
    OnlineTestQuestionComponent.prototype.markAnswer = function (questionId, questionIndex, answerId, answerIndex, mark) {
        var index = this.studentQuestionAnswers.findIndex(function (curAnswer) { return curAnswer.questionId === questionId; });
        if (mark) {
            if (index < 0) {
                ...
                var studentQuestionAnswers = this.studentQuestionAnswers[index];
                studentQuestionAnswers.answerIds.push(answerId);
            ...
            if (index > -1) {
                var studentQuestionAnswers = this.studentQuestionAnswers[index];
                var ansIndex = studentQuestionAnswers.answerIds.findIndex(function (curAnsId) { return curAnsId.answerId === answerId; });
                studentQuestionAnswers.answerIds.splice(ansIndex, 1);
                this.studentQuestionAnswers[index] = studentQuestionAnswers;
            }
        }
    };
    OnlineTestQuestionComponent.prototype.submitExam = function () {
        var _this = this;
        var confirm = true;
        if (!this.examTimeUp) {
        ...
        this.onlineExamService
            ...
            _this.onlineExamResult = res.onlineExamResult;
            if (res.type === 0) {
                _this.showToastr('top-right', 'success', 'Exam Submitted Successfully!');
            }
            _this.calculatingResult = false;
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
    ...
    OnlineTestQuestionComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    OnlineTestQuestionComponent.prototype.back = function () {
        this.router.navigate(['../'], { relativeTo: this.route });
    };
