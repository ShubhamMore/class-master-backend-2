...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(116)]).then(__webpack_require__.bind(null, /*! ./manage-batch-schedule/manage-batch-schedule.module */ "./src/app/employee/branch/schedule/batch-schedule/manage-batch-schedule/manage-batch-schedule.module.ts")).then((m) => m.ManageBatchScheduleModule),
            },
            {
                path: 'add',
            ...
            {
                path: 'view',
                loadChildren: () => __webpack_require__.e(/*! import() */ 117).then(__webpack_require__.bind(null, /*! ./view-schedule/view-schedule.module */ "./src/app/employee/branch/schedule/batch-schedule/view-schedule/view-schedule.module.ts")).then((m) => m.ViewScheduleModule),
            },
            {
                path: '',
                redirectTo: 'manage',
