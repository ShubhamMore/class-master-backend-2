...
const routes = [
    {
        ...
        children: [
            {
                path: 'profile',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(235)]).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/student/profile/profile.module.ts")).then((m) => m.ProfileModule),
                canActivate: [],
            },
            {
                path: 'transaction',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(236)]).then(__webpack_require__.bind(null, /*! ./transaction/transaction.module */ "./src/app/student/transaction/transaction.module.ts")).then((m) => m.TransactionModule),
                canActivate: [],
            },
            {
                path: 'home',
                loadChildren: () => __webpack_require__.e(/*! import() */ 234).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/student/home/home.module.ts")).then((m) => m.HomeModule),
                canActivate: [],
            },
            {
                path: 'branch',
