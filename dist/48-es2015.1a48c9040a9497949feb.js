...
function MembershipPlansComponent_div_7_div_2_tr_14_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MembershipPlansComponent_div_7_div_2_tr_14_Template_button_click_11_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r10); const membership_r7 = ctx.$implicit; const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](3); return ctx_r9.editMembership(membership_r7); });
...
let MembershipPlansComponent = /*@__PURE__*/ (() => {
    ...
    MembershipPlansComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: MembershipPlansComponent, selectors: [["ngx-membership-plans"]], decls: 12, vars: 2, consts: [[1, "row"], [1, "col-md-9", "col-sm-8"], ["class", "row", 4, "ngIf", "ngIfElse"], ["loadingData", ""], ["noMemberships", ""], [1, "col-12"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], ["type", "button", "nbButton", "", "size", "small", "status", "basic", 3, "click"], [1, "pt-5", "pb-5", "text-center"]], template: function MembershipPlansComponent_Template(rf, ctx) {
            if (rf & 1) {
...
let SaveMembershipPlanComponent = /*@__PURE__*/ (() => {
    class SaveMembershipPlanComponent {
        ...
        ngOnInit() {
            ...
            this.membershipService.getMembershipPlan().subscribe((membership) => {
                ...
                this.membershipForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormGroup"]({
    ...
    SaveMembershipPlanComponent.ɵfac = function SaveMembershipPlanComponent_Factory(t) { return new (t || SaveMembershipPlanComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_membership_service__WEBPACK_IMPORTED_MODULE_2__["MembershipService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogRef"])); };
    SaveMembershipPlanComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SaveMembershipPlanComponent, selectors: [["ngx-save-membership-plan"]], decls: 41, vars: 10, consts: [[1, "membership-box"], ["icon", "close-outline", 1, "float-right", "pointer", 3, "click"], [1, ""], [1, "", 3, "formGroup", "submit"], [1, "table-responsive"], [1, "table", "table-borderless"], [1, "form-control-group"], ["type", "number", "nbInput", "", "id", "input-price", "name", "price", "min", "0", "formControlName", "price", "placeholder", "Price", "fullWidth", "", 3, "status"], [4, "ngIf"], [1, "row"], [1, "col-md-12", "text-right"], ["type", "submit", "nbButton", "", "size", "small"], ["class", "caption status-danger", 4, "ngIf"], [1, "caption", "status-danger"]], template: function SaveMembershipPlanComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SaveMembershipPlanComponent_Template_nb_icon_click_2_listener() { return ctx.onClose(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("submit", function SaveMembershipPlanComponent_Template_form_submit_7_listener() { return ctx.saveMembership(); });
