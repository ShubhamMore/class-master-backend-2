...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'login',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(65)]).then(__webpack_require__.bind(null, /*! ../authentication/login/login.module */ "./src/app/authentication/login/login.module.ts")).then((m) => m.LoginModule),
                canActivate: [],
            },
            {
                path: 'register',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(5), __webpack_require__.e("common"), __webpack_require__.e(47)]).then(__webpack_require__.bind(null, /*! ../authentication/register/register.module */ "./src/app/authentication/register/register.module.ts")).then((m) => m.RegisterModule),
                canActivate: [],
            },
            {
                path: 'forgot-password',
                loadChildren: () => __webpack_require__.e(/*! import() */ 64).then(__webpack_require__.bind(null, /*! ../authentication/forgot-password/forgot-password.module */ "./src/app/authentication/forgot-password/forgot-password.module.ts")).then((m) => m.ForgotPasswordModule),
                canActivate: [],
            },
            {
                path: 'reset-password',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(66)]).then(__webpack_require__.bind(null, /*! ../authentication/reset-password/reset-password.module */ "./src/app/authentication/reset-password/reset-password.module.ts")).then((m) => m.ResetPasswordModule),
                canActivate: [],
            },
            {
                path: 'privacy-policy',
                loadChildren: () => __webpack_require__.e(/*! import() */ 67).then(__webpack_require__.bind(null, /*! ./privacy-policy/privacy-policy.module */ "./src/app/content/privacy-policy/privacy-policy.module.ts")).then((m) => m.PrivacyPolicyModule),
                canActivate: [],
            },
            {
                path: 'terms-and-conditions',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(5), __webpack_require__.e(68)]).then(__webpack_require__.bind(null, /*! ./terms-and-conditions/terms-and-conditions.module */ "./src/app/content/terms-and-conditions/terms-and-conditions.module.ts")).then((m) => m.TermsAndConditionsModule),
                canActivate: [],
            },
            {
                path: '',
...
ContentRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function ContentRoutingModule_Factory(t) { return new (t || ContentRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ContentRoutingModule, [{
...
ContentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ContentComponent, selectors: [["ngx-content"]], decls: 7, vars: 0, consts: [[1, "p-0"]], template: function ContentComponent_Template(rf, ctx) { if (rf & 1) {
...
ContentFooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ContentFooterComponent, selectors: [["ngx-content-footer"]], decls: 12, vars: 0, consts: [[1, "created-by"], ["href", "https://www.google.com", "target", "_blank"], ["routerLink", "/terms-and-conditions", 1, "pointer"], ["routerLink", "/privacy-policy", 1, "pointer"]], template: function ContentFooterComponent_Template(rf, ctx) { if (rf & 1) {
