...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => __webpack_require__.e(/*! import() */ 86).then(__webpack_require__.bind(null, /*! ./manage-online-test-questions/manage-online-test-questions.module */ "./src/app/employee/branch/exam/online-test/online-test-question/manage-online-test-questions/manage-online-test-questions.module.ts")).then((m) => m.ManageOnlineTestQuestionsModule),
            },
            {
                path: 'add',
