...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'manage',
                loadChildren: () => __webpack_require__.e(/*! import() */ 168).then(__webpack_require__.bind(null, /*! ./manage-lead/manage-lead.module */ "./src/app/institute/branch/lead/manage-lead/manage-lead.module.ts")).then((m) => m.ManageLeadModule),
            },
            {
                path: '',
...
let LeadRoutingModule = /*@__PURE__*/ (() => {
    ...
    LeadRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function LeadRoutingModule_Factory(t) { return new (t || LeadRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] });
