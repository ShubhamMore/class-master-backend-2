...
/***/ "./src/app/employee/branch/lecture/attendance/attendance-routing.module.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/attendance/attendance-routing.module.ts ***!
  \*********************************************************************************/
...
/* harmony import */ var _attendance_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./attendance.component */ "./src/app/employee/branch/lecture/attendance/attendance.component.ts");
...
var AttendanceRoutingModule = /** @class */ /*@__PURE__*/ (function () {
...
/***/ "./src/app/employee/branch/lecture/attendance/attendance.component.ts":
/*!****************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/attendance/attendance.component.ts ***!
  \****************************************************************************/
...
function AttendanceComponent_div_39_tr_12_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function AttendanceComponent_div_39_tr_12_Template_input_change_8_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); var i_r5 = ctx.index; var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r6.onChangeAttendance($event.target.checked, i_r5); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
var AttendanceComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AttendanceComponent.prototype.onChangeAttendance = function (attendance, i) {
        this.students[i].attendance = attendance;
    };
    AttendanceComponent.prototype.saveAttendance = function () {
        var _this = this;
        var attendance = {
        ...
        this.attendanceService.saveAttendance(attendance).subscribe(function (res) {
            _this.showToastr('top-right', 'success', "Attendance " + (res ? 'Updated' : 'Marked') + " Successfully");
            _this.back();
        }, function (error) {
            _this.showToastr('top-right', 'danger', error);
        });
    };
    AttendanceComponent.prototype.getTime = function (startTime, endTime) {
        startTime = this.dateService.formatTime(startTime);
        endTime = this.dateService.formatTime(endTime);
        return startTime + ' - ' + endTime;
    };
    AttendanceComponent.prototype.getTeacher = function (teacher) {
        return teacher;
    };
    AttendanceComponent.prototype.getSubject = function (subject) {
    ...
    AttendanceComponent.prototype.showToastr = function (position, status, message) {
    ...
    AttendanceComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AttendanceComponent, selectors: [["ngx-attendance"]], decls: 46, vars: 8, consts: [[1, "row"], [1, "col-md-4", "col-sm-6", "col-12"], ["class", "col-12", 4, "ngIf", "ngIfElse"], [1, "col-12", "text-right"], ["type", "button", "nbButton", "", "size", "small", "status", "primary", 3, "click"], ["noStudents", ""], [1, "col-12"], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], [1, "text-center"], [1, "mark-attendance-selector"], ["type", "checkbox", 1, "mark-attendance", 3, "id", "checked", "change"], [3, "for"], [1, "text-center", "pt-5", "pb-5"]], template: function AttendanceComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AttendanceComponent_Template_button_click_42_listener() { return ctx.saveAttendance(); });
...
/***/ "./src/app/employee/branch/lecture/attendance/attendance.module.ts":
/*!*************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/attendance/attendance.module.ts ***!
  \*************************************************************************/
...
/* harmony import */ var _attendance_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./attendance-routing.module */ "./src/app/employee/branch/lecture/attendance/attendance-routing.module.ts");
/* harmony import */ var _attendance_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./attendance.component */ "./src/app/employee/branch/lecture/attendance/attendance.component.ts");
...
var AttendanceModule = /** @class */ /*@__PURE__*/ (function () {
