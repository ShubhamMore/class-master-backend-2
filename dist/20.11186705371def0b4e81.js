...
var AddStudyMaterialRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddStudyMaterialRoutingModule() {
    }
...
function AddStudyMaterialComponent_nb_card_0_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function AddStudyMaterialComponent_nb_card_0_Template_input_change_16_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r13.onFilePicked($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](18, "button", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddStudyMaterialComponent_nb_card_0_Template_button_click_18_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); var _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](17); return _r1.click(); });
...
var AddStudyMaterialComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddStudyMaterialComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    AddStudyMaterialComponent.prototype.onFilePicked = function (event) {
        this.invalidFile = false;
    ...
    AddStudyMaterialComponent.prototype.saveLectureMaterial = function () {
        var _this = this;
        ...
        this.lectureMaterialService.newLectureMaterials(lectureMaterials).subscribe(function (res) {
            var totalFiles = _this.uploadLectureMaterials.length;
            ...
            _this.uploadLectureMaterials = [];
            _this.cancel();
        }, function (error) {
            _this.loading = false;
        });
    };
    AddStudyMaterialComponent.prototype.removeFile = function (index) {
        this.uploadLectureMaterials.splice(index, 1);
    };
    AddStudyMaterialComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AddStudyMaterialComponent.prototype.cancel = function () {
    ...
    AddStudyMaterialComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddStudyMaterialComponent, selectors: [["ngx-add-study-material"]], viewQuery: function AddStudyMaterialComponent_Query(rf, ctx) {
            ...
            if (rf & 1) {
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, AddStudyMaterialComponent_nb_card_0_Template, 29, 3, "nb-card", 0);
            }
            if (rf & 2) {
...
var AddStudyMaterialModule = /** @class */ /*@__PURE__*/ (function () {
    function AddStudyMaterialModule() {
    }
