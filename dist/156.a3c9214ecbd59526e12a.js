...
var BatchAssignmentRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function BatchAssignmentRoutingModule() {
    }
...
function BatchAssignmentComponent_ng_container_19_div_1_tr_17_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BatchAssignmentComponent_ng_container_19_div_1_tr_17_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14); var batch_r11 = ctx.$implicit; var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r13.manageAssignment(batch_r11); });
...
var BatchAssignmentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    BatchAssignmentComponent.prototype.ngOnInit = function () {
        this.loading = true;
    ...
    BatchAssignmentComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    BatchAssignmentComponent.prototype.getCourses = function () {
        var _this = this;
        this.courseService.getCoursesData().subscribe(function (courses) {
            _this.courses = courses;
        });
    };
    BatchAssignmentComponent.prototype.onSelectCategory = function (category) {
        this.category = category;
        this.course = '';
        this.myCourses = this.courses.filter(function (course) { return course.basicDetails.category === category; });
        this.getBatches(this.category, this.course);
    };
    BatchAssignmentComponent.prototype.onSelectCourse = function (course) {
        this.course = course;
        this.getBatches(this.category, this.course);
    };
    BatchAssignmentComponent.prototype.getBatches = function (category, course) {
        var _this = this;
        this.loading = true;
    ...
    BatchAssignmentComponent.prototype.manageAssignment = function (batch) {
    ...
    BatchAssignmentComponent.prototype.getCategory = function (categoryId) {
    ...
    BatchAssignmentComponent.prototype.getCourse = function (courseId) {
    ...
    BatchAssignmentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BatchAssignmentComponent, selectors: [["ngx-batch-assignment"]], decls: 22, vars: 6, consts: [[1, "row"], [1, "col-md-6", "col-sm-4"], [1, "col-md-3", "col-sm-4"], ["id", "select-category", "name", "category", "fullWidth", "", "placeholder", "Select Category", 3, "selected", "selectedChange"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["id", "select-course", "name", "course", "fullWidth", "", "placeholder", "Select Course", 3, "selected", "selectedChange"], [1, "body-container"], [1, "col-md-12"], [4, "ngIf", "ngIfElse"], ["loadingData", ""], [3, "value"], ["class", "table-responsive", 4, "ngIf", "ngIfElse"], ["noBatches", ""], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], ["nbButton", "", "size", "small", "status", "primary", 3, "click"], [1, "text-center", "pt-5", "pb-5"]], template: function BatchAssignmentComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function BatchAssignmentComponent_Template_nb_select_selectedChange_7_listener($event) { return ctx.onSelectCategory($event); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedChange", function BatchAssignmentComponent_Template_nb_select_selectedChange_12_listener($event) { return ctx.onSelectCourse($event); });
...
var BatchAssignmentModule = /** @class */ /*@__PURE__*/ (function () {
    function BatchAssignmentModule() {
    }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](BatchAssignmentModule, { declarations: [_batch_assignment_component__WEBPACK_IMPORTED_MODULE_4__["BatchAssignmentComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _batch_assignment_routing_module__WEBPACK_IMPORTED_MODULE_3__["BatchAssignmentRoutingModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbCardModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbTooltipModule"],
            _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbIconModule"],
