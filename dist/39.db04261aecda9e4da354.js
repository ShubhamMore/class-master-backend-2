...
var routes = [
    {
        ...
        children: [
            {
                path: 'profile',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(214)]).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/institute/profile/profile.module.ts")).then(function (m) { return m.ProfileModule; }); },
                canActivate: [],
            },
            {
                path: 'settings',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(215)]).then(__webpack_require__.bind(null, /*! ./settings/settings.module */ "./src/app/institute/settings/settings.module.ts")).then(function (m) { return m.SettingsModule; }); },
                canActivate: [],
            },
            {
                path: 'home',
                loadChildren: function () { return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(210)]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/institute/home/home.module.ts")).then(function (m) { return m.HomeModule; }); },
                canActivate: [],
            },
            {
                path: 'my-institutes',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(211)]).then(__webpack_require__.bind(null, /*! ./manage-institute/manage-institute.module */ "./src/app/institute/manage-institute/manage-institute.module.ts")).then(function (m) { return m.ManageInstituteModule; });
                },
                canActivate: [],
            },
            {
                ...
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e(7), __webpack_require__.e("common"), __webpack_require__.e(213)]).then(__webpack_require__.bind(null, /*! ./membership-plans/membership-plans.module */ "./src/app/institute/membership-plans/membership-plans.module.ts")).then(function (m) { return m.MembershipPlansModule; });
                },
                canActivate: [],
            },
            {
                path: 'add',
                loadChildren: function () {
                    return Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e(7), __webpack_require__.e(8)]).then(__webpack_require__.bind(null, /*! ./manage-institute/add-institute/add-institute.module */ "./src/app/institute/manage-institute/add-institute/add-institute.module.ts")).then(function (m) { return m.AddInstituteModule; });
                },
                canActivate: [],
            },
            {
                path: 'view',
                loadChildren: function () {
                    return __webpack_require__.e(/*! import() */ 212).then(__webpack_require__.bind(null, /*! ./manage-institute/view-institute/view-institute.module */ "./src/app/institute/manage-institute/view-institute/view-institute.module.ts")).then(function (m) { return m.ViewInstituteModule; });
                },
                canActivate: [],
            },
            {
            ...
            {
                path: 'branch',
                loadChildren: function () { return __webpack_require__.e(/*! import() */ 72).then(__webpack_require__.bind(null, /*! ./branch/branch.module */ "./src/app/institute/branch/branch.module.ts")).then(function (m) { return m.BranchModule; }); },
...
var InstituteRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function InstituteRoutingModule() {
    }
...
var InstituteComponent = /** @class */ /*@__PURE__*/ (function () {
...
var InstituteModule = /** @class */ /*@__PURE__*/ (function () {
...
var MenuService = /** @class */ /*@__PURE__*/ (function () {
    ...
    MenuService.prototype.setMenuItemSequence = function () {
        this.menuItems = [];
    ...
    MenuService.prototype.hideMenu = function () {
    ...
    MenuService.prototype.showMenu = function () {
        this.menuItems = _institute_menu__WEBPACK_IMPORTED_MODULE_1__["MENU_ITEMS"].map(function (menuItem, i) {
...
var PaymentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    PaymentComponent.prototype.generateOrder = function () {
        var _this = this;
        this.orderService.generateOrder(this.orderDetails).subscribe(function (res) {
            _this.placedOrderReceipt = res.paymentReceipt;
    ...
    PaymentComponent.prototype.deleteOrder = function () {
        var _this = this;
        this.orderService.deleteOrder(this.placedOrderReceipt._id).subscribe(function (res) {
            _this.placedOrderReceipt = null;
            _this.ref.close({ status: false });
        }, function (err) {
            _this.showToastr('top-right', 'danger', err);
            _this.onClose();
        });
    };
    PaymentComponent.prototype.verifyPayment = function (payment) {
        var _this = this;
        this.paymentService.verifyPayment(payment, this.placedOrderReceipt).subscribe(function (res) {
            _this.showToastr('top-right', 'success', 'Payment Verified Successfully');
            _this.ref.close({ status: true, order: res.orderId, receipt: res.receiptId });
        }, function (err) {
            _this.showToastr('top-right', 'danger', err);
            _this.onClose();
        });
    };
    PaymentComponent.prototype.onClose = function () {
        this.ref.close();
    };
    PaymentComponent.prototype.showToastr = function (position, status, message) {
...
var OrderService = /** @class */ /*@__PURE__*/ (function () {
    ...
    OrderService.prototype.setOrderDetails = function (order) {
        this.orderDetails = order;
    };
    OrderService.prototype.deleteOrderDetails = function () {
        this.orderDetails = null;
    };
    OrderService.prototype.deleteOrder = function (id) {
        var data = { api: 'deleteOrder', data: { id: id } };
    ...
    OrderService.prototype.generateOrder = function (order) {
        var data = { api: 'generateOrder', data: order };
        return this.httpService.httpPost(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (response) {
            return response;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(err);
