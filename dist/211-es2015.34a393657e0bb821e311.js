...
const routes = [
    ...
    {
        path: 'view',
        loadChildren: () => __webpack_require__.e(/*! import() */ 212).then(__webpack_require__.bind(null, /*! ./view-transaction/view-transaction.module */ "./src/app/institute/transaction/view-transaction/view-transaction.module.ts")).then((m) => m.ViewTransactionModule),
    },
    {
        path: 'page-not-found',
