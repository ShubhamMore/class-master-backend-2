...
const routes = [
    {
        ...
        children: [
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(33)]).then(__webpack_require__.bind(null, /*! ./add-student/add-student.module */ "./src/app/institute/branch/student/add-student/add-student.module.ts")).then((m) => m.AddStudentModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(33)]).then(__webpack_require__.bind(null, /*! ./add-student/add-student.module */ "./src/app/institute/branch/student/add-student/add-student.module.ts")).then((m) => m.AddStudentModule),
            ...
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(197)]).then(__webpack_require__.bind(null, /*! ./manage-student/manage-student.module */ "./src/app/institute/branch/student/manage-student/manage-student.module.ts")).then((m) => m.ManageStudentModule),
            },
            {
                path: 'course',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(204)]).then(__webpack_require__.bind(null, /*! ./student-course/student-course.module */ "./src/app/institute/branch/student/student-course/student-course.module.ts")).then((m) => m.StudentCourseModule),
            },
            {
                path: '',
...
let StudentRoutingModule = /*@__PURE__*/ (() => {
    ...
    StudentRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function StudentRoutingModule_Factory(t) { return new (t || StudentRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] });
