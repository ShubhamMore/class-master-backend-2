...
let StudentCourseAttendanceRoutingModule = /*@__PURE__*/ (() => {
    class StudentCourseAttendanceRoutingModule {
    }
...
let StudentCourseAttendanceComponent = /*@__PURE__*/ (() => {
    class StudentCourseAttendanceComponent {
        constructor(dateService, branchService, batchService, toastrService, studentService, studentCourseService, attendanceService, router, route) {
...
let StudentCourseAttendanceModule = /*@__PURE__*/ (() => {
    class StudentCourseAttendanceModule {
    }
