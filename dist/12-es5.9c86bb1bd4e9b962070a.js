          ...
          _createClass(AddOnlineTestQuestionsComponent, [{
            ...
            value: function ngOnInit() {
              ...
              this.onlineExamService.getOnlineExamData().subscribe(function (onlineExam) {
                ...
                if (mode && mode !== 'edit') {
                  _this.showToastr('top-right', 'danger', 'Invalid Route'); // this.router.navigate(['../page-not-found'], { relativeTo: this.route });


                  return;
                } else if (mode && !_this.onlineExamQuestionId) {
                  _this.showToastr('top-right', 'danger', 'Online Exam Question Not Found'); // this.router.navigate(['../page-not-found'], { relativeTo: this.route });
