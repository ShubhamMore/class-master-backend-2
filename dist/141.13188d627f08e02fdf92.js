...
var ManageStudentCourseInstallmentRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageStudentCourseInstallmentRoutingModule() {
    }
...
function ManageStudentCourseInstallmentComponent_ng_container_13_div_32_tr_17_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ManageStudentCourseInstallmentComponent_ng_container_13_div_32_tr_17_Template_button_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); var installment_r7 = ctx.$implicit; var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3); return installment_r7.receiptId ? ctx_r17.showReceipt(installment_r7.receiptId) : ctx_r17.collectInstallment(installment_r7._id); });
...
var ManageStudentCourseInstallmentComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageStudentCourseInstallmentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        ...
        this.studentCourseInstallmentService
            ...
            .subscribe(function (studentCourseInstallment) {
    ...
    ManageStudentCourseInstallmentComponent.prototype.getStudentName = function () {
    ...
    ManageStudentCourseInstallmentComponent.prototype.getCourseName = function (courseId) {
    ...
    ManageStudentCourseInstallmentComponent.prototype.editReceipt = function (installmentId, receiptId) {
    ...
    ManageStudentCourseInstallmentComponent.prototype.showReceipt = function (receiptId) {
        this.studentCourseInstallmentReceiptService.setStudentCourseInstallmentReceiptId(receiptId);
        this.router.navigate(['../receipt'], { relativeTo: this.route });
    };
    ManageStudentCourseInstallmentComponent.prototype.deleteReceipt = function (installmentId, receiptId) {
        var _this = this;
        this.loading = true;
        this.studentCourseInstallmentReceiptService
            .deleteStudentCourseInstallmentReceipt(receiptId)
            .subscribe(function (res) {
            _this.studentCourseInstallmentService.setCourseInstallmentReceipt(installmentId, null);
            _this.loading = false;
        }, function (err) {
            _this.showToastr('top-right', 'danger', err);
            _this.loading = false;
    ...
    ManageStudentCourseInstallmentComponent.prototype.collectInstallment = function (installmentId) {
        this.studentCourseInstallmentService.setCourseInstallmentId(installmentId);
        this.router.navigate(['../collect'], { relativeTo: this.route });
    };
    ManageStudentCourseInstallmentComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    ManageStudentCourseInstallmentComponent.prototype.ngOnDestroy = function () { };
...
var ManageStudentCourseInstallmentModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageStudentCourseInstallmentModule() {
    }
