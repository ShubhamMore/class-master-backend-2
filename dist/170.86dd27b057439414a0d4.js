...
function ManageOnlineTestComponent_ng_container_32_div_1_tr_19_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageOnlineTestComponent_ng_container_32_div_1_tr_19_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); var exam_r13 = ctx.$implicit; var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r15.onlineExamQuestions(exam_r13); });
...
var ManageOnlineTestComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageOnlineTestComponent.prototype.searchOnlineExam = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageOnlineTestComponent.prototype.addOnlineExam = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageOnlineTestComponent.prototype.editOnlineExam = function (onlineExam) {
    ...
    ManageOnlineTestComponent.prototype.onlineExamQuestions = function (onlineExam) {
        this.onlineExamService.setOnlineExamId(onlineExam._id);
        this.onlineExamService.setOnlineExamData(onlineExam);
        this.router.navigate(['../question'], { relativeTo: this.route });
    };
    ManageOnlineTestComponent.prototype.changeOnlineExamStatus = function (id, status, i) {
        var _this = this;
        this.loading = true;
        this.onlineExamService.changeOnlineExamStatus(id, status).subscribe(function (res) {
            _this.onlineExams[i].status = status;
            _this.loading = false;
        }, function (error) {
    ...
    ManageOnlineTestComponent.prototype.deleteOnlineExam = function (id, i) {
        var _this = this;
        this.loading = true;
        this.onlineExamService.deleteOnlineExam(id).subscribe(function (res) {
            _this.onlineExams.splice(i, 1);
            _this.loading = false;
        }, function (error) {
            _this.loading = false;
        });
