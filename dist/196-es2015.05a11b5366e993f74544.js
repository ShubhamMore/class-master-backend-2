...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 195).then(__webpack_require__.bind(null, /*! ./manage-schedule/manage-schedule.module */ "./src/app/institute/branch/schedule/manage-schedule/manage-schedule.module.ts")).then((m) => m.ManageScheduleModule),
            },
            {
                path: 'batch-schedule',
                loadChildren: () => __webpack_require__.e(/*! import() */ 71).then(__webpack_require__.bind(null, /*! ./batch-schedule/batch-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule.module.ts")).then((m) => m.BatchScheduleModule),
            },
            {
                path: '',
                redirectTo: 'batch',
