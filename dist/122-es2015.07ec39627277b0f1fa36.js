...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(123)]).then(__webpack_require__.bind(null, /*! ./manage-course/manage-course.module */ "./src/app/employee/branch/manage-branch/course/manage-course/manage-course.module.ts")).then((m) => m.ManageCourseModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(20)]).then(__webpack_require__.bind(null, /*! ./add-course/add-course.module */ "./src/app/employee/branch/manage-branch/course/add-course/add-course.module.ts")).then((m) => m.AddCourseModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(20)]).then(__webpack_require__.bind(null, /*! ./add-course/add-course.module */ "./src/app/employee/branch/manage-branch/course/add-course/add-course.module.ts")).then((m) => m.AddCourseModule),
            ...
            {
                path: 'batch',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(116)]).then(__webpack_require__.bind(null, /*! ./batch/batch.module */ "./src/app/employee/branch/manage-branch/course/batch/batch.module.ts")).then((m) => m.BatchModule),
            },
            {
                path: 'course-material',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(119)]).then(__webpack_require__.bind(null, /*! ./course-material/course-material.module */ "./src/app/employee/branch/manage-branch/course/course-material/course-material.module.ts")).then((m) => m.CourseMaterialModule),
            },
            {
                path: '',
                redirectTo: 'manage',
