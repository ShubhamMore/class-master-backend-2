...
var AddTestRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddTestRoutingModule() {
    }
...
var AddTestComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddTestComponent.prototype.previousStep = function () {
        this.stepper.previous();
    };
    AddTestComponent.prototype.submitExamForm = function () {
    ...
    AddTestComponent.prototype.saveExam = function () {
        var _this = this;
        this.examForm.markAllAsTouched();
        if (this.examForm.invalid) {
            this.showToastr('top-right', 'danger', 'All Exam Fields are Required');
        ...
        if (!this.exam) {
            this.examService.saveExam(exam).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Exam Added Successfully!');
                _this.back();
            }, function (error) {
            ...
            this.examService.editExam(exam).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Exam Updated Successfully!');
                _this.back();
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
    ...
    AddTestComponent.prototype.getSubject = function (subjectId) {
    ...
    AddTestComponent.prototype.showToastr = function (position, status, message) {
    ...
    AddTestComponent.prototype.ngOnDestroy = function () {
...
var AddTestModule = /** @class */ /*@__PURE__*/ (function () {
