...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[159], {
  ...
  /***/
  function srcAppInstituteBranchExamTestBatchTestBatchTestRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/institute/branch/exam/test/batch-test/manage-batch-test/manage-batch-test.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/institute/branch/exam/test/batch-test/add-test/add-test.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/institute/branch/exam/test/batch-test/add-test-score/add-test-score.module.ts")).then(function (m) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BatchTestRoutingModule, [{
  ...
  /***/
  function srcAppInstituteBranchExamTestBatchTestBatchTestComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](BatchTestComponent, [{
  ...
  /***/
  function srcAppInstituteBranchExamTestBatchTestBatchTestModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BatchTestModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_batch_test_component__WEBPACK_IMPORTED_MODULE_3__["BatchTestComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _batch_test_routing_module__WEBPACK_IMPORTED_MODULE_2__["BatchTestRoutingModule"]]
