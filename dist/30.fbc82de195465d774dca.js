...
var AddLeadRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function AddLeadRoutingModule() {
    }
...
var AddLeadComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    AddLeadComponent.prototype.onSelectCategory = function (category) {
        this.myCourses = this.courses.filter(function (course) { return course.basicDetails.category === category; });
    };
    AddLeadComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    AddLeadComponent.prototype.getCourses = function () {
        var _this = this;
        this.courseService.getCoursesData().subscribe(function (courses) {
            _this.courses = courses;
        });
    };
    AddLeadComponent.prototype.previousStep = function () {
        this.stepper.previous();
    };
    AddLeadComponent.prototype.submitLeadForm = function () {
    ...
    AddLeadComponent.prototype.saveLead = function () {
        var _this = this;
        this.loading = true;
        this.leadForm.markAllAsTouched();
        if (this.leadForm.invalid) {
        ...
        if (!this.lead) {
            this.leadService.saveLead(lead).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'New Lead Added Successfully!');
            ...
            this.leadService.editLead(lead).subscribe(function (res) {
                _this.showToastr('top-right', 'success', 'Lead Updated Successfully!');
                _this.router.navigate(['../'], { relativeTo: _this.route });
            }, function (error) {
                _this.showToastr('top-right', 'danger', error);
                _this.loading = false;
    ...
    AddLeadComponent.prototype.getCategory = function (categoryId) {
    ...
    AddLeadComponent.prototype.getCourse = function (courseId) {
    ...
    AddLeadComponent.prototype.showToastr = function (position, status, message) {
        this.toastrService.show(status, message, {
            position: position,
            status: status,
        });
    };
    AddLeadComponent.prototype.ngOnDestroy = function () {
...
var AddLeadModule = /** @class */ /*@__PURE__*/ (function () {
    function AddLeadModule() {
    }
