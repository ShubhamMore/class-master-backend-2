...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 122).then(__webpack_require__.bind(null, /*! ./manage-schedule/manage-schedule.module */ "./src/app/employee/branch/schedule/manage-schedule/manage-schedule.module.ts")).then((m) => m.ManageScheduleModule),
            },
            {
                path: 'batch-schedule',
                loadChildren: () => __webpack_require__.e(/*! import() */ 119).then(__webpack_require__.bind(null, /*! ./batch-schedule/batch-schedule.module */ "./src/app/employee/branch/schedule/batch-schedule/batch-schedule.module.ts")).then((m) => m.BatchScheduleModule),
            },
            {
                path: '',
                redirectTo: 'batch',
