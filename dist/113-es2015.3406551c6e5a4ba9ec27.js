...
/***/ "./src/app/employee/branch/lecture/study-material/study-material-routing.module.ts":
/*!*****************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/study-material/study-material-routing.module.ts ***!
  \*****************************************************************************************/
...
/* harmony import */ var _study_material_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./study-material.component */ "./src/app/employee/branch/lecture/study-material/study-material.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(112)]).then(__webpack_require__.bind(null, /*! ./manage-study-material/manage-study-material.module */ "./src/app/employee/branch/lecture/study-material/manage-study-material/manage-study-material.module.ts")).then((m) => m.ManageStudyMaterialModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(19)]).then(__webpack_require__.bind(null, /*! ./add-study-material/add-study-material.module */ "./src/app/employee/branch/lecture/study-material/add-study-material/add-study-material.module.ts")).then((m) => m.AddStudyMaterialModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(19)]).then(__webpack_require__.bind(null, /*! ./add-study-material/add-study-material.module */ "./src/app/employee/branch/lecture/study-material/add-study-material/add-study-material.module.ts")).then((m) => m.AddStudyMaterialModule),
            ...
            {
                path: 'view',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(3), __webpack_require__.e("common"), __webpack_require__.e(114)]).then(__webpack_require__.bind(null, /*! ./view-study-material/view-study-material.module */ "./src/app/employee/branch/lecture/study-material/view-study-material/view-study-material.module.ts")).then((m) => m.ViewStudyMaterialModule),
            },
            {
                path: '',
                redirectTo: 'manage',
...
let StudyMaterialRoutingModule = /*@__PURE__*/ (() => {
    ...
    StudyMaterialRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function StudyMaterialRoutingModule_Factory(t) { return new (t || StudyMaterialRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] });
...
/***/ "./src/app/employee/branch/lecture/study-material/study-material.component.ts":
/*!************************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/study-material/study-material.component.ts ***!
  \************************************************************************************/
...
/***/ "./src/app/employee/branch/lecture/study-material/study-material.module.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/employee/branch/lecture/study-material/study-material.module.ts ***!
  \*********************************************************************************/
...
/* harmony import */ var _study_material_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./study-material-routing.module */ "./src/app/employee/branch/lecture/study-material/study-material-routing.module.ts");
/* harmony import */ var _study_material_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./study-material.component */ "./src/app/employee/branch/lecture/study-material/study-material.component.ts");
