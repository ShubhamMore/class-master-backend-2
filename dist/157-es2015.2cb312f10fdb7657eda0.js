...
const routes = [
    {
        ...
        children: [
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(11)]).then(__webpack_require__.bind(null, /*! ./add-employee/add-employee.module */ "./src/app/institute/branch/employee/add-employee/add-employee.module.ts")).then((m) => m.AddEmployeeModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e("common"), __webpack_require__.e(11)]).then(__webpack_require__.bind(null, /*! ./add-employee/add-employee.module */ "./src/app/institute/branch/employee/add-employee/add-employee.module.ts")).then((m) => m.AddEmployeeModule),
            ...
            {
                path: 'manage',
                loadChildren: () => __webpack_require__.e(/*! import() */ 67).then(__webpack_require__.bind(null, /*! ./manage-employee/manage-employee.module */ "./src/app/institute/branch/employee/manage-employee/manage-employee.module.ts")).then((m) => m.ManageEmployeeModule),
            },
            {
                path: 'salary',
                loadChildren: () => __webpack_require__.e(/*! import() */ 66).then(__webpack_require__.bind(null, /*! ./manage-employee-salary/manage-employee-salary.module */ "./src/app/institute/branch/employee/manage-employee-salary/manage-employee-salary.module.ts")).then((m) => m.ManageEmployeeSalaryModule),
            },
            {
                path: '',
