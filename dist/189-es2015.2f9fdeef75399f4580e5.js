...
const routes = [
    {
        ...
        children: [
            {
                path: 'batch',
                loadChildren: () => __webpack_require__.e(/*! import() */ 188).then(__webpack_require__.bind(null, /*! ./manage-schedule/manage-schedule.module */ "./src/app/institute/branch/schedule/manage-schedule/manage-schedule.module.ts")).then((m) => m.ManageScheduleModule),
            },
            {
                path: 'batch-schedule',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(185)]).then(__webpack_require__.bind(null, /*! ./batch-schedule/batch-schedule.module */ "./src/app/institute/branch/schedule/batch-schedule/batch-schedule.module.ts")).then((m) => m.BatchScheduleModule),
            },
            {
                path: '',
                redirectTo: 'batch',
