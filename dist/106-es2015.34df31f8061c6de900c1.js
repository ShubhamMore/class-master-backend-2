...
/***/ "./src/app/employee/branch/manage-branch/course/course-routing.module.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/employee/branch/manage-branch/course/course-routing.module.ts ***!
  \*******************************************************************************/
...
/* harmony import */ var _course_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./course.component */ "./src/app/employee/branch/manage-branch/course/course.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(107)]).then(__webpack_require__.bind(null, /*! ./manage-course/manage-course.module */ "./src/app/employee/branch/manage-branch/course/manage-course/manage-course.module.ts")).then((m) => m.ManageCourseModule),
            },
            {
                path: 'add',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(16)]).then(__webpack_require__.bind(null, /*! ./add-course/add-course.module */ "./src/app/employee/branch/manage-branch/course/add-course/add-course.module.ts")).then((m) => m.AddCourseModule),
            },
            {
                path: 'edit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(16)]).then(__webpack_require__.bind(null, /*! ./add-course/add-course.module */ "./src/app/employee/branch/manage-branch/course/add-course/add-course.module.ts")).then((m) => m.AddCourseModule),
            ...
            {
                path: 'batch',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(100)]).then(__webpack_require__.bind(null, /*! ./batch/batch.module */ "./src/app/employee/branch/manage-branch/course/batch/batch.module.ts")).then((m) => m.BatchModule),
            },
            {
                path: 'course-material',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(103)]).then(__webpack_require__.bind(null, /*! ./course-material/course-material.module */ "./src/app/employee/branch/manage-branch/course/course-material/course-material.module.ts")).then((m) => m.CourseMaterialModule),
            },
            {
                path: '',
                redirectTo: 'manage',
...
CourseRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function CourseRoutingModule_Factory(t) { return new (t || CourseRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CourseRoutingModule, [{
...
/***/ "./src/app/employee/branch/manage-branch/course/course.component.ts":
/*!**************************************************************************!*\
  !*** ./src/app/employee/branch/manage-branch/course/course.component.ts ***!
  \**************************************************************************/
...
CourseComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CourseComponent, selectors: [["ngx-course"]], decls: 1, vars: 0, template: function CourseComponent_Template(rf, ctx) { if (rf & 1) {
...
/***/ "./src/app/employee/branch/manage-branch/course/course.module.ts":
/*!***********************************************************************!*\
  !*** ./src/app/employee/branch/manage-branch/course/course.module.ts ***!
  \***********************************************************************/
...
/* harmony import */ var _course_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./course-routing.module */ "./src/app/employee/branch/manage-branch/course/course-routing.module.ts");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CourseModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
