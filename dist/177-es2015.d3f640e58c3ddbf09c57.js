...
const routes = [
    {
        ...
        children: [
            {
                path: 'manage',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(178)]).then(__webpack_require__.bind(null, /*! ./manage-batch/manage-batch.module */ "./src/app/institute/branch/manage-branch/course/batch/manage-batch/manage-batch.module.ts")).then((m) => m.ManageBatchModule),
            },
            {
                path: 'add',
...
let BatchRoutingModule = /*@__PURE__*/ (() => {
    ...
    BatchRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function BatchRoutingModule_Factory(t) { return new (t || BatchRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] });
