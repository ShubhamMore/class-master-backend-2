...
var ManageStudyMaterialRoutingModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageStudyMaterialRoutingModule() {
    }
...
function ManageStudyMaterialComponent_ng_container_13_div_1_tr_11_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ManageStudyMaterialComponent_ng_container_13_div_1_tr_11_Template_button_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); var lectureMaterial_r7 = ctx.$implicit; var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3); return ctx_r9.viewLectureMaterial(lectureMaterial_r7); });
...
var ManageStudyMaterialComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    ManageStudyMaterialComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    ManageStudyMaterialComponent.prototype.getLectureMaterials = function (subject) {
        var _this = this;
        this.loading = true;
        ...
        this.lectureMaterialService
            ...
            .subscribe(function (lectureMaterials) {
            _this.lectureMaterials = lectureMaterials;
            _this.loading = false;
        }, function (err) {
            _this.loading = false;
        });
    };
    ManageStudyMaterialComponent.prototype.addLectureMaterial = function () {
        this.router.navigate(['../add'], { relativeTo: this.route });
    };
    ManageStudyMaterialComponent.prototype.deleteLectureMaterial = function (id, i) {
        var _this = this;
        this.loading = true;
        this.lectureMaterialService.deleteLectureMaterial(id).subscribe(function (res) {
            _this.lectureMaterials.splice(i, 1);
            _this.showToastr('top-right', 'success', "LectureMaterial Deleted Successfully!");
            _this.loading = false;
        }, function (err) {
    ...
    ManageStudyMaterialComponent.prototype.viewLectureMaterial = function (lectureMaterial) {
    ...
    ManageStudyMaterialComponent.prototype.getSubject = function (subjectId) {
    ...
    ManageStudyMaterialComponent.prototype.changeLectureMaterialStatus = function (id, status, i) {
        var _this = this;
        this.loading = true;
        this.lectureMaterialService.changeLectureMaterialStatus(id, status).subscribe(function (res) {
            _this.lectureMaterials[i].status = status;
            _this.showToastr('top-right', 'success', "LectureMaterial " + (status ? 'Activated' : 'Deactivated') + " Successfully!");
            _this.loading = false;
        }, function (err) {
            _this.showToastr('top-right', 'danger', err);
            _this.loading = false;
    ...
    ManageStudyMaterialComponent.prototype.showToastr = function (position, status, message) {
...
var ManageStudyMaterialModule = /** @class */ /*@__PURE__*/ (function () {
    function ManageStudyMaterialModule() {
    }
